...
Begin VB.Form PrgConfigDesarrollo 
   AutoRedraw      =   -1  'True
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "configdesarrollo.frx":0000
   ...
   End
End
Attribute VB_Name = "PrgConfigDesarrollo"
...
Sub Form_Load()
    ...
    Titulo1.Caption = "Ingreso de Ordenes de Trabajo"
    Titulo2.Caption = "Ingreso de Pruebas de Ensayo"
    Titulo3.Caption = "Verificacion de Pedido de Desarrollos"
    Titulo4.Caption = "Consulta de Pedidos de Desarrollos"
    Titulo5.Caption = "Analisis de Desarrollo"
