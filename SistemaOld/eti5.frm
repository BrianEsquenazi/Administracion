...
Private Sub Lote_keypress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        If rstLaudo.RecordCount > 0 Then
            If Left$(Articulo.Text, 2) = "DY" Or Left$(Articulo.Text, 2) = "DS" Or Left$(Articulo.Text, 2) = "DK" Or Left$(Articulo.Text, 2) = "DQ" Then
