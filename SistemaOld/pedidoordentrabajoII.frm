...
Begin VB.Form PrgpedidoOrdenTrabajo 
   ...
   Begin RichTextLib.RichTextBox Agenda 
      ...
      RightMargin     =   8900
      AutoVerbMenu    =   -1  'True
      TextRTF         =   $"pedidoordentrabajoII.frx":0000
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabPicture(0)   =   "pedidoordentrabajoII.frx":007C
      ...
      TabPicture(1)   =   "pedidoordentrabajoII.frx":0098
      ...
      TabPicture(2)   =   "pedidoordentrabajoII.frx":00B4
      Tab(2).ControlCount=   14
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "RespuestaIV"
      Tab(2).Control(0).Enabled=   -1  'True
      Tab(2).Control(1)=   "RespuestaVI"
      Tab(2).Control(1).Enabled=   -1  'True
      Tab(2).Control(2)=   "RespuestaV"
      Tab(2).Control(2).Enabled=   -1  'True
      Tab(2).Control(3)=   "Destino"
      Tab(2).Control(3).Enabled=   -1  'True
      Tab(2).Control(4)=   "RespuestaII"
      Tab(2).Control(4).Enabled=   -1  'True
      Tab(2).Control(5)=   "RespuestaIII"
      Tab(2).Control(5).Enabled=   -1  'True
      Tab(2).Control(6)=   "RespuestaI"
      Tab(2).Control(6).Enabled=   -1  'True
      Tab(2).Control(7)=   "Respuesta"
      Tab(2).Control(7).Enabled=   -1  'True
      Tab(2).Control(8)=   "CodigoOrden"
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "pedidoordentrabajoII.frx":00D0
      Left            =   240
      List            =   "pedidoordentrabajoII.frx":00D7
      TabIndex        =   41
      Top             =   5160
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   6240
      MouseIcon       =   "pedidoordentrabajoII.frx":00E5
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoII.frx":03EF
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   6960
      MouseIcon       =   "pedidoordentrabajoII.frx":0C31
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoII.frx":0F3B
      ToolTipText     =   "Salida"
      Top             =   7440
      Width           =   480
   End
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   4680
      MouseIcon       =   "pedidoordentrabajoII.frx":177D
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoII.frx":1A87
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   3840
      MouseIcon       =   "pedidoordentrabajoII.frx":22C9
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoII.frx":25D3
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   5520
      MouseIcon       =   "pedidoordentrabajoII.frx":2E15
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoII.frx":311F
...
Sub Form_Load()
    ...
    Destino.AddItem ""
    Destino.AddItem "Aceptada"
    Destino.AddItem "Rechazada"
