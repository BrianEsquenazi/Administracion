...
Begin VB.Form PrgProyeccionMp 
   Caption         =   "18.-Proyeccion de Stock de Materias Primas"
   ClientHeight    =   7140
   ClientLeft      =   2100
   ClientTop       =   585
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2400
      ItemData        =   "ProyeccionMp.frx":0000
      Left            =   360
      List            =   "ProyeccionMp.frx":0007
      TabIndex        =   14
      Top             =   4560
      Visible         =   0   'False
      Width           =   7455
   ...
   End
End
Attribute VB_Name = "PrgProyeccionMp"
...
Private Sub Acepta_Click()
                ...
                Do
                    If .EOF = False Then
                        ...
                        If Proveedor.Text = "" Or Proveedor.Text = WProveedor Then
                            ...
                            Rem Vector(Suma, 4) = Str$(rstArticulo!Minimo)
    ...
    Sql1 = "DELETE AnalisisMp"
    spAnalisisMp = Sql1 + Sql2
    ...
    For Ciclo = 1 To LugarVector
        ...
        For ZCiclo = 1 To CicloHasta
            ...
            If WProducto <> "" Then
                ...
                ZSql = ZSql + " Where ProyeccionVenta.Articulo = " + "'" + WProducto + "'"
                    ...
                    With rstProyeccionVenta
                        ...
                        Do
                            If .EOF = False Then
                                ...
                                Auxi1 = Str$(rstProyeccionVenta!Ano)
                                Call Ceros(Auxi1, 4)
                                
                                Auxi2 = Str$(rstProyeccionVenta!Mes)
                                Call Ceros(Auxi2, 2)
                                
                                ZFecha = Auxi1 + Auxi2 + "01"
                            
                                If ZFecha >= WDesdeFecha And ZFecha <= WHastaFecha Then
                                    WVenta4 = Str$(Val(WVenta4) + rstProyeccionVenta!Cantidad)
                                End If
                ...
                WVenta4 = Str$(Val(WVenta4) / LugarMes)
                ...
                For XCiclo = 1 To LugarMes
                    ...
                    If Val(VentaMes(XCiclo, 3)) > Val(FabricaMayor) Then
                        FabricaMayor = VentaMes(XCiclo, 3)
                    End If
                Next XCiclo
                
                Rem WFabrica1 = FabricaMayor
                WFabrica1 = ""
    ...
    Listado.ReportFileName = "WproyeccionMpI.rpt"

    Listado.WindowTitle = "18.-Listado de Stock de Materias Primas inferior al minimo (Consolidado)"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT AnalisisMp.Codigo, AnalisisMp.Descripcion, AnalisisMp.Stock, AnalisisMp.Producto, AnalisisMp.StockProducto, AnalisisMp.Venta2, AnalisisMp.Venta3, AnalisisMp.Fabrica1, AnalisisMp.CantidadOrden, AnalisisMp.FechaEntrega, AnalisisMp.Proveedor, AnalisisMp.Porcentaje, AnalisisMp.Titulo, AnalisisMp.Orden " _
                    + "From " _
...
Sub Form_Load()
    ...
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgProyeccionMp.Caption = "Proyeccion de Stock de Materias Primas :  " + !Nombre
        End If
    End With
