...
Begin VB.Form PrgMetodoFiltrado 
   AutoRedraw      =   -1  'True
   Caption         =   "Ingreso de Metodos de Filtrado"
   ClientHeight    =   5745
   ClientLeft      =   300
   ClientTop       =   1005
   ClientWidth     =   11430
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "MetodoFiltrado.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "MetodoFiltrado.frx":030A
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "MetodoFiltrado.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "MetodoFiltrado.frx":0A56
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   840
         MouseIcon       =   "MetodoFiltrado.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "MetodoFiltrado.frx":11A2
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1560
         MouseIcon       =   "MetodoFiltrado.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "MetodoFiltrado.frx":18EE
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   2280
         MouseIcon       =   "MetodoFiltrado.frx":1D30
         MousePointer    =   99  'Custom
         Picture         =   "MetodoFiltrado.frx":203A
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   240
         MouseIcon       =   "MetodoFiltrado.frx":247C
         MousePointer    =   99  'Custom
         Picture         =   "MetodoFiltrado.frx":2786
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "MetodoFiltrado.frx":2BC8
      MousePointer    =   99  'Custom
      Picture         =   "MetodoFiltrado.frx":2ED2
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   2040
      MouseIcon       =   "MetodoFiltrado.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "MetodoFiltrado.frx":3A1E
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   360
      MouseIcon       =   "MetodoFiltrado.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "MetodoFiltrado.frx":456A
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   1200
      MouseIcon       =   "MetodoFiltrado.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "MetodoFiltrado.frx":50B6
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   4560
      MouseIcon       =   "MetodoFiltrado.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "MetodoFiltrado.frx":5C02
      ToolTipText     =   "Salida"
      Top             =   1320
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2880
      MouseIcon       =   "MetodoFiltrado.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "MetodoFiltrado.frx":674E
   ...
   End
End
Attribute VB_Name = "PrgMetodoFiltrado"
...
Sub Imprime_Datos()
    ...
    Sql3 = " Where MetodoFiltrado.Codigo = " + "'" + Codigo.Text + "'"
    ...
    If rstMetodoFiltrado.RecordCount > 0 Then
        Descripcion.Text = Trim(rstMetodoFiltrado!Descripcion)
...
Private Sub Acepta_Click()
    ...
    Listado.SQLQuery = "SELECT MetodoFiltrado.Codigo, MetodoFiltrado.Descripcion " _
                + "From " _
                + DSQ + ".dbo.MetodoFiltrado MetodoFiltrado " _
                + "Where " _
                + "MetodoFiltrado.Codigo >= " + Desde.Text + " AND " _
                + "MetodoFiltrado.Codigo <= " + Hasta.Text
    
    Listado.Connect = Connect()
    
    Listado.GroupSelectionFormula = "{MetodoFiltrado.Codigo} in " + Desde.Text + " to " + Hasta.Text
...
Private Sub cmdAdd_Click()
    If Val(Codigo.Text) <> 0 Then
        ...
        ZSql = ""
        ZSql = ZSql + "Select *"
        ZSql = ZSql + " FROM MetodoFiltrado"
        ZSql = ZSql + " Where MetodoFiltrado.Codigo = " + "'" + Codigo.Text + "'"
        spMetodoFiltrado = ZSql
        Set rstMetodoFiltrado = db.OpenRecordset(spMetodoFiltrado, dbOpenSnapshot, dbSQLPassThrough)
        If rstMetodoFiltrado.RecordCount > 0 Then
            rstMetodoFiltrado.Close
            ZSql = ""
            ZSql = ZSql + "UPDATE MetodoFiltrado SET "
            ...
            Set rstMetodoFiltrado = db.OpenRecordset(spMetodoFiltrado, dbOpenSnapshot, dbSQLPassThrough)
                Else
            ZSql = ""
            ZSql = ZSql + "INSERT INTO MetodoFiltrado ("
            ZSql = ZSql + "Codigo ,"
...
Private Sub cmdDelete_Click()
    ...
    If Val(Codigo.Text) <> 0 Then
        ...
        If rstMetodoFiltrado.RecordCount > 0 Then
            ...
            If Respuesta% = 6 Then
                Sql1 = "DELETE MetodoFiltrado"
                Sql2 = " Where Codigo = " + "'" + Codigo.Text + "'"
                spMetodoFiltrado = Sql1 + Sql2
                Set rstMetodoFiltrado = db.OpenRecordset(spMetodoFiltrado, dbOpenSnapshot, dbSQLPassThrough)
                Call CmdLimpiar_Click
            End If
        End If
...
Private Sub CmdLimpiar_Click()
    ...
    Set rstMetodoFiltrado = db.OpenRecordset(spMetodoFiltrado, dbOpenSnapshot, dbSQLPassThrough)
    If rstMetodoFiltrado.RecordCount > 0 Then
        rstMetodoFiltrado.MoveLast
        ZCodigo = IIf(IsNull(rstMetodoFiltrado!CodigoMayor), "0", rstMetodoFiltrado!CodigoMayor)
...
Private Sub Anterior_Click()
    ...
    If rstMetodoFiltrado.RecordCount > 0 Then
        With rstMetodoFiltrado
            .MoveLast
            Codigo.Text = rstMetodoFiltrado!Codigo
        End With
        rstMetodoFiltrado.Close
        Call Imprime_Datos
        Codigo.SetFocus
        ...
        A% = MsgBox(m$, 0, "Archivo de Metodos de Filtrado")
    End If
End Sub
...
Private Sub Opcion_Click()
    ...
    Select Case XIndice
        Case 0
            Sql1 = "Select *"
            Sql2 = " FROM MetodoFiltrado"
            Sql3 = " Order by MetodoFiltrado.Codigo"
            spMetodoFiltrado = Sql1 + Sql2 + Sql3
            Set rstMetodoFiltrado = db.OpenRecordset(spMetodoFiltrado, dbOpenSnapshot, dbSQLPassThrough)
            If rstMetodoFiltrado.RecordCount > 0 Then
                With rstMetodoFiltrado
                    ...
                    Do
                        If .EOF = False Then
                            ...
                            Pantalla.Col = 1
                            Pantalla.Text = rstMetodoFiltrado!Codigo
                            Pantalla.Col = 2
                            Pantalla.Text = rstMetodoFiltrado!Descripcion
...
Private Sub Primer_Click()
    ...
    Set rstMetodoFiltrado = db.OpenRecordset(spMetodoFiltrado, dbOpenSnapshot, dbSQLPassThrough)
    If rstMetodoFiltrado.RecordCount > 0 Then
        rstMetodoFiltrado.MoveFirst
        Codigo.Text = rstMetodoFiltrado!CodigoMenor
        rstMetodoFiltrado.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
...
Private Sub Ultimo_Click()
    ...
    If rstMetodoFiltrado.RecordCount > 0 Then
        rstMetodoFiltrado.MoveLast
        Codigo.Text = rstMetodoFiltrado!CodigoMayor
        rstMetodoFiltrado.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
