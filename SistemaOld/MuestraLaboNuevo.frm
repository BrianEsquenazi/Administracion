...
Begin VB.Form PrgMuestraLaboNuevo 
   ...
   Begin VB.ListBox pantalla 
      ...
      EndProperty
      Height          =   3420
      ItemData        =   "MuestraLaboNuevo.frx":0000
      Left            =   120
      List            =   "MuestraLaboNuevo.frx":0007
      TabIndex        =   1
      Top             =   3600
      Visible         =   0   'False
      Width           =   8175
   ...
   End
End
Attribute VB_Name = "PrgMuestraLaboNuevo"
    ...
    If WGraba = "S" Then
        ...
        If Actualiza.ListIndex = 1 Then
            ...
            If Articulo.Text <> "  -   -   " Then
                ...
                If WControla = 0 And Trim(Lote.Text) <> "" Then
                    WCanti = 0
                    XParam = "'" + Lote.Text + "','" _
                                + Articulo.Text + "'"
