...
Begin VB.Form Menu 
   BackColor       =   &H00808080&
   Caption         =   "Ingreso de Proyeccion de Ordenes de Trabajo de Pellital"
   ClientHeight    =   7815
   ClientLeft      =   2280
   ClientTop       =   780
   ClientWidth     =   7350
   ...
   Begin VB.Menu Maestros 
      ...
      Begin VB.Menu cargaproyeccion 
         Caption         =   "Carga de Proyeccion de Ordenes de Fabricacion"
      End
      Begin VB.Menu ListaProyeccion 
         Caption         =   "Emision de Proyeccion de Fabricacion"
      End
...
Private Sub cargaproyeccion_Click()
    PrgCargaProyeccion.Show
End Sub
...
Private Sub ListaProyeccion_Click()
    PrgListaProyeccion.Show
End Sub
