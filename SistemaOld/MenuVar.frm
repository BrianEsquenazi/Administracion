...
Begin VB.Form Menu 
   ...
   Begin VB.Menu Maestros 
      ...
      Begin VB.Menu Graba1 
         Caption         =   "Proceeo de Grabacion de Prestamos"
         Visible         =   0   'False
      End
      Begin VB.Menu Listprescon 
         Caption         =   "Listado de Prestamos entre Plantas Consolidado"
      End
