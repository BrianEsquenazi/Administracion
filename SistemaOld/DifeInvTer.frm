...
Begin VB.Form PrgDifeInvTer 
   ...
   End
End
Attribute VB_Name = "PrgDifeInvTer"
    ...
    With rstTerminado
        .MoveFirst
            ...
            Do
                ...
                End If
               Rem by nan 23-11
                If Left$(rstTerminado!Codigo, 2) = "PT" Or Left$(rstTerminado!Codigo, 2) = "RE" Or Left$(rstTerminado!Codigo, 2) = "NK" Or Left$(rstTerminado!Codigo, 2) = "SE" Then
                    Renglon = Renglon + 1
