...
Begin VB.Form PrgListStkFamDs 
   Caption         =   "Listado de Stock de Ds por Familia"
   ClientHeight    =   6495
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2760
      ItemData        =   "liststkfamds.frx":0742
      Left            =   120
      List            =   "liststkfamds.frx":0749
      TabIndex        =   1
      Top             =   3600
      Visible         =   0   'False
      Width           =   7815
   End
End
Attribute VB_Name = "PrgListStkFamDs"
...
Private Sub Acepta_Click()
    ...
    CargaEmpresa(2, 1) = "0008"
    CargaEmpresa(2, 2) = "Empresa08"
    ...
    WDesde = "DS-" + XDesde + "-000"
    WHasta = "DS-" + XHasta + "-999"
    ...
    Listado.WindowTitle = "Listado de Stock de DS por Familias"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WListStkFamDs.rpt"
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgListStkFamDs.Caption = "Listado de Stock de Ds por Familia :  " + !Nombre
        End If
    End With
