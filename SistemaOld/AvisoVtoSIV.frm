...
Begin VB.Form PrgAvisoVtoSIV 
   ...
   End
End
Attribute VB_Name = "PrgAvisoVtoSIV"
...
Private Sub Acepta_Click()
    ...
    ZTitulo = "Planta SIV   Fecha : " + Mid$(Date$, 4, 2) + "/" + Left$(Date$, 2) + "/" + Right$(Date$, 4)
