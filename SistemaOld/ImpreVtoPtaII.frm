...
Begin VB.Form PrgImpreVtoPtaII 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgImpreVtoPtaII"
...
Private Sub Acepta_Click()
    ...
    For ZZZCiclo = 1 To 2
        ...
        ZSql = ZSql + " Where VerificaVtoArti.ImpreII = " + "'" + "N" + "'"
