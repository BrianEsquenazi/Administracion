...
Begin VB.Form PrgpedidoOrdenTrabajoAutoriza 
   ...
   Begin RichTextLib.RichTextBox Agenda 
      ...
      RightMargin     =   8900
      AutoVerbMenu    =   -1  'True
      TextRTF         =   $"pedidoordentrabajoautoriza.frx":0000
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabPicture(0)   =   "pedidoordentrabajoautoriza.frx":007C
      ...
      TabPicture(1)   =   "pedidoordentrabajoautoriza.frx":0098
      ...
      TabPicture(2)   =   "pedidoordentrabajoautoriza.frx":00B4
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   6360
      MouseIcon       =   "pedidoordentrabajoautoriza.frx":00D0
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoautoriza.frx":03DA
      ToolTipText     =   "Salida"
      Top             =   7440
      Width           =   480
   End
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   5160
      MouseIcon       =   "pedidoordentrabajoautoriza.frx":0C1C
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoautoriza.frx":0F26
   ...
   End
End
Attribute VB_Name = "PrgpedidoOrdenTrabajoAutoriza"
...
Private Sub cmdAdd_Click()
    ...
    If Val(Pedido.Text) <> 0 And Respuesta.ListIndex >= 1 Then
...
Private Sub cmdClose_Click()
    PrgpedidoOrdenTrabajoAutoriza.Hide
    Unload Me
