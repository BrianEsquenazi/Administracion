...
Begin VB.Form PrgCcprvsel 
   ...
   Begin VB.ListBox Pantalla 
      Height          =   6495
      ItemData        =   "ccprvdel.frx":0000
      Left            =   6840
      List            =   "ccprvdel.frx":0007
      TabIndex        =   3
      Top             =   600
      Visible         =   0   'False
      Width           =   3975
...
Private Sub Acepta_Click()
    ...
    With rstImpCtaCtePrv
            ...
            Do
                ...
                If ZTotal <> 0 Then
                    AcumulaNetoII = ZNeto * WPorce
                        Else
                    If WTipoiva = 2 Then
                        AcumulaNetoII = (WSaldo / 1.21)
                            Else
                        AcumulaNetoII = WSaldo
                    End If
                End If
            
                If WPago = 2 Then
                    AcumulaNetoII = AcumulaNetoII + (WDife / 1.21)
                End If
                AcumulaNeto = AcumulaNeto + AcumulaNetoII
                
                
                If WTipoIb = 0 Or WTipoIb = 1 Then
                
                    WRete = AcumulaNeto * (WPorceIb / 100)
                    Call Redondeo(WRete)
                ...
                If WTipoIbCaba = 3 Or WTipoIbCaba = 4 Or WPorceIbCaba <> 0 Then
                    ...
                    If WTipoIbCaba <> 2 Then
                        ...
                        If Val(Wempresa) = 1 Then
                            ...
                            If AcumulaNeto >= 300 Then
                                If WPorceIbCaba <> 0 Then
                                    WRete = AcumulaNeto * (WPorceIbCaba / 100)
                                    Call Redondeo(WRete)
                                        Else
                                    If WTipoIbCaba = 3 Then
                                        WRete = AcumulaNeto * (3 / 100)
                                            Else
                                        WRete = AcumulaNeto * (4.5 / 100)
                                    End If
                                    Call Redondeo(WRete)
                                End If
                            End If
                ...
                If ZLetra = "M" Then
                    If ZNeto >= 1000 Then
                        AcumulaIva = AcumulaIva + ZIva
                    End If
                    WRetIb = WRetIb + AcumulaIva
                End If
...
Private Sub calculaRetencion()
    ...
    If WTipoprv = 1 Or WTipoprv = 2 Or WTipoprv = 3 Or WTipoprv = 6 Or WTipoprv = 7 Then
            ...
            If WRetencion < 20 Then
                WRetencion = 0
                        Else
                If WRetencion > AcumulaNeto Then
                        WRetencion = 0
                End If
            End If
