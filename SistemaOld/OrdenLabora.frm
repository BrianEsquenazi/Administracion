...
Begin VB.Form PrgOrdenLabora 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Orden de Compra de Materias Primas para Laboratorio"
   ClientHeight    =   8595
   ClientLeft      =   75
   ClientTop       =   330
   ClientWidth     =   11835
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   4095
      Left            =   240
      OleObjectBlob   =   "OrdenLabora.frx":0000
      TabIndex        =   3
      Top             =   600
      Width           =   9015
   End
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2205
      ItemData        =   "OrdenLabora.frx":09CA
      Left            =   3840
      List            =   "OrdenLabora.frx":09D1
      TabIndex        =   1
      Top             =   5880
      Visible         =   0   'False
      Width           =   6615
   ...
   End
End
Attribute VB_Name = "PrgOrdenLabora"
