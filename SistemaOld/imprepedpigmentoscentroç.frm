...
Private Sub Acepta_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "Select Pedido.Proceso1, Pedido.TipoPedido, Pedido.Pedido, Pedido.TipoPed "
    ZSql = ZSql + " FROM Pedido"
    ZSql = ZSql + " Where Pedido.Proceso1 = 2"
    ZSql = ZSql + " and (Pedido.TipoPedido = 2 or Pedido.TipoPedido = 3)"
...
Private Sub Aviso_DragDrop(Source As Control, X As Single, Y As Single)
