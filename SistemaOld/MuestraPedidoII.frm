...
Begin VB.Form PrgMuestraPedidoII 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "MuestraPedidoII.frx":0000
      Left            =   120
      List            =   "MuestraPedidoII.frx":0007
      TabIndex        =   25
      Top             =   4920
      Visible         =   0   'False
      Width           =   4695
   ...
   End
End
Attribute VB_Name = "PrgMuestraPedidoII"
