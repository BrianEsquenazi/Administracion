...
Begin VB.Form PrgCargaSacAccion 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2460
      ItemData        =   "Cargasacadcional.frx":0000
      Left            =   360
      List            =   "Cargasacadcional.frx":0007
      TabIndex        =   15
      Top             =   4440
      Visible         =   0   'False
      Width           =   4695
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   6600
      MouseIcon       =   "Cargasacadcional.frx":0015
      MousePointer    =   99  'Custom
      Picture         =   "Cargasacadcional.frx":031F
      ToolTipText     =   "Salida"
      Top             =   6720
      Width           =   480
   End
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   8760
      MouseIcon       =   "Cargasacadcional.frx":0B61
      MousePointer    =   99  'Custom
      Picture         =   "Cargasacadcional.frx":0E6B
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "Cargasacadcional.frx":16AD
      MousePointer    =   99  'Custom
      Picture         =   "Cargasacadcional.frx":19B7
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   5640
      MouseIcon       =   "Cargasacadcional.frx":21F9
      MousePointer    =   99  'Custom
      Picture         =   "Cargasacadcional.frx":2503
...
Private Sub cmdAdd_Click()
    ...
    If Tipo.Text <> "" And Ano.Text <> "" And Numero.Text <> "" Then
        ...
        If ZRespuesta% = 6 Then
            ...
            ZZEmail = "ebiglieri@surfactan.com.ar"
            
            sTo = ZZEmail
            sCC = ""
            sBCC = ""
            sSubject = "Aviso de Acciones Correctivas"
            sBody = "Se ingresaron accciones corectivas del " + DesTipo.Caption + " : " + Ano.Text + "/" + Numero.Text + " para su implemenatacion"
    ...
    If KeyAscii = 13 Then
        If Numero.Text <> "" Then
            ...
            If rstCargaSac.RecordCount > 0 Then
                ...
                rstCargaSac.Close
                If ZResponsableDestino = ZZCodigoResponsable Or ZZCodigoResponsable = 99 Then
                    Call Imprime_Datos
                    Accion11.SetFocus
                        Else
                    m$ = "La SAC esta asignada a otro responsable"
                    A% = MsgBox(m$, 0, "Archivo de Carga de Acciones de SAC")
                End If
