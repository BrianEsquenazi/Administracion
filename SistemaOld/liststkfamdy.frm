...
Begin VB.Form PrgListStkFamDy 
   Caption         =   "Listado de Stock de Dy por Familia"
   ClientHeight    =   6495
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2760
      ItemData        =   "liststkfamdy.frx":0742
      Left            =   120
      List            =   "liststkfamdy.frx":0749
      TabIndex        =   1
      Top             =   3600
      Visible         =   0   'False
      Width           =   7815
   End
End
Attribute VB_Name = "PrgListStkFamDy"
...
Private Sub Acepta_Click()
    ...
    WDesde = "DY-" + XDesde + "-000"
    WHasta = "DY-" + XHasta + "-999"
    ...
    Listado.WindowTitle = "Listado de Stock de DY por Familias"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WListStkFamDy.rpt"
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgListStkFamDy.Caption = "Listado de Stock de Dy por Familia :  " + !Nombre
        End If
    End With
