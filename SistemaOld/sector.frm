...
Begin VB.Form PrgSector 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "sector.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "sector.frx":030A
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "sector.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "sector.frx":0A56
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   840
         MouseIcon       =   "sector.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "sector.frx":11A2
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1560
         MouseIcon       =   "sector.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "sector.frx":18EE
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   2280
         MouseIcon       =   "sector.frx":1D30
         MousePointer    =   99  'Custom
         Picture         =   "sector.frx":203A
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   240
         MouseIcon       =   "sector.frx":247C
         MousePointer    =   99  'Custom
         Picture         =   "sector.frx":2786
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "sector.frx":2BC8
      MousePointer    =   99  'Custom
      Picture         =   "sector.frx":2ED2
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   2040
      MouseIcon       =   "sector.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "sector.frx":3A1E
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   360
      MouseIcon       =   "sector.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "sector.frx":456A
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   1200
      MouseIcon       =   "sector.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "sector.frx":50B6
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   4560
      MouseIcon       =   "sector.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "sector.frx":5C02
      ToolTipText     =   "Salida"
      Top             =   1440
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2880
      MouseIcon       =   "sector.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "sector.frx":674E
...
Private Sub Anterior_Click()
    ...
    If rstSector.RecordCount > 0 Then
        ...
        A% = MsgBox(m$, 0, "Archivo de Sectores")
    End If
End Sub
