...
Begin VB.Form PrgMinTerPlanta 
   Caption         =   "Listado de Stock de Minimo por Planta"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "WMinterPlanta.rpt"
      Destination     =   1
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "MinTerPlanta.frx":0000
      Left            =   840
      List            =   "MinTerPlanta.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
   ...
   End
End
Attribute VB_Name = "PrgMinTerPlanta"
...
Private Sub Acepta_Click()
        ...
        If rstTerminado.RecordCount > 0 Then
            ...
            With rstTerminado
                ...
                Do
                    If .EOF = False Then
    Rem BY NAN
              Rem    If UCase(rstTerminado!Codigo) = "PT-00027-100" Then
               Rem   Stop
               Rem   End If
                ...
                If Desde.Text <= UCase(rstTerminado!Codigo) And Hasta.Text >= UCase(rstTerminado!Codigo) Then
                            ...
                            WMinimo = IIf(IsNull(rstTerminado!Minimo1), "0", rstTerminado!Minimo1)
                            
                            If XSaldo <> 0 Or WMinimo <> 0 Then
                                ...
                                Vector(Suma, 4) = IIf(IsNull(rstTerminado!Minimo1), "0", rstTerminado!Minimo1)
        ...
        For Ciclo = 1 To Suma
            ...
            If Left$(Terminado, 8) < "PT-50000" Or Left$(Terminado, 8) > "PT-51000" Then
            ...
            If rstMinimo.RecordCount > 0 Then
                    ...
                    Minimo1 = Str$(rstMinimo!Minimo1)
                    minimo2 = Str$(rstMinimo!minimo2)
                    Minimo3 = Str$(rstMinimo!Minimo3)
                    minimo4 = Str$(rstMinimo!minimo4)
                    minimo5 = Str$(rstMinimo!minimo5)
                    ...
                    Select Case a
                        ...
                        Case 1
                           ...
                           Minimo1 = Str$(Val(Minimo1) + Val(Minimo))
                            
                        Case 2
                            Stock2 = Str$(Val(Stock2) + Val(Stock))
                            minimo2 = Str$(Val(minimo2) + Val(Minimo))
                        ...
                        Case 3
                            ...
                            Minimo3 = Str$(Val(Minimo3) + Val(Minimo))
                            
                                                                          
                        
                        Case 4, 6, 7
                            Stock4 = Str$(Val(Stock4) + Val(Stock))
                            minimo4 = Str$(Val(minimo4) + Val(Minimo))
                        ...
                        Case 5
                           ...
                           minimo5 = Str$(Val(minimo5) + Val(Minimo))
                    ...
                    spMinimo = "ModificaMinimoPlanta " + XParam
                    Set rstMinimo = db.OpenRecordset(spMinimo, dbOpenSnapshot, dbSQLPassThrough)
                    ...
                    spMinimo = "AltaMinimoPlanta " + XParam
                    Set rstMinimo = db.OpenRecordset(spMinimo, dbOpenSnapshot, dbSQLPassThrough)
    ...
    spMinimo = "ModificaMinimoDifePlanta "
    Set rstMinimo = db.OpenRecordset(spMinimo, dbOpenSnapshot, dbSQLPassThrough)
    ...
    Listado.SQLQuery = "SELECT Minimo.Terminado, Minimo.Descripcion, Minimo.Stock1, Minimo.Stock2, Minimo.Stock3, Minimo.Stock4, Minimo.Stock5, Minimo.Minimo1, Minimo.Minimo2, Minimo.Minimo3, Minimo.Minimo4, Minimo.Minimo5, Minimo.Dife1, Minimo.Dife2, Minimo.Dife3, Minimo.Dife4, Minimo.Dife5 " _
                        + "From " _
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgMinTerPlanta.Caption = "Listado de Stock Minimo por Planta :  " + !Nombre
        End If
    End With
    Desde.Text = "  -     -   "
    Hasta.Text = "  -     -   "
