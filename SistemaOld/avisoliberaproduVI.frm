...
Begin VB.Form PrgAvisoLiberaProduVI 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoLiberaProduVI"
...
Private Sub Acepta_Click()
    ...
    Sql3 = " Where LiberaTerminado.ImpreProdIII = " + "'" + "S" + "'"
    Sql4 = " and (LiberaTerminado.TipoPro = 'PT'"
    Sql5 = " or LiberaTerminado.TipoPro = 'BI')"
...
Private Sub Imprime_Click()
    ...
    Listado.ReportFileName = "ListaLiberadoIII.RPT"
    ...
    Listado.SQLQuery = "SELECT LiberaTerminado.Producto, LiberaTerminado.Fecha, LiberaTerminado.Partida, LiberaTerminado.PartiOri, LiberaTerminado.Observa, LiberaTerminado.ImpreProdI, LiberaTerminado.ImpreProdII, LiberaTerminado.ImpreProdIII " _
                ...
                + "WHERE " _
                + "LiberaTerminado.ImpreProdIII = 'S' AND " _
                + "LiberaTerminado.TipoPro >= 'PT' AND " _
                + "LiberaTerminado.TipoPro <= 'PT'"
    ...
    Listado.SQLQuery = "SELECT LiberaTerminado.Producto, LiberaTerminado.Fecha, LiberaTerminado.Partida, LiberaTerminado.PartiOri, LiberaTerminado.Observa, LiberaTerminado.ImpreProdI, LiberaTerminado.ImpreProdII, LiberaTerminado.ImpreProdIII " _
                ...
                + "WHERE " _
                + "LiberaTerminado.ImpreProdIII = 'S' AND " _
                + "LiberaTerminado.TipoPro >= 'BI' AND " _
                + "LiberaTerminado.TipoPro <= 'BI'"
