...
Begin VB.Form PrgVariosLetraB 
   ...
   Begin VB.ComboBox TipoFac 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "variosletrab.frx":0000
      Left            =   9360
      List            =   "variosletrab.frx":0002
      TabIndex        =   65
      Top             =   0
      Width           =   1935
   End
   Begin VB.ComboBox ReteCiudad 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "variosletrab.frx":0004
      Left            =   9360
      List            =   "variosletrab.frx":0006
      TabIndex        =   63
      Top             =   720
      Width           =   1935
   End
   Begin VB.ComboBox ReteIb 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "variosletrab.frx":0008
      Left            =   9360
      List            =   "variosletrab.frx":000A
      TabIndex        =   59
      Top             =   360
      Width           =   1935
   End
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3495
      Left            =   360
      OleObjectBlob   =   "variosletrab.frx":000C
      TabIndex        =   3
      Top             =   1560
      Width           =   8655
   End
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1815
      ItemData        =   "variosletrab.frx":09FA
      Left            =   120
      List            =   "variosletrab.frx":0A01
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   5295
   ...
   End
End
Attribute VB_Name = "PrgVariosLetraB"
...
Private Sub Calcula_Cae()
    ...
    Rem BY NAN  23-11-2015
       Rem  ZZImpoIva = (Val(Iva1.Caption) + Val(Iva2.Caption))
   Rem BY NAN 23-11-2015
          
     ZZImpoIva = Val(Iva1.Caption)
     ZZIMPOIVA10 = Val(Iva2.Caption)
    
       
    Rem fin BY NAN 23-11-2015
    ...
    If ZZImpoIva <> 0 Then
                ...
                ok = WSFEv1.AgregarIva(id, base_imp, Importe)
                    Rem BY NAN 23-11-2015 AGREGO 10.5
                       If ZZIMPOIVA10 <> 0 Then
                          id = 4 ' 10.5%
                          base_imp = ZZImpoNeto
                          Importe = ZZIMPOIVA10
                          ok = WSFEv1.AgregarIva(id, base_imp, Importe)
...
Private Sub Calcula_Barra()
    ...
    Rem ZZNumero = "41424344454647484950515253545º55657585960"
