...
Begin VB.Form Menu 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00808080&
   Caption         =   "Agenda de Responsables"
   ClientHeight    =   7890
   ClientLeft      =   840
   ClientTop       =   795
   ClientWidth     =   10440
   ...
   Begin VB.Menu sdf 
      ...
      End
      Begin VB.Menu Grupo 
         Caption         =   "Ingresos de Grupo de Responsables"
      End
      Begin VB.Menu AgendaCargaTarea 
         Caption         =   "Planificacion de Eventos"
      End
   End
   Begin VB.Menu asas 
      Caption         =   "Listados"
      Begin VB.Menu ListaAgendaRespo 
         Caption         =   "Listado de Agenda de Resposanble"
      End
      Begin VB.Menu ListaTareaAsignada 
         Caption         =   "Listado de Tareas Asignadas"
      End
   End
...
Private Sub Form_Activate()
    ...
    Menu.Caption = "Agenda de Responsables : " + ZZOperadorResponsableNombre
...
Private Sub ListaAgendaRespo_Click()
    PrgListaAgendaRespo.Show
End Sub

Private Sub ListaTareaAsignada_Click()
    PrgListaTareaAsignada.Show
End Sub
