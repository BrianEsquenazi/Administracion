...
Stop
            ...
            Do
                ...
                If rstPrueart.RecordCount > 0 Then
                    ...
                    XParam = "'" + WPrueba + "','" + WProducto + "','" _
                                ...
                                + Wvalor9 + "','" + Wvalor10 + "','" _
                                + WEnsayo + "','" + WAspecto + "','" _
                                + WObservaciones + "','" + WObserva2 + "','" _
                                + WConfecciono + "','" + WLiberada + "','" _
                                + WDevuelta + "','" + WLote + "','" _
                                + WRechazo + "','" + WNueva + "','" + WFechaord + "','" _
                                + WDate + "'"
    ...
    Rem                 XParam = "'" + WProducto + "','" + WEnsayo1 + "','" _
    rem                     + WValor1 + "','" + WEnsayo2 + "','" _
    rem                     + Wvalor2 + "','" + WEnsayo3 + "','" _
    rem                     + WValor3 + "','" + WEnsayo4 + "','" _
    rem                     + Wvalor4 + "','" + WEnsayo5 + "','" _
    rem                     + Wvalor5 + "','" + WEnsayo6 + "','" _
    rem                     + Wvalor6 + "','" + WEnsayo7 + "','" _
    rem                     + Wvalor7 + "','" + WEnsayo8 + "','" _
    rem                     + Wvalor8 + "','" + WEnsayo9 + "','" _
    rem                     + Wvalor9 + "','" + WEnsayo10 + "','" _
    rem                     + Wvalor10 + "','" + WDate + "'"
            ...
            Do
                ...
                If rstCtacte.RecordCount > 0 Then
                        ...
                        XParam = "'" + WClave + "','" _
                            ...
                            + WCosto + "','" + WImporte1 + "','" _
                            + WImporte2 + "','" + WImporte3 + "','" _
                            + WImporte4 + "','" + WImporte5 + "','" _
                            + WImporte6 + "','" + WImporte7 + "','" _
                            + WDate + "'"
