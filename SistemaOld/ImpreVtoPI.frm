...
Begin VB.Form PrgImpreVtoSi 
   ...
   End
End
Attribute VB_Name = "PrgImpreVtoSi"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where VerificaVtoArti.ImpreI = " + "'" + "N" + "'"
...
Private Sub Impresion()
    ...
    Listado.SQLQuery = "SELECT VerificaVtoArti.Codigo, VerificaVtoArti.Articulo, VerificaVtoArti.EmpresaPartida, VerificaVtoArti.Partida, VerificaVtoArti.EmpresaTipo, VerificaVtoArti.Tipo, VerificaVtoArti.Numero, VerificaVtoArti.Fecha, VerificaVtoArti.Stock, VerificaVtoArti.StockI, VerificaVtoArti.StockII, VerificaVtoArti.StockIII, VerificaVtoArti.StockIV, VerificaVtoArti.StockV, VerificaVtoArti.StockVI, VerificaVtoArti.StockVII, " _
            + "Articulo.Descripcion " _
            + "From " _
            + DSQ + ".dbo.VerificaVtoArti VerificaVtoArti, " _
            + DSQ + ".dbo.Articulo Articulo " _
            + "Where " _
            + "VerificaVtoArti.Articulo = Articulo.Codigo AND " _
            + "VerificaVtoArti.Numero >= 0 AND " _
            + "VerificaVtoArti.Numero <= 999999"
