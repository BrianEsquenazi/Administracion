...
Begin VB.Form PrgMovcon1 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   3960
      ItemData        =   "Movcon1.frx":0000
      Left            =   120
      List            =   "Movcon1.frx":0007
      TabIndex        =   2
      Top             =   2040
      Visible         =   0   'False
      Width           =   7815
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " and Estadistica.Articulo >= " + "'" + Desde.Text + "'"
    ZSql = ZSql + " and Estadistica.Articulo <= " + "'" + Hasta.Text + "'"
    spEstadistica = ZSql
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgMovcon1.Caption = "Listado de Mercaderia en remitos a facturar por articulo :  " + !Nombre
        End If
    End With
    Desde.Text = "  -     -   "
    Hasta.Text = "  -     -   "
