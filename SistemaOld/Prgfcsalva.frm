...
Begin VB.Form PrgFcsalva 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "Prgfcsalva.frx":0000
      Left            =   6480
      List            =   "Prgfcsalva.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   4095
      Left            =   120
      OleObjectBlob   =   "Prgfcsalva.frx":0015
      TabIndex        =   2
      Top             =   1560
      Width           =   11415
   End
...
Stop
        ...
        With rstEstadistica
            ...
            Do
                If .EOF = False Then
                    ...
                    Vector(Renglon) = rstEstadistica!Clave
    ...
    For da = 1 To Renglon
        ...
        spEstadistica = "ConsultaEstadistica " + XParam
        Set rstEstadistica = db.OpenRecordset(spEstadistica, dbOpenSnapshot, dbSQLPassThrough)
        If rstEstadistica.RecordCount > 0 Then
        
            XParidad = Paridad.Text
            XPrecio = Str$(rstEstadistica!Precio * Val(Paridad.Text))
            XImporte = Str$(rstEstadistica!Importe * Val(Paridad.Text))
            ...
            spEstadistica = "ModificaEstadisticaSalva " + XParam
            Set rstEstadistica = db.OpenRecordset(spEstadistica, dbOpenSnapshot, dbSQLPassThrough)
        End If
    ...
    If rstCtacte.RecordCount > 0 Then
        XParidad = Paridad.Text
        XNet = Str$(rstCtacte!Neto * Val(Paridad.Text))
        XIva1 = Str$(rstCtacte!Iva1 * Val(Paridad.Text))
        XIva2 = Str$(rstCtacte!Iva2 * Val(Paridad.Text))
        rstCtacte.Close
        ...
        spCtacte = "ModificaCtacteSalva " + XParam
        Set rstCtacte = db.OpenRecordset(spCtacte, dbOpenSnapshot, dbSQLPassThrough)
    End If
