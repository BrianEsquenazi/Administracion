...
Private Sub Acepta_Click()
    ...
    Sql6 = " and Cliente.Rubro >= " + "'" + Desde.Text + "'"
    Sql7 = " and Cliente.Rubro <= " + "'" + Hasta.Text + "'"
    ...
    Dos = " and {Estadistica.Rubro} in " + Desde.Text + " to " + Hasta.Text
