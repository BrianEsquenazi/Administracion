...
Begin VB.Form PrgProveAdicionalParte2 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   3840
      MouseIcon       =   "proveadicionalparte2.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "proveadicionalparte2.frx":030A
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   5400
      MouseIcon       =   "proveadicionalparte2.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "proveadicionalparte2.frx":0E56
      ToolTipText     =   "Salida"
      Top             =   2040
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "PrgProveAdicionalParte2"
...
Sub Imprime_Datos()
    ...
    If rstProveedorAdicional.RecordCount > 0 Then
        Descri21.Text = Trim(rstProveedorAdicional!Descri21)
        Descri22.Text = Trim(rstProveedorAdicional!Descri22)
        Descri23.Text = Trim(rstProveedorAdicional!Descri23)
