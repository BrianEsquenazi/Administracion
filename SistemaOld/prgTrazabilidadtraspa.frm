...
Begin VB.Form PrgTrazabilidadTraspa 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgTrazabilidadTraspa"
...
Dim ZZImpre1 As String
Dim ZZImpre2 As String
Dim ZZImpre3 As String
Dim ZZImpre4 As String
Dim ZZImpre5 As String
Dim ZZImpre6 As String
Dim ZZImpre7 As String
Dim ZZImpre8 As String
Dim ZZImpre9 As String
Dim ZZImpre10 As String
Dim ZZImpre11 As String
Dim ZZImpre12 As String
Dim ZZImpre13 As String
Dim ZZImpre14 As String
Dim ZZImpre15 As String
Dim ZZImpre16 As String
Dim ZZImpre17 As String
Dim ZZImpre18 As String
Dim ZZImpre19 As String
Dim ZZImpre20 As String
Dim ZZImpre21 As String
Dim ZZImpre22 As String
Dim ZZImpre23 As String
Dim ZZImpre24 As String
...
Private Sub Procesar_Click()
    ...
    For Ciclo = 1 To ZZLugarII
        ...
        If Trim(XXProveedor) <> "" Then
            ...
            If rstIvaComp.RecordCount > 0 Then
                ...
                ZZHoja(Ciclo, 23) = rstIvaComp!nrointerno
                ZZHoja(Ciclo, 25) = Str$(rstIvaComp!Paridad)
                rstIvaComp.Close
            End If
    ...
    For Ciclo = 1 To ZZLugarII
        ...
        If Trim(ZZHoja(Ciclo, 23)) <> "" Then
            ...
            XXDesArticulo = ZZHoja(Ciclo, 21)
            XXCantidadTotal = ZZHoja(Ciclo, 22)
            XXClaveIva = ZZHoja(Ciclo, 23)
            XXMoneda = ZZHoja(Ciclo, 24)
            XXParidad = ZZHoja(Ciclo, 25)
            
            Select Case Val(XXMoneda)
                Case 0
                    If Val(XXParidad) <> 0 Then
                    
                        XXCosto = XXCosto * Val(XXParidad)
                        
                            Else
                            
                        WAno = Right$(XXFechaCompo, 4)
                        WMes = Mid$(XXFechaCompo, 4, 2)
                        WDia = Left$(XXFechaCompo, 2)
                        XClaveParidad = WAno + WMes + WDia
                    
                        spCambios = "ConsultaCambioOrdFecha  " + "'" + XClaveParidad + "'"
                        Set rstCambios = db.OpenRecordset(spCambios, dbOpenSnapshot, dbSQLPassThrough)
                        If rstCambios.RecordCount > 0 Then
                            With rstCambios
                                .MoveLast
                                ParidadI = rstCambios!Cambio
                            ...
                            ParidadII = 1
                        End If
                        XXCosto = XXCosto * ParidadI
                            
                    End If
                    
                Case 2
                    WAno = Right$(XXFechaCompo, 4)
                    WDia = Mid$(XXFechaCompo, 4, 2)
                    WMes = Left$(XXFechaCompo, 2)
                    XClaveParidad = WAno + WMes + WDia
                    ...
                    If rstCambios.RecordCount > 0 Then
                        ...
                        ParidadII = 1
                    End If
                    XXCosto = XXCosto * ParidadII
                
                Case Else
            End Select
            
            Toto = XXCosto * Val(XXCantiLote)
            If Toto < 1 Then Stop
            ...
            With rstTrazabilidad
                ...
                If .NoMatch = True Then
                    ...
                    .Update
                        Else
                    .Edit
                    !Costo = !Costo + (XXCosto * Val(XXCantiLote))
    ...
    Rem BY NAN 3-02-2013
    
    XNombre = "C:\RECUIVA\Retorno.Txt"
    ...
    With rstTrazabilidad
        ...
        If .NoMatch = False Then
            Do
                ...
                ZSql = ZSql + "Select *"
                ZSql = ZSql + " FROM IvaComp"
                ZSql = ZSql + " Where IvaComp.NroInterno = " + "'" + ZZClave + "'"
                spIvaComp = ZSql
                Set rstIvaComp = db.OpenRecordset(spIvaComp, dbOpenSnapshot, dbSQLPassThrough)
                If rstIvaComp.RecordCount > 0 Then
                    ZZFecha = rstIvaComp!Fecha
                    ZZPeriodo = rstIvaComp!Periodo
                    ZZPunto = rstIvaComp!Punto
                    ZZNumero = rstIvaComp!Numero
                    ZZProveedor = rstIvaComp!Proveedor
                    ZZNeto = rstIvaComp!Neto
                    ZZIva = rstIvaComp!Iva21 + rstIvaComp!Iva5 + rstIvaComp!Iva27
                    rstIvaComp.Close
                End If
                ...
                ZZIvaRetorno = 0
                If ZZNeto <> 0 And ZZIva <> 0 Then
                    ZZCostoI = !Costo
                    ZZPorce = (ZZCostoI / ZZNeto)
                    ZZIvaRetorno = ZZIva * ZZPorce
                    Call Redondeo(ZZIvaRetorno)
                End If
                
                If Int(ZZIvaRetorno * 100) > 0 Then
                
                    Rem tipo de comprabante  --> 001 factura
                    ZZImpre1 = "001"
                
                    Rem fecha de comprabante
                    ZZImpre2 = Right$(ZZFecha, 4) + Mid$(ZZFecha, 4, 2) + Left$(ZZFecha, 2)
                
                    Rem punto de venta
                    ZZImpre3 = ZZPunto
                    Call Ceros(ZZImpre3, 4)
                
                    Rem numero de factura
                    ZZImpre4 = ZZNumero
                    Call Ceros(ZZImpre4, 16)
                    ...
                    Rem Razon Social
                    ZZImpre6 = Left$(ZZRazon + Space$(40), 40)
                
                    Rem
                    ZZImpre7 = "00000000000"
                
                    Rem
                    ZZImpre8 = Space$(40)
                
                    Rem neto de la factura
                    ZZImpre9 = Str$(Int(ZZNeto * 100))
                    Call Ceros(ZZImpre9, 15)
                
                    Rem iva de la factura
                    ZZImpre10 = Str$(Int(ZZIva * 100))
                    Call Ceros(ZZImpre10, 15)
                
                    Rem
                    ZZImpre11 = "0"
                    Call Ceros(ZZImpre11, 15)
                
                    Rem iva a solicitar
                    ZZImpre12 = Str$(Int(ZZIvaRetorno * 100))
                    Rem ZZImpre12 = Str$(Int(ZZIva * 100))
                    Call Ceros(ZZImpre12, 15)
                
                    Rem
                    ZZImpre13 = "0"
                    Call Ceros(ZZImpre13, 15)
                
                    ZZfechaOrden = "000000"
                    Rem Periodo de pago
                    ZZImpre14 = ZZfechaOrden
                
                    Rem periosdo de iva
                    ZZImpre15 = Right$(ZZPeriodo, 4) + Mid$(ZZPeriodo, 4, 2)
                
                    Rem Descripcion del bien
                    ZZImpre16 = Left$("Materia Prima" + Space$(40), 40)
                
                    Rem iva depositado en cbu
                    ZZImpre17 = "0"
                    Call Ceros(ZZImpre17, 15)
                
                    Rem codigo de regimen
                    ZZImpre18 = "000"
                
                    Rem numero de  certificado
                    ZZImpre19 = "00000000000000"
                
                    Rem motivo de no retencion
                    ZZImpre20 = "0"
                
                    Rem RG. Certificad de excusion
                    ZZImpre21 = "00"
                    ...
                    Rem topo de credito fiscal
                    ZZImpre24 = "D"
            
                    WImpre = ZZImpre1 + ZZImpre2 + ZZImpre3 + ZZImpre4 + ZZImpre5 + ZZImpre6 + ZZImpre7 + ZZImpre8 + ZZImpre9 + ZZImpre10 + ZZImpre11 + ZZImpre12 + ZZImpre13 + ZZImpre14 + ZZImpre15 + ZZImpre16 + ZZImpre17 + ZZImpre18 + ZZImpre19 + ZZImpre20 + ZZImpre21 + ZZImpre22 + ZZImpre23 + ZZImpre24
    ...
    a = MsgBox(m$, 0, "Exportacion de Datos para la Trazabilidad")
...
Private Sub Proceso1_Click()
    ...
    For Ciclo = 1 To 999
        If Trim(WVector1.TextMatrix(Ciclo, 1)) = "" Then
            DesdeRenglon = Ciclo - 1
            Exit For
        End If
    Next Ciclo
    
    Renglon = DesdeRenglon
    ...
    For Da = 1 To XRenglon
        ...
        Auxi1 = WVector1.TextMatrix(Da, 1)
