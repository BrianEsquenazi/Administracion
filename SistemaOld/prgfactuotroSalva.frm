...
Begin VB.Form PrgFactuSalva 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "prgfactuotroSalva.frx":0000
      Left            =   4200
      List            =   "prgfactuotroSalva.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "prgfactuotroSalva.frx":0015
      TabIndex        =   2
      Top             =   1680
      Width           =   11415
   End
   ...
   End
End
Attribute VB_Name = "PrgFactuSalva"
...
Private Sub Calcula_Importe()
    ...
    Set rstCliente = db.OpenRecordset(spCliente, dbOpenSnapshot, dbSQLPassThrough)
    If rstCliente.RecordCount > 0 Then
        Rem ZZPorceIbCaba = IIf(IsNull(rstCliente!PorceIbCaba), "0", rstCliente!PorceIbCaba)
        ZZPorceIbCaba = 0
        rstCliente.Close
    End If
...
Private Sub XFactu_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub ZZProceso()
    ...
    ZSql = ZSql + " FROM Estadistica"
    ZSql = ZSql + " Where EStadistica.Tipo = " + "'" + "01" + "'"
    ZSql = ZSql + " and Estadistica.Numero = " + "'" + Xfactu.Text + "'"
    spEstadistica = ZSql
    Set rstEstadistica = db.OpenRecordset(spEstadistica, dbOpenSnapshot, dbSQLPassThrough)
    If rstEstadistica.RecordCount > 0 Then
