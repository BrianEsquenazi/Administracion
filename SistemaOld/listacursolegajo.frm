...
Begin VB.Form PrgListaCursoLegajo 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Cursos por Legajo"
   ClientHeight    =   6690
   ClientLeft      =   2010
   ClientTop       =   735
   ClientWidth     =   8085
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Consulta 
         Height          =   480
         Left            =   4680
         MouseIcon       =   "listacursolegajo.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "listacursolegajo.frx":030A
   ...
   End
End
Attribute VB_Name = "PrgListaCursoLegajo"
...
Private Sub Acepta_Click()
    ...
    Uno = "{Cursadas.Legajo} in " + Desde.Text + " to " + Hasta.Text + " and "
    ...
    Select Case Tipo.ListIndex
         Case 1
            Listado.SQLQuery = "SELECT Cursadas.Codigo, Cursadas.Curso, Cursadas.Fecha, Cursadas.OrdFecha, Cursadas.Horas, Cursadas.Legajo, Cursadas.DesLegajo, Cursadas.Observaciones, Cursadas.TipoCursada, " _
                + "Curso.Descripcion " _
                + "From " _
                ...
                + "Cursadas.Legajo >= " + Desde.Text + " AND " _
                + "Cursadas.Legajo <= " + Hasta.Text + " AND " _
    ...
    Listado.ReportFileName = "WListaCursoLegajo.rpt"
    Listado.Action = 1
