...
Begin VB.Form PrgAltaCertificadoAuto 
   ...
   Begin VB.ListBox pantalla 
      ...
      EndProperty
      Height          =   1020
      ItemData        =   "AltaCertificadoAuto.frx":0000
      Left            =   120
      List            =   "AltaCertificadoAuto.frx":0007
      TabIndex        =   58
      Top             =   7080
      Visible         =   0   'False
      Width           =   7575
   ...
   End
End
Attribute VB_Name = "PrgAltaCertificadoAuto"
...
Private Sub Form_Load()
    ...
    With rstEmpresa
        ...
        If .NoMatch = False Then
            PrgAltaCertificadoAuto.Caption = "Ingreso de Datos a Imprimir en las Certificados de Analisis:  " + !Nombre
        End If
    End With
