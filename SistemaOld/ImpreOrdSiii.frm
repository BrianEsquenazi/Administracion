...
Begin VB.Form PrgImpreOrdSiii 
   ...
   End
End
Attribute VB_Name = "PrgImpreOrdSiii"
...
Private Sub Acepta_Click()
    ...
    Rem Lugar = 1
    Rem Vector(Lugar) = 3880

    If Lugar > 0 Then
        PrgImpreOrdSiii.Refresh
        Aviso.Visible = True
        Aviso.Refresh
        For a = 1 To 10
            Beep
...
Private Sub Impresion()
    ...
    Listado.ReportFileName = "OrdenImpreFarma.rpt"
...
Private Sub ImpresionAnterior()
    ...
    Print #1, Tab(1); "|Categoria..:"; Tab(20); WCategoriaI;
    If Val(WCarpeta) <> 0 Then
        Print #1, Tab(50); "Carpeta.....:"; WCarpeta;
        Print #1, Tab(80); "|"
            Else
        Print #1, Tab(80); "|"
    End If
...
Private Sub Proceso_Click()
    ...
    ZSql = ZSql + " Where Orden.Orden = " + "'" + WOrden + "'"
