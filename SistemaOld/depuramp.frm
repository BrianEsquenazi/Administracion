...
Private Sub Proceso_Click()
    ...
    Uno = "Select * FROM Laudo Where Articulo >= " + "'" + Desde.Text + "'"
    Dos = " and Articulo <= " + "'" + Hasta.Text + "'"
    Tres = " and Saldo <> 0 "
    Cuatro = "ORDER BY Articulo"
    spLaudo = Uno + Dos + Tres + Cuatro
        ...
        If .NoMatch = False Then
            Do
                ...
                If Entra = "S" Then
                    ...
                    Vector(Renglon, 1) = !Articulo
                    Vector(Renglon, 3) = !Laudo
                    Vector(Renglon, 4) = !Fecha
                    Vector(Renglon, 5) = !Laudo
                    Vector(Renglon, 6) = WLiberada
    ...
    Uno = "Select * FROM Guia Where Articulo >= " + "'" + Desde.Text + "'"
    Dos = " and Articulo <= " + "'" + Hasta.Text + "'"
    Tres = " and Saldo <> 0 "
    Cuatro = "ORDER BY Articulo"
    ...
    For dada = 1 To Renglon
        ...
        If rstArticulo.RecordCount > 0 Then
            Vector(dada, 2) = rstArticulo!Descripcion
            rstArticulo.Close
        End If
