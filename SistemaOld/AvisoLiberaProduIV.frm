...
Begin VB.Form PrgAvisoLiberaProduIV 
   AutoRedraw      =   -1  'True
   Caption         =   "Aviso de Desbloqueo de Productos "
   ClientHeight    =   4605
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.Frame Aviso 
      ...
      Begin VB.Label Label1 
         Alignment       =   2  'Center
         Caption         =   "Desbloqueo de Productos Eliminar Etiqueta Color Rojo"
         BeginProperty Font 
            Name            =   "MS Serif"
            Size            =   24
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "PrgAvisoLiberaProduIV"
...
Private Sub Acepta_Click()
    ...
    Sql4 = " and LiberaTerminado.TipoPro = 'CO'"
    Sql5 = ""
...
Private Sub Imprime_Click()
    ...
    Listado.SQLQuery = "SELECT LiberaTerminado.Producto, LiberaTerminado.Fecha, LiberaTerminado.Partida, LiberaTerminado.PartiOri, LiberaTerminado.Observa, LiberaTerminado.ImpreProdI, LiberaTerminado.ImpreProdII, LiberaTerminado.ImpreProdIII " _
                ...
                + "LiberaTerminado.TipoPro >= 'CO' AND " _
                + "LiberaTerminado.TipoPro <= 'CO'"
