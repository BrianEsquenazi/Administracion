...
Begin VB.Form PrgAgendaConsultaSacauto 
   ...
   Begin VB.CommandButton Impresion 
      ...
      Height          =   735
      Left            =   2760
      MouseIcon       =   "Agendaconsultasacauto.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "Agendaconsultasacauto.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   209
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2220
      ItemData        =   "Agendaconsultasacauto.frx":0B4C
      Left            =   2040
      List            =   "Agendaconsultasacauto.frx":0B53
      TabIndex        =   5
      Top             =   3600
      Visible         =   0   'False
      Width           =   4695
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image AnteriorNro 
         Height          =   480
         Left            =   840
         MouseIcon       =   "Agendaconsultasacauto.frx":0B61
         MousePointer    =   99  'Custom
         Picture         =   "Agendaconsultasacauto.frx":0E6B
      ...
      Begin VB.Image SiguienteNro 
         Height          =   480
         Left            =   1440
         MouseIcon       =   "Agendaconsultasacauto.frx":12AD
         MousePointer    =   99  'Custom
         Picture         =   "Agendaconsultasacauto.frx":15B7
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image SiguienteTipo 
         Height          =   480
         Left            =   1320
         MouseIcon       =   "Agendaconsultasacauto.frx":19F9
         MousePointer    =   99  'Custom
         Picture         =   "Agendaconsultasacauto.frx":1D03
         ToolTipText     =   "Registro Posterior"
         Top             =   120
         Width           =   480
      End
      Begin VB.Image AnteriorTipo 
         Height          =   480
         Left            =   600
         MouseIcon       =   "Agendaconsultasacauto.frx":2145
         MousePointer    =   99  'Custom
         Picture         =   "Agendaconsultasacauto.frx":244F
         ToolTipText     =   "Registro Anterior"
         Top             =   120
         Width           =   480
      End
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabPicture(0)   =   "Agendaconsultasacauto.frx":2891
      ...
      TabPicture(1)   =   "Agendaconsultasacauto.frx":28AD
      ...
      TabPicture(2)   =   "Agendaconsultasacauto.frx":28C9
      ...
      TabPicture(3)   =   "Agendaconsultasacauto.frx":28E5
      ...
      TabPicture(4)   =   "Agendaconsultasacauto.frx":2901
   ...
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   4680
      MouseIcon       =   "Agendaconsultasacauto.frx":291D
      MousePointer    =   99  'Custom
      Picture         =   "Agendaconsultasacauto.frx":2C27
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   6360
      MouseIcon       =   "Agendaconsultasacauto.frx":3469
      MousePointer    =   99  'Custom
      Picture         =   "Agendaconsultasacauto.frx":3773
      ToolTipText     =   "Salida"
      Top             =   7320
      Width           =   480
   End
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   8760
      MouseIcon       =   "Agendaconsultasacauto.frx":3FB5
      MousePointer    =   99  'Custom
      Picture         =   "Agendaconsultasacauto.frx":42BF
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   3840
      MouseIcon       =   "Agendaconsultasacauto.frx":4B01
      MousePointer    =   99  'Custom
      Picture         =   "Agendaconsultasacauto.frx":4E0B
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   5520
      MouseIcon       =   "Agendaconsultasacauto.frx":564D
      MousePointer    =   99  'Custom
      Picture         =   "Agendaconsultasacauto.frx":5957
   ...
   End
End
Attribute VB_Name = "PrgAgendaConsultaSacauto"
...
Sub Imprime_Datos()
    ...
    If rstCargaSacIII.RecordCount > 0 Then
        ...
        If Estado11.ListIndex < 0 Then
            Estado11.ListIndex = 0
        End If
        If Estado12.ListIndex < 0 Then
            Estado12.ListIndex = 0
        End If
        If Estado13.ListIndex < 0 Then
            Estado13.ListIndex = 0
        End If
        If Estado14.ListIndex < 0 Then
            Estado14.ListIndex = 0
        End If
        If Estado15.ListIndex < 0 Then
            Estado15.ListIndex = 0
        End If
        If Estado16.ListIndex < 0 Then
    ...
    If rstCargaSacIV.RecordCount > 0 Then
        ...
        If Estado1.ListIndex < 0 Then
            Estado1.ListIndex = 0
        End If
        If Estado2.ListIndex < 0 Then
            Estado2.ListIndex = 0
        End If
        If Estado3.ListIndex < 0 Then
            Estado3.ListIndex = 0
        End If
        If Estado4.ListIndex < 0 Then
            Estado4.ListIndex = 0
        End If
        If Estado5.ListIndex < 0 Then
            Estado5.ListIndex = 0
        End If
        If Estado6.ListIndex < 0 Then
            Estado6.ListIndex = 0
        End If
        
        If Estado31.ListIndex < 0 Then
            Estado31.ListIndex = 0
        End If
        If Estado32.ListIndex < 0 Then
            Estado32.ListIndex = 0
        End If
        If Estado33.ListIndex < 0 Then
            Estado33.ListIndex = 0
        End If
        If Estado34.ListIndex < 0 Then
            Estado34.ListIndex = 0
        End If
        If Estado35.ListIndex < 0 Then
            Estado35.ListIndex = 0
        End If
        If Estado36.ListIndex < 0 Then
