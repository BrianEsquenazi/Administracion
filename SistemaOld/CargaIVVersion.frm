...
Begin VB.Form PrgCargaIVVersion 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   9000
      MouseIcon       =   "CargaIVVersion.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "CargaIVVersion.frx":030A
      ToolTipText     =   "Salida"
      Top             =   6360
      Width           =   480
   End
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   8160
      MouseIcon       =   "CargaIVVersion.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "CargaIVVersion.frx":0E56
   ...
   End
End
Attribute VB_Name = "PrgCargaIVVersion"
        ...
        With rstCargaIVVersion
            ...
            Do
                If .EOF = False Then
                    ...
                    ControlCambio.Text = IIf(IsNull(rstCargaIVVersion!ControlCambio), "", rstCargaIVVersion!ControlCambio)
