...
Begin VB.Form PrgListaImpoFechaII 
   ...
   End
End
Attribute VB_Name = "PrgListaImpoFechaII"
...
Dim spTrabajo As String
Dim XParam As String
Dim Empe(12, 10) As String
Dim Vector(5000, 10) As String
Dim XLote(12, 10) As String
Dim WTrabajo(1000, 10) As String
...
Private Sub Acepta_Click()
    ...
    For a = 1 To XHasta
        ...
        ZSql = ""
        ZSql = ZSql + "Select *, Orden.Tipo as [WTipoOrden], Orden.Carpeta as [WCarpeta], Orden.Proveedor as [WProveedor]"
        ...
        ZSql = ZSql + " Order by Laudo.FechaOrd, Laudo.Clave"
        spLaudo = ZSql
            ...
            With rstLaudo
                ...
                Do
                    If .EOF = False Then
                        ...
                        Rem If rstLaudo!Articulo = "DY-302-901" Then
                        ...
                        If rstLaudo!WTipoOrden = 1 Then
                            If Left$(rstLaudo!Articulo, 2) = "DY" Or Left$(rstLaudo!Articulo, 2) = "DS" Or Left$(rstLaudo!Articulo, 2) = "DQ" Then
                                ...
                                If Entra = "S" Then
                                    Lugar = Lugar + 1
                                    Vector(Lugar, 1) = rstLaudo!WProveedor
                                    ...
                                    Vector(Lugar, 7) = rstLaudo!PartiOri
                                    Vector(Lugar, 8) = rstLaudo!Orden
...
Da:
    ...
    Rem Erase Vector
    Rem Lugar = 1
    Rem Vector(Lugar, 1) = "10000000064"
    Rem Vector(Lugar, 4) = "DY-204-002"
    Rem Vector(Lugar, 6) = "950640"
    Rem Vector(Lugar, 7) = "PB60007"
    
    
    For Ciclo = 1 To Lugar
        
        WWProve = Vector(Ciclo, 1)
        WWCarpeta = Vector(Ciclo, 2)
        WWFecha = Vector(Ciclo, 3)
        WWArticulo = Vector(Ciclo, 4)
        WWLote = Vector(Ciclo, 6)
        WWPartiOri = Vector(Ciclo, 7)
        ...
        For a = 1 To XHasta
            ...
            ZSql = ZSql + " Where Laudo.FechaOrd <= " + "'" + WHasta + "'"
                ...
                With rstLaudo
                    ...
                    Do
                        If .EOF = False Then
                                ...
                                For ZCicla = 1 To WLugar
                                    If WTrabajo(WLugar, 5) = rstLaudo!Orden Then
                                        Entra = "N"
                                        Exit For
                                    End If
                                Next ZCicla
                                ...
                                If Entra = "S" Then
                                    ...
                                    WLugar = WLugar + 1
                                    WTrabajo(WLugar, 1) = rstLaudo!Laudo
                                    WTrabajo(WLugar, 2) = rstLaudo!Fecha
                                    WTrabajo(WLugar, 3) = rstLaudo!FechaOrd
                                    If rstLaudo!Liberadaant > 0 Then
                                        WTrabajo(WLugar, 4) = Str$(rstLaudo!Liberadaant)
                                            Else
                                        WTrabajo(WLugar, 4) = Str$(rstLaudo!Liberada)
                                    End If
                                    WTrabajo(WLugar, 5) = rstLaudo!Orden
                                    WTrabajo(WLugar, 6) = rstLaudo!PartiOri
                                    WTrabajo(WLugar, 7) = ""
                                    WTrabajo(WLugar, 8) = ""
                                    WTrabajo(WLugar, 9) = "N"
            ...
            For ZZCiclo = 1 To WLugar
            
                If WTrabajo(ZZCiclo, 9) = "N" Then
                    ...
                    ZSql = ZSql + " Where Orden.Orden = " + "'" + WTrabajo(ZZCiclo, 5) + "'"
                    spOrden = ZSql
                    Set rstOrden = db.OpenRecordset(spOrden, dbOpenSnapshot, dbSQLPassThrough)
                    If rstOrden.RecordCount > 0 Then
                        ZZCarpeta = rstOrden!Carpeta
                        ZZProveedor = rstOrden!Proveedor
                        ZZZCosto = rstOrden!Precio
                        rstOrden.Close
                    End If
                    
                    WTrabajo(ZZCiclo, 7) = ZZCarpeta
                    WTrabajo(ZZCiclo, 8) = ZZProveedor
                    WTrabajo(ZZCiclo, 9) = "S"
                    WTrabajo(ZZCiclo, 10) = Str$(ZZZCosto)
                ...
                With rstHoja
                    ...
                    If .NoMatch = False Then
                        Do
                            ...
                            Rem If rstHoja!FechaOrd >= WDesde And rstHoja!FechaOrd <= WHasta Then
                            If rstHoja!FechaOrd <= WHasta Then
                ...
                With rstMovvar
                    ...
                    If .NoMatch = False Then
                        Do
                            ...
                            If rstMovvar!FechaOrd <= WHasta Then
                ...
                With rstMovlab
                    ...
                    If .NoMatch = False Then
                        Do
                            ...
                            If rstMovlab!FechaOrd <= WHasta Then
                ...
                With rstEstadistica
                    ...
                    If .NoMatch = False Then
                        Do
                            ...
                            Rem If rstEstadistica!OrdFecha >= WDesde And rstEstadistica!OrdFecha <= WHasta Then
                            If rstEstadistica!OrdFecha <= WHasta Then
        ...
        For ZZCiclo = 1 To WLugar
            ...
            XXLaudo = WTrabajo(ZZCiclo, 1)
            XXFecha = WTrabajo(ZZCiclo, 2)
            XXFechaOrd = WTrabajo(ZZCiclo, 3)
            XXCantidad = Val(WTrabajo(ZZCiclo, 4))
            XXCantidadOriginal = Val(WTrabajo(ZZCiclo, 4))
            XXOrden = WTrabajo(ZZCiclo, 5)
            ZZPartiOri = WTrabajo(ZZCiclo, 6)
            ZZCarpeta = WTrabajo(ZZCiclo, 7)
            ZZProveedor = WTrabajo(ZZCiclo, 8)
            ZZZCosto = Val(WTrabajo(ZZCiclo, 10))
            
            If WWSalida > XXCantidad Then
                WWSalida = WWSalida - XXCantidad
                XXCantidad = 0
                    Else
                XXCantidad = XXCantidad - WWSalida
                WWSalida = 0
            End If
            
            Rem If XXCantidad > 0 Then
            
                If XXFechaOrd >= WDesde And XXFechaOrd <= WHasta Then
                    ...
                    If ZZZCosto = 0 Then
                        ...
                        End If
                            Else
                        ZZCosto = Str$(ZZZCosto)
                    End If
                    
                    ZZEmpresa = "1"
                    ZZCantidad = XXCantidadOriginal
                    ZZSalida = Str$(XXCantidadOriginal - XXCantidad)
    ...
    Listado.SQLQuery = "SELECT LoteFecha.Proveedor, LoteFecha.Carpeta, LoteFecha.Fecha, LoteFecha.Articulo, LoteFecha.Lote, LoteFecha.PartiOri, LoteFecha.Cantidad, LoteFecha.Salida, LoteFecha.Costo," _
                + "Proveedor.Nombre " _
                + "From " _
