...
Begin VB.Form PrgImpreVtoTotal 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgImpreVtoTotal"
...
Private Sub Acepta_Click()
    ...
    ZZLugarTotal = ZZLugar + ZZLugarII
    
    If ZZLugarTotal > 0 Then
        PrgImpreVtoTotal.Refresh
        Aviso.Visible = True
        Aviso.Refresh
        For a = 1 To 10
            Beep
...
Private Sub Imprime_Click()
    ...
    For WWCicla = 1 To ZZLugarII
    
        WNumero = ZZVectorII(WWCicla)
