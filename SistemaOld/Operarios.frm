...
Begin VB.Form PrgOperarios 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "Operarios.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "Operarios.frx":030A
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "Operarios.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "Operarios.frx":0A56
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   840
         MouseIcon       =   "Operarios.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "Operarios.frx":11A2
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1560
         MouseIcon       =   "Operarios.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "Operarios.frx":18EE
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   2280
         MouseIcon       =   "Operarios.frx":1D30
         MousePointer    =   99  'Custom
         Picture         =   "Operarios.frx":203A
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   240
         MouseIcon       =   "Operarios.frx":247C
         MousePointer    =   99  'Custom
         Picture         =   "Operarios.frx":2786
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "Operarios.frx":2BC8
      MousePointer    =   99  'Custom
      Picture         =   "Operarios.frx":2ED2
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   2040
      MouseIcon       =   "Operarios.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "Operarios.frx":3A1E
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   360
      MouseIcon       =   "Operarios.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "Operarios.frx":456A
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   1200
      MouseIcon       =   "Operarios.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "Operarios.frx":50B6
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   4560
      MouseIcon       =   "Operarios.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "Operarios.frx":5C02
      ToolTipText     =   "Salida"
      Top             =   1800
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2880
      MouseIcon       =   "Operarios.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "Operarios.frx":674E
   ...
   End
End
Attribute VB_Name = "PrgOperarios"
...
Sub Imprime_Datos()
    Sql1 = "Select *"
    Sql2 = " FROM Operarios"
    Sql3 = " Where Operarios.Codigo = " + "'" + Codigo.Text + "'"
    ...
    If rstOperarios.RecordCount > 0 Then
        Descripcion.Text = Trim(rstOperarios!Descripcion)
        Clave.Text = Trim(rstOperarios!Clave)
        rstOperarios.Close
    End If
End Sub
...
Private Sub Acepta_Click()
    ...
    Listado.SQLQuery = "SELECT Operarios.Codigo, Operarios.Descripcion, Operarios.Clave " _
                + "From " _
                + DSQ + ".dbo.Operarios Operarios " _
                + "Where " _
                + "Operarios.Codigo >= " + Desde.Text + " AND " _
                + "Operarios.Codigo <= " + Hasta.Text
    
    Listado.Connect = Connect()
    
    Listado.GroupSelectionFormula = "{Operarios.Codigo} in " + Desde.Text + " to " + Hasta.Text
...
Private Sub cmdAdd_Click()
    If Val(Codigo.Text) <> 0 Then
        ...
        If rstOperarios.RecordCount > 0 Then
            rstOperarios.Close
            Sql1 = "UPDATE Operarios SET "
            Sql2 = " Descripcion = " + "'" + Descripcion.Text + "',"
            Sql3 = " Clave = " + "'" + Clave.Text + "'"
            Sql4 = " Where Codigo = " + "'" + Codigo.Text + "'"
            spOperarios = Sql1 + Sql2 + Sql3 + Sql4
            Set rstOperarios = db.OpenRecordset(spOperarios, dbOpenSnapshot, dbSQLPassThrough)
                Else
            Sql1 = "INSERT INTO Operarios ("
            Sql2 = "Codigo ,"
            Sql3 = "Descripcion ,"
            Sql4 = "Clave )"
            Sql5 = "Values ("
            ...
            Sql8 = "'" + Clave.Text + "')"
            spOperarios = Sql1 + Sql2 + Sql3 + Sql4 + Sql5 + Sql6 + Sql7 + Sql8
            Set rstOperarios = db.OpenRecordset(spOperarios, dbOpenSnapshot, dbSQLPassThrough)
        End If
...
Private Sub cmdDelete_Click()
    ...
    If Val(Codigo.Text) <> 0 Then
        ...
        If rstOperarios.RecordCount > 0 Then
            ...
            If Respuesta% = 6 Then
                Sql1 = "DELETE Operarios"
                Sql2 = " Where Codigo = " + "'" + Codigo.Text + "'"
                spOperarios = Sql1 + Sql2
                Set rstOperarios = db.OpenRecordset(spOperarios, dbOpenSnapshot, dbSQLPassThrough)
                Call CmdLimpiar_Click
            End If
        End If
...
Private Sub CmdLimpiar_Click()
    ...
    Set rstOperarios = db.OpenRecordset(spOperarios, dbOpenSnapshot, dbSQLPassThrough)
    If rstOperarios.RecordCount > 0 Then
        rstOperarios.MoveLast
        ZCodigo = IIf(IsNull(rstOperarios!CodigoMayor), "0", rstOperarios!CodigoMayor)
...
Private Sub Anterior_Click()
    ...
    If rstOperarios.RecordCount > 0 Then
        With rstOperarios
            .MoveLast
            Codigo.Text = rstOperarios!Codigo
        End With
        rstOperarios.Close
        Call Imprime_Datos
        Codigo.SetFocus
        ...
        A% = MsgBox(m$, 0, "Archivo de Operarios")
    End If
End Sub
                ...
                With rstOperarios
                    ...
                    Do
                        If .EOF = False Then
                            ...
                            Pantalla.Col = 1
                            Pantalla.Text = rstOperarios!Codigo
                            Pantalla.Col = 2
                            Pantalla.Text = rstOperarios!Descripcion
                            IngresaItem = rstOperarios!Codigo
...
Private Sub Primer_Click()
    ...
    Set rstOperarios = db.OpenRecordset(spOperarios, dbOpenSnapshot, dbSQLPassThrough)
    If rstOperarios.RecordCount > 0 Then
        rstOperarios.MoveFirst
        Codigo.Text = rstOperarios!CodigoMenor
        rstOperarios.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
...
Private Sub Ultimo_Click()
    ...
    If rstOperarios.RecordCount > 0 Then
        rstOperarios.MoveLast
        Codigo.Text = rstOperarios!CodigoMayor
        rstOperarios.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
        ...
        Case 0
            ...
            If rstOperarios.RecordCount > 0 Then
                With rstOperarios
                    ...
                    Do
                        If .EOF = False Then
                            da = Len(rstOperarios!Descripcion) - WEspacios
                            For aa = 1 To da + 1
                                If Left$(Ayuda.Text, WEspacios) = Mid$(rstOperarios!Descripcion, aa, WEspacios) Then
                                    LugarAyuda = LugarAyuda + 1
                                    Pantalla.Row = LugarAyuda
                                    Pantalla.Col = 1
                                    Pantalla.Text = rstOperarios!Codigo
