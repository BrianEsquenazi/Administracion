...
Begin VB.Form PrgProcesoSifere 
   AutoRedraw      =   -1  'True
   Caption         =   "Proceso de Traspaso de Percepcioes SIFERE (No Aduana)"
   ClientHeight    =   5775
   ClientLeft      =   3060
   ClientTop       =   1425
   ClientWidth     =   6930
   ...
   End
End
Attribute VB_Name = "PrgProcesoSifere"
    ...
    If rstImputac.RecordCount > 0 Then
        ...
        With rstImputac
                ...
                Do
                    ...
                    If !NroInterno = 135913 Then Stop
                
                    If rstImputac!Debito <> 0 Then
                    
                        If !Proveedor <> "10069345023" And !Proveedor <> "10014123562" And !Proveedor <> "10022098824" Then
                            ...
                            If Val(WCodigo) <> 0 Then
                                ...
                                WPunto = rstImputac!Punto
                                WNumero = rstImputac!Numero
                                ...
                                Campo5 = WNumero
                                Campo6 = "F"
                                Campo7 = rstImputac!Letra
                                Campo8 = XImpoIva
                                
                                If WImpoIva > 0 Then
                                    WImpre = Campo1 + Campo2 + Campo3 + Campo4 + Campo5 + Campo6 + Campo7 + Campo8
                                    Print #1, WImpre
                                End If
