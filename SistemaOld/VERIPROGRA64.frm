...
Begin VB.Form PrgVeriProgra64 
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "VERIPROGRA64.frx":0000
      Left            =   1200
      List            =   "VERIPROGRA64.frx":0007
      TabIndex        =   4
      Top             =   1680
      Width           =   3255
   End
   ...
   End
End
Attribute VB_Name = "PrgVeriProgra64"
            ...
            With rstBanco
                ...
                Do
                    If .EOF = False Then
                        ...
                        Rem IngresaItem = rstBanco!Banco
...
Private Sub Lista_Click()
    Listado.GroupSelectionFormula = "{Banco.Banco} in " + "0" + " to " + "9999"
