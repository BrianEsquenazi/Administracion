...
Begin VB.Form PrgEstaAnuPeligroso 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgEstaAnuPeligroso"
...
Dim ZZSecundario As String
Dim ZZRiesgo As String
...
Private Sub Acepta_Click()
    ...
    For Ciclo = 1 To 12
        ...
        If ZSuma = "S" Then
            ZMeses = ZMeses + 1
        End If
        If MesCicla = MesFin And AnoCicla = AnoFin Then
            ZSuma = "N"
        End If
                ...
                If Left$(WCodigo, 2) = "PT" Or Left$(WCodigo, 2) = "PE" Then
                    ...
                    If rstTerminado.RecordCount > 0 Then
                        ...
                        If Trim(ZZClase) <> "" Then
                            WDescriLinea = WDescriLinea + "Clase:" + Trim(ZZClase) + "  "
                        End If
                        If Trim(ZZSecundario) <> "" Then
                            WDescriLinea = WDescriLinea + "Sec.:" + Trim(ZZSecundario) + "  "
                        End If
                        If Trim(ZZRiesgo) <> "" Then
                            WDescriLinea = WDescriLinea + "Riesgo:" + Trim(ZZRiesgo) + "  "
                        End If
                        If Trim(ZZIntervencion) <> "" Then
                            WDescriLinea = WDescriLinea + "Int:" + Trim(ZZIntervencion) + "  "
                        End If
                        If Trim(ZZNaciones) <> "" Then
                            WDescriLinea = WDescriLinea + "Clase:" + Trim(ZZNaciones) + "  "
                        End If
                        If Trim(ZZEmbalaje) <> "" Then
                            WDescriLinea = WDescriLinea + "Emb.:" + Trim(ZZEmbalaje) + "  "
                        End If
    ...
    If Val(WEmpresa) = 1 Or Val(WEmpresa) = 10 Then
        Listado.ReportFileName = "WEstaAnuPeligroso.rpt"
            Else
        Listado.ReportFileName = "WEstaAnupeligroso.rpt"
    End If
