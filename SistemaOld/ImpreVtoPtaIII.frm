...
Begin VB.Form PrgImpreVtoPtaIII 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgImpreVtoPtaIII"
...
Private Sub Acepta_Click()
    ...
    For ZZZCiclo = 1 To 2
        ...
        ZSql = ZSql + " Where VerificaVtoArti.ImpreIII = " + "'" + "N" + "'"
