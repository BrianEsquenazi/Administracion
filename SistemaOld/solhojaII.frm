...
Begin VB.Form PrgSolHojaII 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   4095
      Left            =   120
      OleObjectBlob   =   "solhojaII.frx":0000
      TabIndex        =   7
      Top             =   1200
      Width           =   8895
   End
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "solhojaII.frx":09E6
      Left            =   3360
      List            =   "solhojaII.frx":09ED
      TabIndex        =   5
      Top             =   6480
      Visible         =   0   'False
      Width           =   8415
   ...
   End
End
Attribute VB_Name = "PrgSolHojaII"
        ...
        For iRow = 0 To 9
            ...
            If Articulo <> "" Then
                ...
                If Tipo = "M" Then
                    ...
                    If Left$(Articulo, 2) <> "CO" And Left$(Articulo, 2) <> "DY" And Left$(Articulo, 2) <> "DW" And Left$(Articulo, 2) <> "DS" Then
                        WEntra = "S"
                    End If
