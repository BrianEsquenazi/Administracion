...
Begin VB.Form PrgListMinDy 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2760
      ItemData        =   "ListMinDy.frx":0000
      Left            =   120
      List            =   "ListMinDy.frx":0007
      TabIndex        =   1
      Top             =   2760
      Visible         =   0   'False
      Width           =   7815
   End
End
Attribute VB_Name = "PrgListMinDy"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where Pedido.Articulo >= " + "'" + Desde.Text + "'"
    ZSql = ZSql + " and Pedido.Articulo <= " + "'" + Hasta.Text + "'"
    ZSql = ZSql + " and Pedido.Importe > 0"
    ZSql = ZSql + " Order by Pedido.Articulo"
    spPedido = ZSql
    Set rstPedido = db.OpenRecordset(spPedido, dbOpenSnapshot, dbSQLPassThrough)
    ...
    Listado.WindowTitle = "Listado de Stock Minimo de M.P. de Reventa"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WstkMinDy.rpt"
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgListMinDy.Caption = "Listado de Stock Minimo de M.P. de Reventa :  " + !Nombre
        End If
    End With
