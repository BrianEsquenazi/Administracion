...
Begin VB.Form PrgVerificaLabora 
   AutoRedraw      =   -1  'True
   Caption         =   "Verificacion de Pedidos de Desarrollos  (Laboratorio)"
   ClientHeight    =   7320
   ClientLeft      =   150
   ClientTop       =   690
   ClientWidth     =   11550
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   5520
      MouseIcon       =   "VerificaLabora.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "VerificaLabora.frx":030A
      ToolTipText     =   "Salida"
      Top             =   6600
      Width           =   480
   End
End
Attribute VB_Name = "PrgVerificaLabora"
...
Private Sub Proceso_Click()
    ...
    Sql3 = " Where PedidoOrdenTRabajo.Destino = 2"
    Sql4 = " and PedidoOrdenTRabajo.EstadoLabora <> 'N'"
...
Private Sub Muestra_DblClick()
    ...
    PrgVerificaLabora.Hide
    Unload Me
    PrgpedidoOrdenTrabajoLabora.Show
