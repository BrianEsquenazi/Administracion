...
Begin VB.Form PrgRankClie 
   AutoRedraw      =   -1  'True
   Caption         =   "9.-Listado de Ranking por Cliente"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "RankClie.frx":0000
      Left            =   840
      List            =   "RankClie.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
...
Private Sub Acepta_Click()
    ...
    With rstRanking
        ...
        If .NoMatch = False Then
            Do
                ...
                Rem     WDescriArticulo = rstTerminado!Descripcion
                Rem End If
    ...
    Listado.WindowTitle = "9.-Listado de Ranking de ventas por cliente"
    Listado.WindowTop = 0
