...
Begin VB.Form PrgAvisoRechaProduI 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaProduI"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreProdI = " + "'" + ZMarca + "'"
    ...
    If rstPedidoDevol.RecordCount > 0 Then
        ...
        .MoveFirst
            Do
                If .EOF = False Then
                    If rstPedidoDevol!TipoProII = "PG" Then
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreProdI  = " + "'" + WMarcaImpresion + "'"
