...
Begin VB.Form PrgMoviMp0 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Inventario de Materia Prima con Lote = 0"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2760
      ItemData        =   "MoviMp0.frx":0000
      Left            =   120
      List            =   "MoviMp0.frx":0007
      TabIndex        =   3
      Top             =   2040
      Visible         =   0   'False
      Width           =   7215
...
Private Sub Acepta_Click()
    ...
    Listado.WindowTitle = "Listado de Inventario de Materia Prima con Lote = 0"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Inventario.Numero, Inventario.Tipo, Inventario.Articulo, Inventario.Cantidad, Inventario.Lote, Inventario.Talon, Inventario.Observaciones, Inventario.Ubicacion, " _
                        ...
                        + "Inventario.Tipo = 'M' AND Inventario.Articulo >= 'AA-000--00' AND Inventario.Articulo <= 'ZZ-999-99' AND Inventario.Lote = 0"
...
Sub Form_Load()
    With rstEmpresa
        ...
        If .NoMatch = False Then
            PrgMoviMp0.Caption = "Listado de Inventario de Materia Prima con Lote = 0 :  " + !Nombre
        End If
    End With
    Desde.Text = "  -   -   "
    Hasta.Text = "  -   -   "
