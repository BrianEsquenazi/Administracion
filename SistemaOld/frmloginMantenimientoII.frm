VERSION 5.00
Begin VB.Form frmLoginMantenimientoII 
   ...
   End
End
Attribute VB_Name = "frmLoginMantenimientoII"
...
Private Sub cmdOK_Click()
    ...
    If rstResponsableSac.RecordCount > 0 Then
        ZZOperadorResponsable = rstResponsableSac!Codigo
        ZZOperadorResponsableNombre = rstResponsableSac!Descripcion
        rstResponsableSac.Close
        Unload frmLoginMantenimientoII
        Menu.Show
    End If
