...
Begin VB.Form PrgEsta4 
   AutoRedraw      =   -1  'True
   Caption         =   "5.-Listado de Estadisitica de Ventas por Vendedor, Cliente y Linea"
   ClientHeight    =   7245
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
...
Dim ZDescriVendedor(100) As String
...
Private Sub Acepta_Click()
    ...
    Rem ZSql = ""
    Rem ZSql = ZSql + "Select *, Vendedor.Nombre as [WDesVendedor], Cliente.Razon as [WDesCliente], Cliente.Vendedor as [WCodigoVendedor]"
    Rem ZSql = ZSql + " FROM Estadistica, Cliente, Vendedor"
    Rem ZSql = ZSql + " Where Estadistica.Cliente = Cliente.Cliente"
    Rem ZSql = ZSql + " and Estadistica.Vendedor = Vendedor.Vendedor"
    Rem ZSql = ZSql + " and Estadistica.OrdFecha >= " + "'" + WDesde + "'"
    Rem ZSql = ZSql + " and Estadistica.OrdFecha <= " + "'" + Whasta + "'"
    Rem ZSql = ZSql + " and Estadistica.Vendedor >= " + "'" + Desde.Text + "'"
    Rem ZSql = ZSql + " and Estadistica.Vendedor <= " + "'" + Hasta.Text + "'"
        ...
        With rstEstadistica
            ...
            Do
               ...
               Rem WDescriVendedor = rstEstadistica!WDesVendedor
                ...
                WDescriRubro = ""
               Rem  WDescriCliente = rstEstadistica!WDesCliente
                ...
                With rstEsta
                    ...
                    !Varios = WTitulo
                    !DescriVendedor = ZDescriVendedor(wvendedor)
    ...
    Listado.WindowTitle = "5.-Listado de Estadistica de Ventas por Vendedor, Cliente y Linea"
    Listado.WindowTop = 0
    ...
    If Tipo.ListIndex = 0 Then
        Listado.ReportFileName = "WEsta4ii.rpt"
            Else
        Listado.ReportFileName = "WEsta4resuii.rpt"
    End If
...
Sub Form_Load()
    ...
    Tipo.AddItem "Normal"
    Tipo.AddItem "Resumido por Cliente"
