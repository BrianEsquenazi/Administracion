...
Begin VB.Form PrgMinimoPlanta 
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "WMinimoPlanta.rpt"
      Destination     =   1
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "MinimoPlanta.frx":0000
      Left            =   840
      List            =   "MinimoPlanta.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
   ...
   End
End
Attribute VB_Name = "PrgMinimoPlanta"
...
Private Sub Acepta_Click()
                ...
                Do
                    If .EOF = False Then
                        ...
                        If Desde.Text <= rstArticulo!Codigo And Hasta.Text >= rstArticulo!Codigo Then
                            ...
                            WMinimo = IIf(IsNull(rstArticulo!Minimo1), "0", rstArticulo!Minimo1)
                        
                            If XSaldo <> 0 Or WMinimo1 <> 0 Then
                                ...
                                Vector(Suma, 4) = IIf(IsNull(rstArticulo!Minimo1), "0", rstArticulo!Minimo1)
    ...
    Listado.WindowTitle = "Listado de Stock de Materias Primas inferior al minimo por planta"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Minimo.Articulo, Minimo.Descripcion, Minimo.Stock1, Minimo.Stock2, Minimo.Stock3, Minimo.Stock4, Minimo.Stock5, Minimo.Minimo1, Minimo.Minimo2, Minimo.Minimo3, Minimo.Minimo4, Minimo.Minimo5, Minimo.Dife1, Minimo.Dife2, Minimo.Dife3, Minimo.Dife4, Minimo.Dife5 " _
                    + "From " _
...
Sub Form_Load()
    With rstEmpresa
        ...
        If .NoMatch = False Then
            PrgMinimoPlanta.Caption = "Listado de Stock Minimo por PLanta :  " + !Nombre
        End If
    End With
    Desde.Text = "  -   -   "
    Hasta.Text = "  -   -   "
