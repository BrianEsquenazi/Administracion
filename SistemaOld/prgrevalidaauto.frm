...
Begin VB.Form PrgRevalidaauto 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "prgrevalidaauto.frx":0000
      ...
      TabPicture(1)   =   "prgrevalidaauto.frx":001C
      Tab(1).ControlCount=   44
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Valor20"
      Tab(1).Control(0).Enabled=   -1  'True
      Tab(1).Control(1)=   "Valor19"
      Tab(1).Control(1).Enabled=   -1  'True
      Tab(1).Control(2)=   "Valor18"
      Tab(1).Control(2).Enabled=   -1  'True
      Tab(1).Control(3)=   "Valor17"
      Tab(1).Control(3).Enabled=   -1  'True
      Tab(1).Control(4)=   "Valor16"
      Tab(1).Control(4).Enabled=   -1  'True
      Tab(1).Control(5)=   "Valor15"
      Tab(1).Control(5).Enabled=   -1  'True
      Tab(1).Control(6)=   "Valor14"
      Tab(1).Control(6).Enabled=   -1  'True
      Tab(1).Control(7)=   "Valor13"
      Tab(1).Control(7).Enabled=   -1  'True
      Tab(1).Control(8)=   "Valor12"
      Tab(1).Control(8).Enabled=   -1  'True
      Tab(1).Control(9)=   "Valor11"
      Tab(1).Control(9).Enabled=   -1  'True
      Tab(1).Control(10)=   "Label116"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "lblresultadoII"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "Std20"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "Std19"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "Std18"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "Std17"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "Std16"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "Std15"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "Std14"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "Std13"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "Std12"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "Std11"
      Tab(1).Control(21).Enabled=   0   'False
      Tab(1).Control(22)=   "Label104"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "Descri20"
      Tab(1).Control(23).Enabled=   0   'False
      Tab(1).Control(24)=   "Descri19"
      Tab(1).Control(24).Enabled=   0   'False
      Tab(1).Control(25)=   "Descri18"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "Descri17"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "Descri16"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "Descri15"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "Descri14"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "Descri13"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "Descri12"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "Descri11"
      Tab(1).Control(32).Enabled=   0   'False
      Tab(1).Control(33)=   "Label22"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).Control(34)=   "ValorOri20"
      Tab(1).Control(34).Enabled=   0   'False
      Tab(1).Control(35)=   "ValorOri19"
      Tab(1).Control(35).Enabled=   0   'False
      Tab(1).Control(36)=   "ValorOri18"
      Tab(1).Control(36).Enabled=   0   'False
      Tab(1).Control(37)=   "ValorOri17"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "ValorOri16"
      Tab(1).Control(38).Enabled=   0   'False
      Tab(1).Control(39)=   "ValorOri15"
      Tab(1).Control(39).Enabled=   0   'False
      Tab(1).Control(40)=   "ValorOri14"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "ValorOri13"
      Tab(1).Control(41).Enabled=   0   'False
      Tab(1).Control(42)=   "ValorOri12"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "ValorOri11"
      Tab(1).Control(43).Enabled=   0   'False
      TabCaption(2)   =   "Especificaciones 21 - 30"
      TabPicture(2)   =   "prgrevalidaauto.frx":0038
   ...
   End
End
Attribute VB_Name = "PrgRevalidaauto"
