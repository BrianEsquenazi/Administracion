...
Begin VB.Form PrgIvavenPrv 
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "ivavenprv.frx":0000
      Left            =   840
      List            =   "ivavenprv.frx":0007
      TabIndex        =   3
      Top             =   2160
      Visible         =   0   'False
      Width           =   3735
   ...
   End
End
Attribute VB_Name = "PrgIvavenPrv"
...
Private Sub Acepta_Click()
    ...
    If Val(WEmpresa) = 1 Then
        ...
        DSQ = getDatabase(DbConnect)
         ...
         Listado.SQLQuery = "SELECT CtaCte.Tipo, CtaCte.Numero, CtaCte.Cliente, CtaCte.OrdFecha, CtaCte.Importe4, CtaCte.Importe5, CtaCte.Importe6, CtaCte.Importe7, CtaCte.Importe8, CtaCte.ImpoIbTucu, CtaCte.ImpoIbCiudad, " _
                + "Cliente.Provincia, " _
                + "Provincia.Nombre " _
                + "From " _
                ...
                + "Cliente.Provincia = Provincia.Provincia AND " _
        ...
        Listado.ReportFileName = "WIvavenprvsurfa.rpt"
        ...
        DSQ = getDatabase(DbConnect)
         ...
         Listado.SQLQuery = "SELECT CtaCte.Tipo, CtaCte.Numero, CtaCte.Cliente, CtaCte.OrdFecha, CtaCte.Paridad, CtaCte.Importe4, CtaCte.Importe5, CtaCte.Importe6, CtaCte.Importe7, CtaCte.Importe8, " _
                    + "Cliente.Provincia, " _
                    + "Provincia.Nombre " _
                    + "From " _
                    + DSQ + ".dbo.CtaCte CtaCte, " _
        ...
        Listado.ReportFileName = "WIvavenprv.rpt"
