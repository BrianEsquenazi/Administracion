...
Begin VB.Form Menu 
   ...
   Begin VB.Menu sdf 
      ...
      End
      Begin VB.Menu INdiceSac 
         Caption         =   "Indice General de Acciones"
      End
      Begin VB.Menu INdiceSol 
         Caption         =   "Indice General de Solicitudes"
         Visible         =   0   'False
      End
   End
   Begin VB.Menu ZXascsdf 
      Caption         =   "Listados "
      Begin VB.Menu ListaSac 
         Caption         =   "Listado de SAC por Centro"
      End
      Begin VB.Menu ListaSacTipo 
         Caption         =   "Listado de SAC por Tipo"
      End
      Begin VB.Menu ListaSacTipoGrupo 
         Caption         =   "Listado de SAC por Agrupacion de Tipo"
      End
      Begin VB.Menu ListadoSacEstadistica 
         Caption         =   "Listado de Estadistica por Tipo"
      End
   End
...
Private Sub Form_Activate()
    ...
    If ZZCodigoResponsable = 0 Then
        Menu.tiposac.Enabled = False
        Menu.ResponsableSac.Enabled = False
        Menu.CentroSac.Enabled = False
        Menu.CargaSac.Enabled = False
        Menu.cargasacverifica.Enabled = False
    End If

    If woperador = 3 Or woperador = 21 Then
        Menu.tiposac.Enabled = False
        Menu.ResponsableSac.Enabled = False
        Menu.CentroSac.Enabled = False
    End If
    If woperador = 27 Or woperador = 19 Or woperador = 29 Then
        Menu.cargasacverifica.Enabled = True
    End If
...
Private Sub INdiceSac_Click()
    PrgIndiceSac.Show
End Sub

Private Sub ListadoSacEstadistica_Click()
    PrgListaSacEstadistica.Show
End Sub
...
Private Sub ListaSacTipo_Click()
    PrgListaSacTipo.Show
End Sub

Private Sub ListaSacTipoGrupo_Click()
    PrgListaSacTipoGrupo.Show
End Sub
