...
Private Sub Graba_Click()
    ...
    If Trim(Observaciones.Text) = "" Then
        ...
        A% = MsgBox(m$, 0, "Solicitud de Compra de Insumos")
        Exit Sub
    End If
    
    If Val(Solicitud.Text) = 0 And WOperador <> 90 Then
    ...
    If WGraba <> "S" Then
        ...
        If Val(Solicitud.Text) = 0 Then
            ...
            If rstInsumo.RecordCount > 0 Then
                With rstInsumo
                    .MoveLast
                    Solicitud.Text = rstInsumo!Solicitud + 1
                End With
                rstInsumo.Close
            End If
        End If
        ...
        T$ = "Solicitud de Compra de Insumos"
        m$ = "Desea Imprimir la Solicitud de Insumos"
...
Private Sub Form_Load()
    ...
    With rstEmpresa
        ...
        .Seek "=", Val(Wempresa)
        If .NoMatch = False Then
            PrgInsumos.Caption = "Ingreso de Solicitud de Compras de Insumos :  " + !Nombre
        End If
    End With
...
Sub Impresion()
    ...
    Listado.GroupSelectionFormula = "{Insumos.Solicitud} in " + Solicitud.Text + " to " + Solicitud.Text
    ...
    Listado.SQLQuery = "SELECT Insumos.Solicitud, Insumos.Fecha, Insumos.Planta, Insumos.Solicitante, Insumos.Observaciones, Insumos.Entrega, Insumos.Cantidad, Insumos.Descripcion " _
                    ...
                    + "Where " _
                    + "Insumos.Solicitud >= " + Solicitud.Text + " AND Insumos.Solicitud <= " + Solicitud.Text
...
Private Sub WClave_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        If WClave.Text = "SOL" Then
            ...
            A% = MsgBox(m$, 0, "Solicitud de Compras de Insumos")
            WClave.SetFocus
        End If
    End If
End Sub
