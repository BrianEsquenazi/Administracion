...
Begin VB.Form PrgCierrePrueba 
   ...
   End
End
Attribute VB_Name = "PrgCierrePrueba"
...
Private Sub Aceptar_Click()
    ...
    For Ciclo = 1 To Renglon
                ...
                Rem If WTerminado = "PT-22127-100" Then Stop
...
Private Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgCierrePrueba.Caption = "Actualizacion del Stock :  " + !Nombre
        End If
    End With
