...
Begin VB.Form PrgDatosEtiqueta 
   AutoRedraw      =   -1  'True
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabPicture(0)   =   "datosetiqueta.frx":0000
      ...
      TabPicture(1)   =   "datosetiqueta.frx":001C
      Tab(1).ControlCount=   5
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "WTexto2"
      Tab(1).Control(0).Enabled=   -1  'True
      Tab(1).Control(1)=   "WCombo1"
      Tab(1).Control(1).Enabled=   -1  'True
      Tab(1).Control(2)=   "WTexto1"
      Tab(1).Control(2).Enabled=   -1  'True
      Tab(1).Control(3)=   "WVector1"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "WTexto3"
      Tab(1).Control(4).Enabled=   0   'False
      TabCaption(2)   =   "Frases P"
      TabPicture(2)   =   "datosetiqueta.frx":0038
      Tab(2).ControlCount=   5
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "WTexto12"
      Tab(2).Control(0).Enabled=   -1  'True
      Tab(2).Control(1)=   "WTexto22"
      Tab(2).Control(1).Enabled=   -1  'True
      Tab(2).Control(2)=   "WCombo12"
      Tab(2).Control(2).Enabled=   -1  'True
      Tab(2).Control(3)=   "WTexto32"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "WVector2"
      Tab(2).Control(4).Enabled=   0   'False
      TabCaption(3)   =   "Denominacion Componentes Peligrosos"
      TabPicture(3)   =   "datosetiqueta.frx":0054
      Tab(3).ControlCount=   5
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "WVector3"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "WCombo13"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "WTexto13"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "WTexto23"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "WTexto33"
      Tab(3).Control(4).Enabled=   0   'False
      TabCaption(4)   =   "Datos Onu"
      TabPicture(4)   =   "datosetiqueta.frx":0070
      ...
      Begin VB.Image sdfsdf 
         Height          =   1500
         Left            =   2640
         Picture         =   "datosetiqueta.frx":008C
         Top             =   3060
         Width           =   1500
      End
      Begin VB.Image sfdsf 
         Height          =   1500
         Left            =   360
         Picture         =   "datosetiqueta.frx":0B93
         Top             =   3060
         Width           =   1500
      End
      Begin VB.Image sdfds 
         Height          =   1500
         Left            =   4920
         Picture         =   "datosetiqueta.frx":1949
         Top             =   780
         Width           =   1500
      End
      Begin VB.Image sdfsdfds 
         Height          =   1500
         Left            =   4920
         Picture         =   "datosetiqueta.frx":2638
         Top             =   3000
         Width           =   1500
      End
      Begin VB.Image sdsdfsdfsd 
         Height          =   1500
         Left            =   9480
         Picture         =   "datosetiqueta.frx":33AE
         Top             =   780
         Width           =   1500
      End
      Begin VB.Image sddsf 
         Height          =   1500
         Left            =   2640
         Picture         =   "datosetiqueta.frx":406B
         Top             =   720
         Width           =   1500
      End
      Begin VB.Image sdafdsf 
         Height          =   1500
         Left            =   7200
         Picture         =   "datosetiqueta.frx":4D5F
         Top             =   3060
         Width           =   1500
      End
      Begin VB.Image asd 
         Height          =   1500
         Left            =   7200
         Picture         =   "datosetiqueta.frx":5A0A
         Top             =   780
         Width           =   1500
      End
      Begin VB.Image Image1 
         Height          =   1500
         Left            =   360
         Picture         =   "datosetiqueta.frx":6510
         Top             =   780
         Width           =   1500
      End
   End
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2220
      ItemData        =   "datosetiqueta.frx":7199
      Left            =   120
      List            =   "datosetiqueta.frx":71A0
      TabIndex        =   1
      Top             =   6960
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   10320
      MouseIcon       =   "datosetiqueta.frx":71AE
      MousePointer    =   99  'Custom
      Picture         =   "datosetiqueta.frx":74B8
      ToolTipText     =   "Salida"
      Top             =   6600
      Width           =   480
   End
   Begin VB.Image Graba 
      Height          =   480
      Left            =   7440
      MouseIcon       =   "datosetiqueta.frx":7CFA
      MousePointer    =   99  'Custom
      Picture         =   "datosetiqueta.frx":8004
   ...
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   9360
      MouseIcon       =   "datosetiqueta.frx":8846
      MousePointer    =   99  'Custom
      Picture         =   "datosetiqueta.frx":8B50
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   8400
      MouseIcon       =   "datosetiqueta.frx":9392
      MousePointer    =   99  'Custom
      Picture         =   "datosetiqueta.frx":969C
   ...
   End
End
Attribute VB_Name = "PrgDatosEtiqueta"
...
Dim rstDatosEtiqueta As Recordset
Dim spDatosEtiqueta As String
...
Dim WBorraIII(1000, 20) As String
...
Listado.ReportFileName = "etiptpeligrolist.rpt"
...
Private Sub Command2_Click()
    ...
    If rstDatosEtiqueta.RecordCount > 0 Then
        With rstDatosEtiqueta
            .MoveFirst
            Do
                If .EOF = False Then
                    If rstDatosEtiqueta!Tipo = 1 Then
                        ZZLugar = ZZLugar + 1
                        ZZVector(ZZLugar, 1) = rstDatosEtiqueta!Clave
                        ZZVector(ZZLugar, 2) = rstDatosEtiqueta!fraseh
                    End If
                    .MoveNext
                        Else
                    Exit Do
    ...
    For Ciclo = 1 To ZZLugar
        ...
        ZSql = ""
        ZSql = ZSql + "UPDATE DatosEtiqueta SET "
...
Private Sub Graba_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "DELETE DatosEtiqueta"
    ...
    For Ciclo = 1 To 99
        ...
        If Trim(WVector1.TextMatrix(Ciclo, 1)) <> "" Then
            ...
            ZSql = ""
            ZSql = ZSql + "INSERT INTO DatosEtiqueta ("
            ZSql = ZSql + "Clave ,"
            ZSql = ZSql + "Terminado ,"
            ZSql = ZSql + "Renglon ,"
            ZSql = ZSql + "Palabra ,"
    ...
    If rstTerminado.RecordCount > 0 Then
        ...
        WWObservaciones = IIf(IsNull(rstTerminado!Observaciones), "", rstTerminado!Observaciones)
        WWTipoeti = IIf(IsNull(rstTerminado!Tipoeti), "", rstTerminado!Tipoeti)
        WWNaciones = IIf(IsNull(rstTerminado!Naciones), "", rstTerminado!Naciones)
        WWClase = IIf(IsNull(rstTerminado!Clase), "", rstTerminado!Clase)
        WWSecundario = IIf(IsNull(rstTerminado!Secundario), "", rstTerminado!Secundario)
        WWRiesgo = IIf(IsNull(rstTerminado!Riesgo), "", rstTerminado!Riesgo)
        WWIntervencion = IIf(IsNull(rstTerminado!Intervencion), "", rstTerminado!Intervencion)
        WWEmbalaje = IIf(IsNull(rstTerminado!Embalaje), "", rstTerminado!Embalaje)
        WWCaracteristicas = IIf(IsNull(rstTerminado!Descrionu), "", rstTerminado!Descrionu)
    ...
    If Trim(WWObservaciones) <> Trim(Observaciones.Text) Then
        ZZGraba = "S"
    End If
    If Trim(WWTipoeti) <> Trim(Tipoeti.Text) Then
        ZZGraba = "S"
    End If
    ...
    If Trim(WWClase) <> Trim(Clase.Text) Then
        ZZGraba = "S"
    End If
    If Trim(WWSecundario) <> Trim(Secundario.Text) Then
        ZZGraba = "S"
    End If
    If Trim(WWRiesgo) <> Trim(Riesgo.Text) Then
        ZZGraba = "S"
    End If
        ...
        If Respuesta% = 6 Then
            ...
            For Cicla = 1 To 7
                ...
                If CargaEmpresa(Cicla, 1) <> "" Then
                    ...
                    ZSql = ZSql & "TipoEti = " + "'" + Tipoeti.Text + "',"
                    ZSql = ZSql & "Naciones = " + "'" + Naciones.Text + "',"
                    ZSql = ZSql & "Clase = " + "'" + Clase.Text + "',"
                    ZSql = ZSql & "Secundario = " + "'" + Secundario.Text + "',"
                    ZSql = ZSql & "Riesgo = " + "'" + Riesgo.Text + "',"
    ...
    Select Case XIndice
        ...
        Case 3
            ...
            If rstPeligroso.RecordCount > 0 Then
                ...
                End If
                If Trim(rstPeligroso!Secundario) <> "" Then
                    Secundario.Text = rstPeligroso!Secundario
                End If
                If Trim(rstPeligroso!Riesgo) <> "" Then
                    Riesgo.Text = rstPeligroso!Riesgo
                End If
...
Private Sub Proceso()
    ...
    For Ciclo = 1 To 999
        ...
        If rstDatosEtiqueta.RecordCount > 0 Then
            ...
            Palabra.ListIndex = rstDatosEtiqueta!Palabra
            Logo1.ListIndex = rstDatosEtiqueta!pictograma1
            Logo2.ListIndex = rstDatosEtiqueta!pictograma2
            Logo3.ListIndex = rstDatosEtiqueta!pictograma3
            Logo4.ListIndex = rstDatosEtiqueta!pictograma4
            logo5.ListIndex = rstDatosEtiqueta!pictograma5
            Logo6.ListIndex = rstDatosEtiqueta!pictograma6
            Logo7.ListIndex = rstDatosEtiqueta!pictograma7
            Logo8.ListIndex = rstDatosEtiqueta!pictograma8
            Logo9.ListIndex = rstDatosEtiqueta!pictograma9
            
            Select Case rstDatosEtiqueta!Tipo
                Case 1
                    ZZLugar1 = ZZLugar1 + 1
                    WVector1.TextMatrix(ZZLugar1, 1) = Trim(rstDatosEtiqueta!fraseh)
                    WVector1.TextMatrix(ZZLugar1, 2) = Trim(rstDatosEtiqueta!descripcion1H)
                    WVector1.TextMatrix(ZZLugar1, 3) = Trim(rstDatosEtiqueta!descripcion2H)
                    WVector1.TextMatrix(ZZLugar1, 4) = Trim(rstDatosEtiqueta!descripcion3H)
                    
                Case 2
                    ZZLugar2 = ZZLugar2 + 1
                    WVector2.TextMatrix(ZZLugar2, 1) = Trim(rstDatosEtiqueta!FraseP)
                    WVector2.TextMatrix(ZZLugar2, 2) = Trim(rstDatosEtiqueta!descripcion1p)
                    WVector2.TextMatrix(ZZLugar2, 3) = Trim(rstDatosEtiqueta!descripcion2p)
                    WVector2.TextMatrix(ZZLugar2, 4) = Trim(rstDatosEtiqueta!descripcion3p)
                    WVector2.TextMatrix(ZZLugar2, 5) = Trim(rstDatosEtiqueta!Observaciones)
                Case 3
                    ZZLugar3 = ZZLugar3 + 1
                    WVector3.TextMatrix(ZZLugar3, 1) = Trim(rstDatosEtiqueta!denominacion)
                Case Else
            End Select
...
Private Sub Naciones_Keypress(KeyAscii As Integer)
    ...
    Rem
    Rem     ZAyuda = ""
    Rem     If KeyAscii > 31 Then
    Rem         ZAyuda = Naciones.Text + Chr$(KeyAscii)
    Rem             Else
    ...
    Rem                 ZAyuda = ""
    Rem             Case 8
    Rem                 WEspacios = Len(Naciones.Text)
    Rem                 If WEspacios > 0 Then
    Rem                     WEspacios = WEspacios - 1
    Rem                     ZAyuda = Left$(Naciones.Text, WEspacios)
    Rem                 End If
    Rem             Case Else
    Rem                 ZAyuda = Naciones.Text
    Rem         End Select
    Rem     End If
    Rem
    Rem     Clase.Text = ""
    ...
    Rem
    Rem     ZLugar = 0
    Rem     If Trim(ZAyuda) <> "" Then
    Rem
    Rem         ZSql = ""
    Rem         ZSql = ZSql + "Select *"
    Rem         ZSql = ZSql + " FROM Peligroso"
    Rem         ZSql = ZSql + " Where Peligroso.NroOnu = " + "'" + ZAyuda + "'"
    Rem         ZSql = ZSql + " Order by Peligroso.Codigo"
    Rem         spPeligroso = ZSql
    Rem         Set rstPeligroso = db.OpenRecordset(spPeligroso, dbOpenSnapshot, dbSQLPassThrough)
    Rem         If rstPeligroso.RecordCount > 0 Then
    Rem
    Rem             With rstPeligroso
    Rem
    Rem                 .MoveFirst
    ...
    Rem
    Rem                         ZLugar = ZLugar + 1
    Rem                         ZPeligrosoI = rstPeligroso!Ficha
    Rem                         ZPeligrosoII = rstPeligroso!Descripcion
    Rem                         ZPeligrosoIII = rstPeligroso!Clase
    Rem                         ZPeligrosoIV = rstPeligroso!Secundario
    Rem                         ZPeligrosoV = rstPeligroso!Riesgo
    Rem                         ZPeligrosoVI = rstPeligroso!Embalaje
    Rem
    Rem                         .MoveNext
    Rem
    ...
    Rem
    Rem             End With
    Rem             rstPeligroso.Close
    Rem
    Rem         End If
    Rem
    Rem         If ZLugar = 1 Then
    Rem
    Rem             Pantalla.Visible = False
    Rem
    Rem             Clase.Text = Trim(ZPeligrosoIII)
    Rem             Secundario.Text = Trim(ZPeligrosoIV)
    Rem             Riesgo.Text = Trim(ZPeligrosoV)
    Rem             Embalaje.Text = Trim(ZPeligrosoVI)
    Rem             Caracteristicas.Text = Left$(ZPeligrosoII, 100)
    Rem             Intervencion.Text = Trim(ZPeligrosoI)
    Rem
    Rem                 Else
    Rem
    Rem             Opcion.Clear
