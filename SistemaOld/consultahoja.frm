...
Begin VB.Form PrgConsultaHoja 
   ...
   ScaleHeight     =   8325
   ScaleWidth      =   11850
   Begin VB.Frame IngreClave 
      Caption         =   "  Ingreso de Clave de Acceso"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   5760
      MouseIcon       =   "consultahoja.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "consultahoja.frx":030A
      ToolTipText     =   "Salida"
      Top             =   7680
      Width           =   480
   End
End
Attribute VB_Name = "PrgConsultaHoja"
...
Private Sub Form_Activate()
    ...
    Box7.Visible = False
    Box8.Visible = False
    IngreClave.Visible = True
    CmdClose.Visible = False
    PrgConsultaHoja.Caption = "Procesamiento de Hojas de Produccion"
    WClave.SetFocus
End Sub
...
Private Sub Proceso_Click()
        ...
        With rstHoja
            ...
            Do
                If .EOF = False Then
                    ...
                    ZDatos(Renglon, 16) = rstHoja!Operario
    ...
    If Val(ZDatos(1, 1)) <> 0 And Val(ZDatos(1, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(2, 1)) <> 0 And Val(ZDatos(2, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(3, 1)) <> 0 And Val(ZDatos(3, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(4, 1)) <> 0 And Val(ZDatos(4, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(5, 1)) <> 0 And Val(ZDatos(5, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(6, 1)) <> 0 And Val(ZDatos(6, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(7, 1)) <> 0 And Val(ZDatos(7, 16)) = ZZOperario Then
    ...
    If Val(ZDatos(8, 1)) <> 0 And Val(ZDatos(8, 16)) = ZZOperario Then
    ...
    If ZExiste = "N" Then
        m$ = "No posee equipos asignados para la produccion"
        A% = MsgBox(m$, 0, "Procesamiento de Hojas de Produccion")
        WClave.SetFocus
            Else
        CmdClose.Visible = True
        IngreClave.Visible = False
    End If
...
Private Sub WClave_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Sql1 = "Select *"
        Sql2 = " FROM Operarios"
        Sql3 = " Where Operarios.Clave = " + "'" + WClave.Text + "'"
        spOperarios = Sql1 + Sql2 + Sql3
        Set rstOperarios = db.OpenRecordset(spOperarios, dbOpenSnapshot, dbSQLPassThrough)
        If rstOperarios.RecordCount > 0 Then
            ZZOperario = rstOperarios!Codigo
            rstOperarios.Close
            Call Proceso_Click
        End If
    End If
