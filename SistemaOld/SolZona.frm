...
Begin VB.Form PrgSolZona 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Carga de Solicitud de Mercaderia a Zona Franca"
   ClientHeight    =   8055
   ClientLeft      =   360
   ClientTop       =   510
   ClientWidth     =   11400
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2460
      ItemData        =   "SolZona.frx":0000
      Left            =   120
      List            =   "SolZona.frx":0007
      TabIndex        =   1
      Top             =   5280
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   10560
      MouseIcon       =   "SolZona.frx":0015
      MousePointer    =   99  'Custom
      Picture         =   "SolZona.frx":031F
      ToolTipText     =   "Salida"
      Top             =   3360
      Width           =   480
   End
   Begin VB.Image Graba 
      Height          =   480
      Left            =   10560
      MouseIcon       =   "SolZona.frx":0B61
      MousePointer    =   99  'Custom
      Picture         =   "SolZona.frx":0E6B
   ...
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   10560
      MouseIcon       =   "SolZona.frx":16AD
      MousePointer    =   99  'Custom
      Picture         =   "SolZona.frx":19B7
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   10560
      MouseIcon       =   "SolZona.frx":21F9
      MousePointer    =   99  'Custom
      Picture         =   "SolZona.frx":2503
...
Private Sub Graba_Click()
    ...
    If Respuesta% = 6 Then
        ...
        WEmail(1) = "ngutierrez@pellital.com.ar"
        WEmail(2) = ""
        WEmail(3) = ""
        WEmail(4) = ""
        WEmail(5) = ""
        ...
        sCC = ""
        sBCC = ""
        sSubject = "Solicitud de Produccion de PT"
        ZSuma = "Fecha de Solicitud = " + Fecha.Text + "   "
        sBody = ZSuma
        ...
        For iRow = 1 To HastaRenglon
            ...
            WVector1.Col = 2
            ZDescripcion = Trim(WVector1.Text)
            ...
            ZSuma = "( Producto = " + ZArticulo + "   " + ZDescripcion + "   " + ZCantidad + " Kgs."
            If ZFechaEntrega <> "  /  /    " And ZFechaEntrega <> "" Then
                ZSuma = ZSuma + "  Fecha Entrega = " + ZFechaEntrega
            End If
            If ZEnvase <> "" Then
                ZSuma = ZSuma + "  Envase = " + ZEnvase
            End If
            ZSuma = ZSuma + " )      "
...
Private Sub Proceso_Click()
    ...
    Sql1 = "Select CargaSolicitud.Clave, CargaSolicitud.Solicitud, CargaSolicitud.Articulo, CargaSolicitud.Cantidad, CargaSolicitud.FechaEntrega, CargaSolicitud.Envase, Terminado.Descripcion"
