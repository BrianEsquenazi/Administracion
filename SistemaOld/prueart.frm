...
Begin VB.Form PrgPruart 
   ...
   Begin VB.ListBox WPantalla 
      ...
      EndProperty
      Height          =   645
      ItemData        =   "prueart.frx":0000
      Left            =   7440
      List            =   "prueart.frx":0007
      TabIndex        =   88
      Top             =   7800
      Visible         =   0   'False
      Width           =   1335
   ...
   Begin VB.ListBox pantalla 
      ...
      EndProperty
      Height          =   2220
      ItemData        =   "prueart.frx":0015
      Left            =   240
      List            =   "prueart.frx":001C
      TabIndex        =   6
      Top             =   5760
      Visible         =   0   'False
      Width           =   7815
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(2)   =   "prueart.frx":0062
      Tab(2).ControlCount=   44
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Valor21"
      Tab(2).Control(0).Enabled=   -1  'True
      Tab(2).Control(1)=   "Valor22"
      Tab(2).Control(1).Enabled=   -1  'True
      Tab(2).Control(2)=   "Valor23"
      Tab(2).Control(2).Enabled=   -1  'True
      Tab(2).Control(3)=   "Valor24"
      Tab(2).Control(3).Enabled=   -1  'True
      Tab(2).Control(4)=   "Valor25"
      Tab(2).Control(4).Enabled=   -1  'True
      Tab(2).Control(5)=   "Valor26"
      Tab(2).Control(5).Enabled=   -1  'True
      Tab(2).Control(6)=   "Valor27"
      Tab(2).Control(6).Enabled=   -1  'True
      Tab(2).Control(7)=   "Valor28"
      Tab(2).Control(7).Enabled=   -1  'True
      Tab(2).Control(8)=   "Valor29"
      Tab(2).Control(8).Enabled=   -1  'True
      Tab(2).Control(9)=   "Valor30"
      Tab(2).Control(9).Enabled=   -1  'True
      Tab(2).Control(10)=   "ValorNumero21"
      Tab(2).Control(10).Enabled=   -1  'True
      Tab(2).Control(11)=   "ValorNumero22"
      Tab(2).Control(11).Enabled=   -1  'True
      Tab(2).Control(12)=   "ValorNumero23"
      Tab(2).Control(12).Enabled=   -1  'True
      Tab(2).Control(13)=   "ValorNumero24"
      Tab(2).Control(13).Enabled=   -1  'True
      Tab(2).Control(14)=   "ValorNumero25"
      Tab(2).Control(14).Enabled=   -1  'True
      Tab(2).Control(15)=   "ValorNumero26"
      Tab(2).Control(15).Enabled=   -1  'True
      Tab(2).Control(16)=   "ValorNumero27"
      Tab(2).Control(16).Enabled=   -1  'True
      Tab(2).Control(17)=   "ValorNumero28"
      Tab(2).Control(17).Enabled=   -1  'True
      Tab(2).Control(18)=   "ValorNumero29"
      Tab(2).Control(18).Enabled=   -1  'True
      Tab(2).Control(19)=   "ValorNumero30"
      Tab(2).Control(19).Enabled=   -1  'True
      Tab(2).Control(20)=   "Descri21"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "Descri22"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "Descri23"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "Descri24"
      Tab(2).Control(23).Enabled=   0   'False
      Tab(2).Control(24)=   "Descri25"
      Tab(2).Control(24).Enabled=   0   'False
      Tab(2).Control(25)=   "Descri26"
      Tab(2).Control(25).Enabled=   0   'False
      Tab(2).Control(26)=   "Descri27"
      Tab(2).Control(26).Enabled=   0   'False
      Tab(2).Control(27)=   "Descri28"
      Tab(2).Control(27).Enabled=   0   'False
      Tab(2).Control(28)=   "Descri29"
      Tab(2).Control(28).Enabled=   0   'False
      Tab(2).Control(29)=   "Descri30"
      Tab(2).Control(29).Enabled=   0   'False
      Tab(2).Control(30)=   "Label41"
      Tab(2).Control(30).Enabled=   0   'False
      Tab(2).Control(31)=   "Std21"
      Tab(2).Control(31).Enabled=   0   'False
      Tab(2).Control(32)=   "Std22"
      Tab(2).Control(32).Enabled=   0   'False
      Tab(2).Control(33)=   "Std23"
      Tab(2).Control(33).Enabled=   0   'False
      Tab(2).Control(34)=   "Std24"
      Tab(2).Control(34).Enabled=   0   'False
      Tab(2).Control(35)=   "Std25"
      Tab(2).Control(35).Enabled=   0   'False
      Tab(2).Control(36)=   "Std26"
      Tab(2).Control(36).Enabled=   0   'False
      Tab(2).Control(37)=   "Std27"
      Tab(2).Control(37).Enabled=   0   'False
      Tab(2).Control(38)=   "Std28"
      Tab(2).Control(38).Enabled=   0   'False
      Tab(2).Control(39)=   "Std29"
      Tab(2).Control(39).Enabled=   0   'False
      Tab(2).Control(40)=   "Std30"
      Tab(2).Control(40).Enabled=   0   'False
      Tab(2).Control(41)=   "Label30"
      Tab(2).Control(41).Enabled=   0   'False
      Tab(2).Control(42)=   "Label29"
      Tab(2).Control(42).Enabled=   0   'False
      Tab(2).Control(43)=   "Label16"
...
Dim CargaEmpresa(100, 2) As String
...
Dim CargaEmpresa1(100, 10) As String
Dim TODAS As String
...
Private Sub Acepta_Click()
   ...
   Desde.Text = UCase(Desde.Text)
    ...
    If rstEspecificacionesUnifica.RecordCount > 0 Then
        ...
        ZEnsayo11 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo11), "0", rstEspecificacionesUnifica!Ensayo11)
        ZEnsayo12 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo12), "0", rstEspecificacionesUnifica!Ensayo12)
        ZEnsayo13 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo13), "0", rstEspecificacionesUnifica!Ensayo13)
        ZEnsayo14 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo14), "0", rstEspecificacionesUnifica!Ensayo14)
        ZEnsayo15 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo15), "0", rstEspecificacionesUnifica!Ensayo15)
        ZEnsayo16 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo16), "0", rstEspecificacionesUnifica!Ensayo16)
        ZEnsayo17 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo17), "0", rstEspecificacionesUnifica!Ensayo17)
        ZEnsayo18 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo18), "0", rstEspecificacionesUnifica!Ensayo18)
        ZEnsayo19 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo19), "0", rstEspecificacionesUnifica!Ensayo19)
        ZEnsayo20 = IIf(IsNull(rstEspecificacionesUnifica!Ensayo20), "0", rstEspecificacionesUnifica!Ensayo20)
    ...
    If rstEspecificacionesUnificaIII.RecordCount > 0 Then
        ...
        ZEnsayo21 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo21), "0", rstEspecificacionesUnificaIII!Ensayo21)
        ZEnsayo22 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo22), "0", rstEspecificacionesUnificaIII!Ensayo22)
        ZEnsayo23 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo23), "0", rstEspecificacionesUnificaIII!Ensayo23)
        ZEnsayo24 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo24), "0", rstEspecificacionesUnificaIII!Ensayo24)
        ZEnsayo25 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo25), "0", rstEspecificacionesUnificaIII!Ensayo25)
        ZEnsayo26 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo26), "0", rstEspecificacionesUnificaIII!Ensayo26)
        ZEnsayo27 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo27), "0", rstEspecificacionesUnificaIII!Ensayo27)
        ZEnsayo28 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo28), "0", rstEspecificacionesUnificaIII!Ensayo28)
        ZEnsayo29 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo29), "0", rstEspecificacionesUnificaIII!Ensayo29)
        ZEnsayo30 = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo30), "0", rstEspecificacionesUnificaIII!Ensayo30)
        ...
        ZEnsayo(29) = IIf(IsNull(rstEspecificacionesUnificaIII!Ensayo29), "0", rstEspecificacionesUnificaIII!Ensayo29)
   ...
   Rem ACA SE CONECTA A LA EMPRESA SELECT
    ...
    If TODAS = "1" Then
               ...
               CargaEmpresa1(1, 1) = "0001"
                CargaEmpresa1(1, 2) = "Empresa01"
                CargaEmpresa1(2, 1) = "0003"
                CargaEmpresa1(2, 2) = "Empresa03"
              Rem  CargaEmpresa1(3, 1) = "0005"
               Rem CargaEmpresa1(3, 2) = "Empresa05"
              Rem  CargaEmpresa1(4, 1) = "0006"
              Rem  CargaEmpresa1(4, 2) = "Empresa06"
                CargaEmpresa1(3, 1) = "0007"
                CargaEmpresa1(3, 2) = "Empresa07"
                CargaEmpresa1(4, 1) = "0010"
                CargaEmpresa1(4, 2) = "Empresa10"
                CargaEmpresa1(5, 1) = "0011"
                CargaEmpresa1(5, 2) = "Empresa11"
                
                XEmpresa = Wempresa
                ZHasta1 = 5
               For ZCiclo = 1 To ZHasta1
                 
                    Wempresa = CargaEmpresa1(ZCiclo, 1)
                    txtOdbc = CargaEmpresa1(ZCiclo, 2)
                    OPEN_FILE_PRUEBA
...
Private Sub GrabaLote_Click()
        ...
        Select Case WTipoOrden
            Case 1, 2
                ...
                If WTipoOrden = 1 Then
                    ...
                    ZSql = ZSql + " OrdenI = " + "'" + Orden.Text + "',"
                    ZSql = ZSql + " PtaOrdenI = " + "'" + ZZEmpresa + "'"
                    ...
                    For Ciclo = 1 To 11
                        ...
                        Wempresa = CargaEmpresa(Ciclo, 1)
                        txtOdbc = CargaEmpresa(Ciclo, 2)
                        strConnect = "odbc;dsn=" & txtOdbc & ";uid=" & txtUserName & ";pwd=" & txtPassword & ";app=" & gAplicacion
                        Set db = DBEngine.Workspaces(0).OpenDatabase("", False, False, strConnect)
    ...
    If Val(Devuelta.Text) > 0 Then
        ...
        If Val(Wempresa) = 1 Or Val(Wempresa) = 3 Or Val(Wempresa) = 5 Or Val(Wempresa) = 6 Or Val(Wempresa) = 7 Or Val(Wempresa) = 10 Or Val(Wempresa) = 11 Then
            ...
            WEmail = "pcorna@surfactan.com.ar;atassara@surfactan.com.ar;mborelli@surfactan.com.ar;juanfs@surfactan.com.ar"
            sTo = WEmail
            sCC = ""
            sBCC = ""
    ...
    If Val(Liberada.Text) > 0 Then
        ...
        If Entra = "S" Then
            ...
            If Val(Wempresa) = 1 Or Val(Wempresa) = 3 Or Val(Wempresa) = 5 Or Val(Wempresa) = 6 Or Val(Wempresa) = 7 Or Val(Wempresa) = 10 Or Val(Wempresa) = 11 Then
                WEmail = "atassara@surfactan.com.ar"
                    Else
                WEmail = "Rechazo"
            End If
            sTo = WEmail
...
Private Sub Confirmaestado_Click()
    ...
    If FechaElaboracion.Text <> "  /  /    " And FechaElaboracion.Text <> "00/00/0000" Then
        Call Valida_fecha(FechaElaboracion.Text, Auxi4)
        If Auxi4 <> "S" Then
            m$ = "Fecha de Elaboracion incorrecta"
            d% = MsgBox(m$, 0, "Ingreso de Ensayos de Materia Prima")
            Exit Sub
        End If
    End If
...
Private Sub Impensayo_Click()
    ...
    Lista.ReportFileName = "ensayo22.rpt"
    Lista.Destination = 0
    
     Lista.Formulas(0) = "descri1= '" & Descri1.Caption & "'"
     Lista.Formulas(1) = "descri2= '" & descri2.Caption & "'"
     Lista.Formulas(3) = "descri3= '" & Descri3.Caption & "'"
     Lista.Formulas(4) = "descri4= '" & Descri4.Caption & "'"
     Lista.Formulas(5) = "descri5= '" & Descri5.Caption & "'"
     Lista.Formulas(6) = "descri6= '" & Descri6.Caption & "'"
     Lista.Formulas(7) = "descri7= '" & Descri7.Caption & "'"
     Lista.Formulas(8) = "descri8= '" & Descri8.Caption & "'"
     Lista.Formulas(9) = "descri9= '" & Descri9.Caption & "'"
     Lista.Formulas(10) = "descri10= '" & Descri10.Caption & "'"
     Lista.Formulas(11) = "descri11= '" & Descri11.Caption & "'"
     Lista.Formulas(12) = "descri12= '" & Descri12.Caption & "'"
     Lista.Formulas(13) = "descri13= '" & Descri13.Caption & "'"
     Lista.Formulas(14) = "descri14= '" & Descri14.Caption & "'"
     Lista.Formulas(15) = "descri15= '" & Descri15.Caption & "'"
     Lista.Formulas(16) = "descri16= '" & Descri16.Caption & "'"
     Lista.Formulas(17) = "descri17= '" & Descri17.Caption & "'"
     Lista.Formulas(18) = "descri18= '" & Descri18.Caption & "'"
     Lista.Formulas(19) = "descri19= '" & Descri19.Caption & "'"
     Lista.Formulas(20) = "descri20= '" & Descri20.Caption & "'"
  Rem   Lista.Formulas(21) = "descri21= '" & Descri21.Caption & "'"
  Rem   Lista.Formulas(22) = "descri22= '" & Descri22.Caption & "'"
  Rem   Lista.Formulas(23) = "descri23= '" & Descri23.Caption & "'"
  Rem   Lista.Formulas(24) = "descri24= '" & Descri24.Caption & "'"
  Rem   Lista.Formulas(25) = "descri25= '" & Descri25.Caption & "'"
  Rem   Lista.Formulas(26) = "descri26= '" & Descri26.Caption & "'"
  Rem   Lista.Formulas(27) = "descri27= '" & Descri27.Caption & "'"
  Rem   Lista.Formulas(28) = "descri28= '" & Descri28.Caption & "'"
   Rem  Lista.Formulas(29) = "descri29= '" & Descri29.Caption & "'"
 Rem    Lista.Formulas(30) = "descri30= '" & Descri30.Caption & "'"
    
    Lista.Formulas(31) = "std1= '" & Std1.Caption & "'"
     Lista.Formulas(32) = "std2= '" & Std2.Caption & "'"
     Lista.Formulas(33) = "std3= '" & Std3.Caption & "'"
     Lista.Formulas(34) = "std4= '" & Std4.Caption & "'"
     Lista.Formulas(35) = "std5= '" & Std5.Caption & "'"
     Lista.Formulas(36) = "std6= '" & Std6.Caption & "'"
     Lista.Formulas(37) = "std7= '" & Std7.Caption & "'"
     Lista.Formulas(38) = "std8= '" & Std8.Caption & "'"
     Lista.Formulas(39) = "std9= '" & Std9.Caption & "'"
     Lista.Formulas(40) = "std10= '" & Std10.Caption & "'"
     Lista.Formulas(41) = "std11= '" & Std11.Caption & "'"
     Lista.Formulas(42) = "std12= '" & Std12.Caption & "'"
     Lista.Formulas(43) = "std13= '" & Std13.Caption & "'"
     Lista.Formulas(44) = "std14= '" & Std14.Caption & "'"
     Lista.Formulas(45) = "std15= '" & Std15.Caption & "'"
     Lista.Formulas(46) = "std16= '" & Std16.Caption & "'"
     Lista.Formulas(47) = "std17= '" & Std17.Caption & "'"
     Lista.Formulas(48) = "std18= '" & Std18.Caption & "'"
     Lista.Formulas(49) = "std19= '" & Std19.Caption & "'"
     Lista.Formulas(50) = "std20= '" & Std20.Caption & "'"
   Rem  Lista.Formulas(51) = "std21= '" & Std21.Caption & "'"
   Rem  Lista.Formulas(52) = "std22= '" & Std22.Caption & "'"
   Rem  Lista.Formulas(53) = "std23= '" & Std23.Caption & "'"
   Rem  Lista.Formulas(54) = "std24= '" & Std24.Caption & "'"
   Rem  Lista.Formulas(55) = "std25= '" & Std25.Caption & "'"
   Rem  Lista.Formulas(56) = "std26= '" & Std26.Caption & "'"
   Rem  Lista.Formulas(57) = "std27= '" & Std27.Caption & "'"
   Rem  Lista.Formulas(58) = "std28= '" & Std28.Caption & "'"
   Rem  Lista.Formulas(59) = "std29= '" & Std29.Caption & "'"
   Rem  Lista.Formulas(60) = "std30= '" & Std30.Caption & "'"
    
    Lista.Formulas(61) = "valor1= '" & Valor1.Text & "'"
    Lista.Formulas(62) = "valor2= '" & valor2.Text & "'"
    Lista.Formulas(63) = "valor3= '" & Valor3.Text & "'"
    Lista.Formulas(64) = "valor4= '" & valor4.Text & "'"
    Lista.Formulas(65) = "valor5= '" & valor5.Text & "'"
    Lista.Formulas(66) = "valor6= '" & valor6.Text & "'"
    Lista.Formulas(67) = "valor7= '" & valor7.Text & "'"
    Lista.Formulas(68) = "valor8= '" & valor8.Text & "'"
    Lista.Formulas(69) = "valor9= '" & valor9.Text & "'"
    Lista.Formulas(70) = "valor10= '" & valor10.Text & "'"
    Lista.Formulas(71) = "valor11= '" & Valor11.Text & "'"
    Lista.Formulas(72) = "valor12= '" & Valor12.Text & "'"
    Lista.Formulas(73) = "valor13= '" & Valor13.Text & "'"
    Lista.Formulas(74) = "valor14= '" & Valor14.Text & "'"
    Lista.Formulas(75) = "valor15= '" & Valor15.Text & "'"
    Lista.Formulas(76) = "valor16= '" & Valor16.Text & "'"
    Lista.Formulas(77) = "valor17= '" & Valor17.Text & "'"
    Lista.Formulas(78) = "valor18= '" & Valor18.Text & "'"
    Lista.Formulas(79) = "valor19= '" & Valor19.Text & "'"
    Lista.Formulas(80) = "valor20= '" & Valor20.Text & "'"
    
    Lista.Formulas(81) = "informe1= '" & Informe.Text & "'"
    Lista.Formulas(82) = "orden1= '" & Orden.Text & "'"
    Lista.Formulas(83) = "partidaprove= '" & PartidaProveedorII.Text & "'"
     Lista.Formulas(84) = "EMPRE= '" & WAuxiliar & "'"
     Lista.Formulas(85) = "vto= '" & Vto & "'"
     Lista.Formulas(86) = "merc= '" & OrigenMercaderiaII & "'"
     Lista.Formulas(87) = "descriprod= '" & Descriprod.Caption & "'"
    
    
    Lista.SQLQuery = "SELECT * " _
                + "From " _
                + DSQ + ".dbo.Prueart Prueart " _
                + "Where " _
                + "Prueart.prueba= " + "'" + "1" + Lote.Text + "'" _
 ...
 Rem   Printer.FontSize = "12"
 Rem   Printer.Print Tab(1); ""
 Rem   Printer.FontSize = "10"
    
 Rem   Printer.Print Tab(1); "Empresa : " + Wauxiliar
 Rem   Printer.Print Tab(1); ""
 Rem   Printer.Print Tab(20); "ENSAYO DE MATERIA PRIMA"
 Rem   Printer.Print Tab(1); ""
 Rem   Printer.Print Tab(1); "Prueba"; Tab(15); Lote.Text
 Rem   Printer.Print Tab(1); "Producto"; Tab(15); Producto.Text; Tab(40); Descriprod.Caption
 Rem   Printer.Print Tab(1); "Fecha"; Tab(15); Fecha.Text
 Rem   Printer.Print Tab(1); ""
    
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri1.Caption; Tab(80); Std1.Caption; Tab(105); Valor1.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); descri2.Caption; Tab(80); Std2.Caption; Tab(105); valor2.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri3.Caption; Tab(80); Std3.Caption; Tab(105); Valor3.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri4.Caption; Tab(80); Std4.Caption; Tab(105); valor4.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri5.Caption; Tab(80); Std5.Caption; Tab(105); valor5.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri6.Caption; Tab(80); Std6.Caption; Tab(105); valor6.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri7.Caption; Tab(80); Std7.Caption; Tab(105); valor7.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri8.Caption; Tab(80); Std8.Caption; Tab(105); valor8.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri9.Caption; Tab(80); Std9.Caption; Tab(105); valor9.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri10.Caption; Tab(80); Std10.Caption; Tab(105); valor10.Text
  Rem  Printer.Print Tab(1); "Ensayo"; Tab(15); Descri11.Caption; Tab(80); Left$(Std11.Caption, 20); Tab(105); Valor11.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri12.Caption; Tab(80); Left$(Std12.Caption, 20); Tab(105); Valor12.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri13.Caption; Tab(80); Left$(Std13.Caption, 20); Tab(105); Valor13.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri14.Caption; Tab(80); Left$(Std14.Caption, 20); Tab(105); Valor14.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri15.Caption; Tab(80); Left$(Std15.Caption, 20); Tab(105); Valor15.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri16.Caption; Tab(80); Left$(Std16.Caption, 20); Tab(105); Valor16.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri17.Caption; Tab(80); Left$(Std17.Caption, 20); Tab(105); Valor17.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri18.Caption; Tab(80); Left$(Std18.Caption, 20); Tab(105); Valor18.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri19.Caption; Tab(80); Left$(Std19.Caption, 20); Tab(105); Valor19.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri20.Caption; Tab(80); Left$(Std20.Caption, 20); Tab(105); Valor20.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri21.Caption; Tab(80); Left$(Std21.Caption, 20); Tab(105); Valor21.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri22.Caption; Tab(80); Left$(Std22.Caption, 20); Tab(105); Valor22.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri23.Caption; Tab(80); Left$(Std23.Caption, 20); Tab(105); Valor23.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri24.Caption; Tab(80); Left$(Std24.Caption, 20); Tab(105); Valor24.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri25.Caption; Tab(80); Left$(Std25.Caption, 20); Tab(105); Valor25.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri26.Caption; Tab(80); Left$(Std26.Caption, 20); Tab(105); Valor26.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri27.Caption; Tab(80); Left$(Std27.Caption, 20); Tab(105); Valor27.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri28.Caption; Tab(80); Left$(Std28.Caption, 20); Tab(105); Valor28.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri29.Caption; Tab(80); Left$(Std29.Caption, 20); Tab(105); Valor29.Text
 Rem   Printer.Print Tab(1); "Ensayo"; Tab(15); Descri30.Caption; Tab(80); Left$(Std30.Caption, 20); Tab(105); Valor30.Text
    
    
    
 Rem   Printer.Print Tab(1); ""
 Rem   Printer.Print Tab(1); "Observaciones"; Tab(20); Ensayo.Text
 Rem   Printer.Print Tab(1); "Observaciones"; Tab(20); Aspecto.Text
    Rem Printer.Print Tab(1); "Observaciones"; Tab(20); Observaciones.Text
 Rem   Printer.Print Tab(1); "Confecciono"; Tab(20); Confecciono.Text
 Rem   Printer.Print Tab(1); ""
 Rem   Printer.Print Tab(1); "Liberada"; Tab(30); Pusing("###,###", Val(Liberada.Text))
 Rem   Printer.Print Tab(1); "Devuelta"; Tab(30); Pusing("###,###", Val(Devuelta.Text))
 Rem   Printer.Print Tab(1); "Nro Rechazo"; Tab(30); Pusing("######", Val(NroRechazo.Text))
 Rem   Printer.Print Tab(1); ""
    ...
    If KeyAscii = 13 Then
        ...
        Select Case Llave
            Case "S"
                ...
                FechaElaboracion.Text = ZFechaElaboracion
...
Private Sub Listado_Click()
    ...
    Desdefec.Text = "  /  /    "
    Hastafec.Text = "  /  /    "
    ImprePantalla.Value = True
    ImpreListado.Value = False
    Aprobado.Value = True
    Rechazo.Value = False
    Frame2.Visible = True
    Desde.SetFocus
...
Private Sub RevalidaAnterior_keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ZSql = ""
        ZSql = ZSql + "Select Revalida.Revalida, Revalida.Articulo"
...
Private Sub ImprimeII_Click()
    ...
    For Ciclo = 1 To 30
        ...
        spEnsayo = "ConsultaEnsayos " + "'" + ZEnsayo(Ciclo) + "'"
        Set rstEnsayo = db.OpenRecordset(spEnsayo, dbOpenSnapshot, dbSQLPassThrough)
        If rstEnsayo.RecordCount > 0 Then
            Auxi1 = ZEnsayo(Ciclo)
            Call Ceros(Auxi1, 4)
            ZZDescri = Auxi1 + " - " + rstEnsayo!Descripcion
            ZUnidad(Ciclo) = IIf(IsNull(rstEnsayo!Unidad), "", rstEnsayo!Unidad)
            rstEnsayo.Close
                Else
            ZZDescri = ""
        End If
    ...
    If Val(ZEnsayo(1)) = 0 Then
        Descri1.Caption = ""
    End If
    If Val(ZEnsayo(2)) = 0 Then
        descri2.Caption = ""
    End If
    If Val(ZEnsayo(3)) = 0 Then
        Descri3.Caption = ""
    End If
    If Val(ZEnsayo(4)) = 0 Then
        Descri4.Caption = ""
    End If
    If Val(ZEnsayo(5)) = 0 Then
        Descri5.Caption = ""
    End If
    If Val(ZEnsayo(6)) = 0 Then
        Descri6.Caption = ""
    End If
    If Val(ZEnsayo(7)) = 0 Then
        Descri7.Caption = ""
    End If
    If Val(ZEnsayo(8)) = 0 Then
        Descri8.Caption = ""
    End If
    If Val(ZEnsayo(9)) = 0 Then
        Descri9.Caption = ""
    End If
    If Val(ZEnsayo(10)) = 0 Then
        Descri10.Caption = ""
    End If
    If Val(ZEnsayo(11)) = 0 Then
        Descri11.Caption = ""
    End If
    If Val(ZEnsayo(12)) = 0 Then
        Descri12.Caption = ""
    End If
    If Val(ZEnsayo(13)) = 0 Then
        Descri13.Caption = ""
    End If
    If Val(ZEnsayo(14)) = 0 Then
        Descri14.Caption = ""
    End If
    If Val(ZEnsayo(15)) = 0 Then
        Descri15.Caption = ""
    End If
    If Val(ZEnsayo(16)) = 0 Then
        Descri16.Caption = ""
    End If
    If Val(ZEnsayo(17)) = 0 Then
        Descri17.Caption = ""
    End If
    If Val(ZEnsayo(18)) = 0 Then
        Descri18.Caption = ""
    End If
    If Val(ZEnsayo(19)) = 0 Then
        Descri19.Caption = ""
    End If
    If Val(ZEnsayo(20)) = 0 Then
        Descri20.Caption = ""
    End If
    If Val(ZEnsayo(21)) = 0 Then
        Descri21.Caption = ""
    End If
    If Val(ZEnsayo(22)) = 0 Then
        Descri22.Caption = ""
    End If
    If Val(ZEnsayo(23)) = 0 Then
        Descri23.Caption = ""
    End If
    If Val(ZEnsayo(24)) = 0 Then
        Descri24.Caption = ""
    End If
    If Val(ZEnsayo(25)) = 0 Then
        Descri25.Caption = ""
    End If
    If Val(ZEnsayo(26)) = 0 Then
        Descri26.Caption = ""
    End If
    If Val(ZEnsayo(27)) = 0 Then
        Descri27.Caption = ""
    End If
    If Val(ZEnsayo(28)) = 0 Then
        Descri28.Caption = ""
    End If
    If Val(ZEnsayo(29)) = 0 Then
        Descri29.Caption = ""
    End If
    If Val(ZEnsayo(30)) = 0 Then
        Descri30.Caption = ""
    End If
            ...
            If rstPrueart.RecordCount > 0 Then
                        ...
                        Do
                            If .EOF = False Then
                                ...
                                If WDesde <= WFechaord And WHasta >= WFechaord Then
                                    ...
                                    ZEnsayo11 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo11), "0", rstEspecificacionesUnificaVersion!Ensayo11)
                                    ZEnsayo12 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo12), "0", rstEspecificacionesUnificaVersion!Ensayo12)
                                    ZEnsayo13 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo13), "0", rstEspecificacionesUnificaVersion!Ensayo13)
                                    ZEnsayo14 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo14), "0", rstEspecificacionesUnificaVersion!Ensayo14)
                                    ZEnsayo15 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo15), "0", rstEspecificacionesUnificaVersion!Ensayo15)
                                    ZEnsayo16 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo16), "0", rstEspecificacionesUnificaVersion!Ensayo16)
                                    ZEnsayo17 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo17), "0", rstEspecificacionesUnificaVersion!Ensayo17)
                                    ZEnsayo18 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo18), "0", rstEspecificacionesUnificaVersion!Ensayo18)
                                    ZEnsayo19 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo19), "0", rstEspecificacionesUnificaVersion!Ensayo19)
                                    ZEnsayo20 = IIf(IsNull(rstEspecificacionesUnificaVersion!Ensayo20), "0", rstEspecificacionesUnificaVersion!Ensayo20)
                ...
                If LlamaImprime = "N" Then
                    ...
                    If rstEspecificacionesUnificaIII.RecordCount > 0 Then
                        ...
                        ZStd21 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor21), "", rstEspecificacionesUnificaIII!Valor21)
                        ZStd22 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor22), "", rstEspecificacionesUnificaIII!Valor22)
                        ZStd23 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor23), "", rstEspecificacionesUnificaIII!Valor23)
                        ZStd24 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor24), "", rstEspecificacionesUnificaIII!Valor24)
                        ZStd25 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor25), "", rstEspecificacionesUnificaIII!Valor25)
                        ZStd26 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor26), "", rstEspecificacionesUnificaIII!Valor26)
                        ZStd27 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor27), "", rstEspecificacionesUnificaIII!Valor27)
                        ZStd28 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor28), "", rstEspecificacionesUnificaIII!Valor28)
                        ZStd29 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor29), "", rstEspecificacionesUnificaIII!Valor29)
                        ZStd30 = IIf(IsNull(rstEspecificacionesUnificaIII!Valor30), "", rstEspecificacionesUnificaIII!Valor30)
                ...
                If LlamaImprime = "S" Then
                    ...
                    If rstEspecificacionesUnificaVersionII.RecordCount > 0 Then
                        ...
                        ZEnsayo21 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo21), "0", rstEspecificacionesUnificaVersionII!Ensayo21)
                        ZEnsayo22 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo22), "0", rstEspecificacionesUnificaVersionII!Ensayo22)
                        ZEnsayo23 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo23), "0", rstEspecificacionesUnificaVersionII!Ensayo23)
                        ZEnsayo24 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo24), "0", rstEspecificacionesUnificaVersionII!Ensayo24)
                        ZEnsayo25 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo25), "0", rstEspecificacionesUnificaVersionII!Ensayo25)
                        ZEnsayo26 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo26), "0", rstEspecificacionesUnificaVersionII!Ensayo26)
                        ZEnsayo27 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo27), "0", rstEspecificacionesUnificaVersionII!Ensayo27)
                        ZEnsayo28 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo28), "0", rstEspecificacionesUnificaVersionII!Ensayo28)
                        ZEnsayo29 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo29), "0", rstEspecificacionesUnificaVersionII!Ensayo29)
                        ZEnsayo30 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Ensayo30), "0", rstEspecificacionesUnificaVersionII!Ensayo30)
                        
                        ZStd21 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor21), "", rstEspecificacionesUnificaVersionII!Valor21)
                        ZStd22 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor22), "", rstEspecificacionesUnificaVersionII!Valor22)
                        ZStd23 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor23), "", rstEspecificacionesUnificaVersionII!Valor23)
                        ZStd24 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor24), "", rstEspecificacionesUnificaVersionII!Valor24)
                        ZStd25 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor25), "", rstEspecificacionesUnificaVersionII!Valor25)
                        ZStd26 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor26), "", rstEspecificacionesUnificaVersionII!Valor26)
                        ZStd27 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor27), "", rstEspecificacionesUnificaVersionII!Valor27)
                        ZStd28 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor28), "", rstEspecificacionesUnificaVersionII!Valor28)
                        ZStd29 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor29), "", rstEspecificacionesUnificaVersionII!Valor29)
                        ZStd30 = IIf(IsNull(rstEspecificacionesUnificaVersionII!Valor30), "", rstEspecificacionesUnificaVersionII!Valor30)
                ...
                If rstLaudo.RecordCount > 0 Then
                    ...
                    Vencimiento.Text = WVto
                    Vto.Text = WVto
                    
                    WFechaElaboracion = IIf(IsNull(rstLaudo!FechaElaboracion), "  /  /    ", rstLaudo!FechaElaboracion)
                    FechaElaboracion.Text = WFechaElaboracion
                ...
                If rstInforme.RecordCount > 0 Then
                    ...
                    XEstado1 = IIf(IsNull(rstInforme!Estado1), "0", rstInforme!Estado1)
                    XEstado2 = IIf(IsNull(rstInforme!Estado2), "", RTrim(rstInforme!Estado2))
                    Estado2.Text = IIf(IsNull(rstInforme!Estado2), "", RTrim(rstInforme!Estado2))
                    Certificado2.Text = IIf(IsNull(rstInforme!Certificado2), "", RTrim(rstInforme!Certificado2))
                    rstInforme.Close
                End If
                ...
                T$ = "Ensayos de materias primas"
                m$ = "Desea ver los datos del certificado de analisis "
                Respuesta% = MsgBox(m$, 32 + 4, T$)
                If Respuesta% = 6 Then
                    IngresaEstado.Visible = True
                End If
