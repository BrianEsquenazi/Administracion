...
Begin VB.Form PrgImpreVtoPtaVII 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgImpreVtoPtaVII"
...
Private Sub Acepta_Click()
    ...
    For ZZZCiclo = 1 To 2
        ...
        ZSql = ZSql + " Where VerificaVtoArti.ImpreVII = " + "'" + "N" + "'"
