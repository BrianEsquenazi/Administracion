...
Begin VB.Form PrgCargaIIIProduccionAutomatico 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame PantaGraba 
      ...
      Begin VB.Image GrabaII 
         Height          =   480
         Left            =   1440
         MouseIcon       =   "cargaiiiproduccionautomatico.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "cargaiiiproduccionautomatico.frx":030A
      ...
      Begin VB.Image CierraII 
         Height          =   480
         Left            =   3000
         MouseIcon       =   "cargaiiiproduccionautomatico.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "cargaiiiproduccionautomatico.frx":0E56
         ToolTipText     =   "Salida"
         Top             =   1920
         Width           =   480
      End
   ...
   Begin VB.CommandButton AltaPoe 
      Height          =   735
      Left            =   9000
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   39
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabPicture(0)   =   "cargaiiiproduccionautomatico.frx":226C
      ...
      TabPicture(1)   =   "cargaiiiproduccionautomatico.frx":2288
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "cargaiiiproduccionautomatico.frx":22A4
      Left            =   120
      List            =   "cargaiiiproduccionautomatico.frx":22AB
      TabIndex        =   1
      Top             =   6480
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   8280
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":22B9
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":25C3
   ...
   Begin VB.Image AltaRenglon 
      Height          =   480
      Left            =   7440
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":2E05
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":310F
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   9960
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":3551
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":385B
      ToolTipText     =   "Salida"
      Top             =   6240
      Width           =   480
   End
   Begin VB.Image Graba 
      Height          =   480
      Left            =   7440
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":409D
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":43A7
      ToolTipText     =   "Graba los Datos Ingresados"
      Top             =   6240
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   9120
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":4BE9
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":4EF3
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   8280
      MouseIcon       =   "cargaiiiproduccionautomatico.frx":5735
      MousePointer    =   99  'Custom
      Picture         =   "cargaiiiproduccionautomatico.frx":5A3F
   ...
   End
End
Attribute VB_Name = "PrgCargaIIIProduccionAutomatico"
...
Dim WPasaVector(5000, 36) As String
...
Private Sub AltaEpata_Click()
    ...
    If Respuesta% = 6 Then
        ...
        For Ciclo = 1 To ZLugar
            ...
            ZVersion = WPasaVector(Ciclo, 26)
            ZFechaVersion = WPasaVector(Ciclo, 27)
            ZItem = ""
...
Private Sub Command1_Click()
    ...
    ZSql = ZSql + " Version = " + "'" + "1" + "',"
    ZSql = ZSql + " FechaVersion = " + "'" + "01/01/2010" + "',"
    ZSql = ZSql + " OrdFechaVersion = " + "'" + "20100101" + "'"
    spCargaIII = ZSql
            ...
            With rstCargaIII
                ...
                Do
                    If .EOF = False Then
                        ...
                        ZZZVersion = IIf(IsNull(rstCargaIII!Version), "0", rstCargaIII!Version)
                        WPasaVector(ZLugar, 26) = ZZZVersion
                        
                        ZZZFechaVersion = IIf(IsNull(rstCargaIII!FechaVersion), "  /  /    ", rstCargaIII!FechaVersion)
                        WPasaVector(ZLugar, 27) = ZZZFechaVersion
...
Private Sub Graba_Click()
    ...
    ZSql = ZSql + " FROM CargaIII"
    ZSql = ZSql + " Where CargaIII.Terminado = " + "'" + Terminado.Text + "'"
    Rem ZSql = ZSql + " and CargaIII.Paso = " + "'" + Paso.Text + "'"
    rsCargaIII = ZSql
    Set rstCargaIII = db.OpenRecordset(rsCargaIII, dbOpenSnapshot, dbSQLPassThrough)
    If rstCargaIII.RecordCount > 0 Then
        Version.Text = Str$(rstCargaIII!Version)
        FechaVersion.Text = rstCargaIII!FechaVersion
        rstCargaIII.Close
    End If
    ...
    For iRow = 1 To HastaRenglon
        ...
        If Trim(XDescripcion) = "SOLICITAR CONTROL INTERMEDIO a LAB CC" Then
...
Private Sub Form_Load()
    ...
    Terminado.Text = ZZPasaTerminado
    Paso.Text = ZZPasaPaso
