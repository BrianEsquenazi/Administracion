...
Begin VB.Form PrgEvaluaEnsayos 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   600
         MouseIcon       =   "evaluaEnsayos.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "evaluaEnsayos.frx":030A
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1200
         MouseIcon       =   "evaluaEnsayos.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "evaluaEnsayos.frx":0A56
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   1680
         MouseIcon       =   "evaluaEnsayos.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "evaluaEnsayos.frx":11A2
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   120
         MouseIcon       =   "evaluaEnsayos.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "evaluaEnsayos.frx":18EE
   ...
   Begin VB.Label Parametro 
      Caption         =   "Protocolo OK/evid. de calibracion o ISO 17025, 9001, SAC, H.SPA. Metodo OK"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3000
      MouseIcon       =   "evaluaEnsayos.frx":1D30
      MousePointer    =   99  'Custom
      Picture         =   "evaluaEnsayos.frx":203A
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   1560
      MouseIcon       =   "evaluaEnsayos.frx":287C
      MousePointer    =   99  'Custom
      Picture         =   "evaluaEnsayos.frx":2B86
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   120
      MouseIcon       =   "evaluaEnsayos.frx":33C8
      MousePointer    =   99  'Custom
      Picture         =   "evaluaEnsayos.frx":36D2
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   840
      MouseIcon       =   "evaluaEnsayos.frx":3F14
      MousePointer    =   99  'Custom
      Picture         =   "evaluaEnsayos.frx":421E
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "evaluaEnsayos.frx":4A60
      MousePointer    =   99  'Custom
      Picture         =   "evaluaEnsayos.frx":4D6A
      ToolTipText     =   "Salida"
      Top             =   3840
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2280
      MouseIcon       =   "evaluaEnsayos.frx":55AC
      MousePointer    =   99  'Custom
      Picture         =   "evaluaEnsayos.frx":58B6
   ...
   End
End
Attribute VB_Name = "PrgEvaluaEnsayos"
