...
Begin VB.Form PrgEsta2 
   AutoRedraw      =   -1  'True
   Caption         =   "3.-Listado de Estadisitica de Ventas por Linea y Articulo"
   ClientHeight    =   6840
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
...
Private Sub Acepta_Click()
    ...
    Sql5 = " and Estadistica.Linea >= " + "'" + Desde.Text + "'"
    Sql6 = " and Estadistica.Linea <= " + "'" + Hasta.Text + "'"
    ...
    Listado.WindowTitle = "3.-Listado de Estadistica de Ventas por Linea y Articulo"
    Listado.WindowTop = 0
    ...
    Dos = " and {Estadistica.Linea} in " + Desde.Text + " to " + Hasta.Text
    ...
    Listado.ReportFileName = "WEsta2ii.rpt"
