...
Begin VB.Form PrgImpreOrdSv 
   ...
   End
End
Attribute VB_Name = "PrgImpreOrdSv"
...
Private Sub Acepta_Click()
        ...
        With rstOrden
            ...
            If .NoMatch = False Then
                Do
                    ...
                    For XDa = 1 To Lugar
                        If Val(Vector(XDa)) = rstOrden!Orden Then
                            Entra = "N"
                            Exit For
                        End If
                    Next XDa
        ...
        With rstOrden
            ...
            If .NoMatch = False Then
                Do
                    ...
                    For XDa = 1 To LugarII
                        If Val(VectorII(XDa)) = rstOrden!Orden Then
                            Entra = "N"
                            Exit For
                        End If
                    Next XDa
                    ...
                    If Entra = "S" Then
                        LugarII = LugarII + 1
                        VectorII(LugarII) = rstOrden!Orden
                    End If
    ...
    If Lugar > 0 Or LugarII > 0 Then
        PrgImpreOrdSv.Refresh
        Aviso.Visible = True
        Aviso.Refresh
        For a = 1 To 10
            Beep
...
Private Sub Imprime_Click()
    ...
    For WWCicla = 1 To Lugar
        ...
        Rem ZZTipoOrden = 0
        Rem spOrden = "ConsultaOrden " + "'" + WOrden + "'"
        Rem Set rstOrden = db.OpenRecordset(spOrden, dbOpenSnapshot, dbSQLPassThrough)
        Rem If rstOrden.RecordCount > 0 Then
        Rem     ZZTipoOrden = IIf(IsNull(rstOrden!Tipo), "0", rstOrden!Tipo)
        Rem     rstOrden.Close
        Rem End If
        Rem
        Rem If ZZTipoOrden = 1 Then
        Rem
        Rem     ZSql = ""
        Rem     ZSql = ZSql & "UPDATE Orden SET "
        Rem     ZSql = ZSql & " ImpresionII = " + "'" + "N" + "'"
        Rem     ZSql = ZSql & " Where Orden = " + "'" + WOrden + "'"
        Rem     spOrden = ZSql
        Rem     Set rstOrden = db.OpenRecordset(spOrden, dbOpenSnapshot, dbSQLPassThrough)
        Rem
        Rem End If
    ...
    For WWCicla = 1 To LugarII
    
        WOrden = VectorII(WWCicla)
    ...
    For WWCicla = 1 To Lugar
        ...
        ZZTipoOrden = 0
        spOrden = "ConsultaOrden " + "'" + WOrden + "'"
        Set rstOrden = db.OpenRecordset(spOrden, dbOpenSnapshot, dbSQLPassThrough)
        If rstOrden.RecordCount > 0 Then
            ZZTipoOrden = IIf(IsNull(rstOrden!Tipo), "0", rstOrden!Tipo)
            rstOrden.Close
        End If
