...
Begin VB.Form Menu 
   BackColor       =   &H00808080&
   Caption         =   "Sistema de Procesos Varios"
   ClientHeight    =   7815
   ClientLeft      =   2280
   ClientTop       =   780
   ClientWidth     =   7350
   ...
   Begin VB.Menu Maestros 
      ...
      Begin VB.Menu Sedronar 
         Caption         =   "Declaracion Jurada (Sedronar)"
      End
      Begin VB.Menu Sedronarpt 
         Caption         =   "Declaracion Jurada PT (Sedronar)"
      End
      Begin VB.Menu Sedronarnuevo 
         Caption         =   "Declaracion Jurada (Sedronar Nuevo)"
      End
      Begin VB.Menu Sedronarptnuevo 
         Caption         =   "Declaracion Jurada PT (Sedronar Nuevo)"
      End
...
Private Sub Sedronarnuevo_Click()
    PrgSedronarNuevo.Show
End Sub

Private Sub SedronarPt_Click()
    PrgSedronarPt.Show
End Sub

Private Sub Sedronarptnuevo_Click()
    PrgSedronarPtNuevo.Show
End Sub
