...
Begin VB.Form PrgVerificaPedidoConsulta 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0C0C0&
   ...
   End
End
Attribute VB_Name = "PrgVerificaPedidoConsulta"
...
Private Sub cmdClose_Click()
    ...
    End With
    WOrigenPosi = 1
    PrgVerificaPedidoConsulta.Hide
    Unload Me
...
Private Sub Proceso_Click()
            ...
            With rstPedido
                ...
                Do
                    If .EOF = False Then
                        ...
                        Muestra.Col = 2
                        Muestra.Text = IIf(IsNull(rstPedido!Descripcion), "", rstPedido!Descripcion)
                        ...
                        WEstado = IIf(IsNull(rstPedido!proceso2), "0", rstPedido!proceso2)
                        WCantiProceso = IIf(IsNull(rstPedido!CantiProceso), "0", rstPedido!CantiProceso)
                        WObserva = IIf(IsNull(rstPedido!observa), "", rstPedido!observa)
                        ...
                        Select Case WEstado
                            ...
                            Case 2
                                Muestra.Col = 5
                                Muestra.Text = "Produccion"
                            Case 3
                                Muestra.Col = 5
                                Muestra.Text = "Transferencia"
                            Case Else
                        End Select
                        Muestra.Col = 6
                        Muestra.Text = Str$(WCantiProceso)
                        Muestra.Col = 7
                        Muestra.Text = WObserva
    ...
    For Da = 1 To WRenglon
        ...
        If Left$(Terminado, 2) = "DY" Or Left$(Terminado, 2) = "DS" Or Left$(Terminado, 2) = "DQ" Then
            WTipopro = "M"
                Else
            WTipopro = "T"
        End If
...
Private Sub Muestra_DblClick()
    ...
    Select Case WTipopro
        ...
        Case Else
            Renglon = 0
            spPedido = "ListaPedidoTerminado " + "'" + XProducto + "'"
            Set rstPedido = db.OpenRecordset(spPedido, dbOpenSnapshot, dbSQLPassThrough)
            If rstPedido.RecordCount > 0 Then
                With rstPedido
                    .MoveFirst
    ...
    Rem StkPedido.Caption = Pusing("###,###.##", Str$(Val(Muestra.TextMatrix(Muestra.Row, 4))))
    StkPedido.Caption = Pusing("###,###.##", Str$(ZZPedido))
...
Private Sub Stock_Consolidado()
    ...
    If Left$(Termi.Text, 2) = "DY" Or Left$(Termi.Text, 2) = "DS" Or Left$(Termi.Text, 2) = "DQ" Then
        WTipopro = "M"
            Else
        WTipopro = "T"
    End If
            ...
            If rstPedido.RecordCount > 0 Then
                With rstPedido
                    ...
                    Do
                        ...
                        XPed = rstPedido!Cantidad - rstPedido!Facturado
                        If XPed <> 0 Then
                        Rem If Pedido.Text <> rstPedido!Pedido Then
                            Renglon = Renglon + 1
