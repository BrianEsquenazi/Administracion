...
Begin VB.Form PrgAvisoRechaLabo 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaLabo"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreLaboI = " + "'" + ZMarca + "'"
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreLaboI  = " + "'" + WMarcaImpresion + "'"
