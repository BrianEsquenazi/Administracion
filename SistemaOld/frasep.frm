...
Begin VB.Form PrgFraseP 
   AutoRedraw      =   -1  'True
   Caption         =   "Ingreso de Frases P"
   ClientHeight    =   7950
   ClientLeft      =   300
   ClientTop       =   1005
   ClientWidth     =   11430
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "frasep.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "frasep.frx":030A
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "frasep.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "frasep.frx":0A56
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   840
         MouseIcon       =   "frasep.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "frasep.frx":11A2
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1560
         MouseIcon       =   "frasep.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "frasep.frx":18EE
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   2280
         MouseIcon       =   "frasep.frx":1D30
         MousePointer    =   99  'Custom
         Picture         =   "frasep.frx":203A
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   240
         MouseIcon       =   "frasep.frx":247C
         MousePointer    =   99  'Custom
         Picture         =   "frasep.frx":2786
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "frasep.frx":2BC8
      MousePointer    =   99  'Custom
      Picture         =   "frasep.frx":2ED2
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   2040
      MouseIcon       =   "frasep.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "frasep.frx":3A1E
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   360
      MouseIcon       =   "frasep.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "frasep.frx":456A
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   1200
      MouseIcon       =   "frasep.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "frasep.frx":50B6
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   4560
      MouseIcon       =   "frasep.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "frasep.frx":5C02
      ToolTipText     =   "Salida"
      Top             =   3120
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2880
      MouseIcon       =   "frasep.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "frasep.frx":674E
...
Sub Imprime_Datos()
    Sql1 = "Select *"
    Sql2 = " FROM FraseP"
    Sql3 = " Where FraseP.Codigo = " + "'" + Codigo.Text + "'"
    ...
    If rstFraseP.RecordCount > 0 Then
        Descripcion.Text = Trim(rstFraseP!Descripcion)
        DescripcionII.Text = Trim(rstFraseP!DescripcionII)
        DescripcionIII.Text = Trim(rstFraseP!DescripcionIII)
        Observa.Text = Trim(rstFraseP!Observa)
        rstFraseP.Close
    End If
End Sub
...
Private Sub Acepta_Click()
    ...
    Listado.SQLQuery = "SELECT FraseP.Codigo, FraseP.Descripcion " _
                + "From " _
                + DSQ + ".dbo.FraseP FraseP " _
                + "Where " _
                + "FraseP.Codigo >= " + Desde.Text + " AND " _
                + "FraseP.Codigo <= " + Hasta.Text
    
    Listado.Connect = Connect()
    
    Listado.GroupSelectionFormula = "{FraseP.Codigo} in " + Chr$(34) + Desde.Text + Chr$(34) + " to " + Chr$(34) + Hasta.Text + Chr$(34)
...
Private Sub cmdAdd_Click()
    If Codigo.Text <> "" Then
        ...
        ZSql = ""
        ZSql = ZSql + "Select *"
        ZSql = ZSql + " FROM FraseP"
        ZSql = ZSql + " Where FraseP.Codigo = " + "'" + Codigo.Text + "'"
        spFraseP = ZSql
        Set rstFraseP = db.OpenRecordset(spFraseP, dbOpenSnapshot, dbSQLPassThrough)
        If rstFraseP.RecordCount > 0 Then
            rstFraseP.Close
            ZSql = ""
            ZSql = ZSql + "UPDATE FraseP SET "
        ...
        With rstFraseP
            ...
            Do
                If .EOF = False Then
                    ...
                    ZZLugar = ZZLugar + 1
                    ZZVector(ZZLugar, 1) = rstFraseP!Codigo
                    ZZVector(ZZLugar, 2) = rstFraseP!Descripcion
                ...
                With rstFraseP
                    ...
                    Do
                        If .EOF = False Then
                            ...
                            Pantalla.Col = 1
                            Pantalla.Text = rstFraseP!Codigo
                            Pantalla.Col = 2
                            Pantalla.Text = rstFraseP!Descripcion
...
Private Sub Primer_Click()
    ...
    If rstFraseP.RecordCount > 0 Then
        rstFraseP.MoveFirst
        Codigo.Text = rstFraseP!CodigoMenor
        rstFraseP.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
...
Private Sub Ultimo_Click()
    ...
    If rstFraseP.RecordCount > 0 Then
        rstFraseP.MoveLast
        Codigo.Text = rstFraseP!CodigoMayor
        rstFraseP.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
        ...
        Case 0
            ...
            If rstFraseP.RecordCount > 0 Then
                With rstFraseP
                    ...
                    Do
                        If .EOF = False Then
                            Da = Len(rstFraseP!Descripcion) - WEspacios
                            For aa = 1 To Da + 1
                                If Left$(Ayuda.Text, WEspacios) = Mid$(rstFraseP!Descripcion, aa, WEspacios) Then
                                    LugarAyuda = LugarAyuda + 1
                                    Pantalla.Row = LugarAyuda
                                    Pantalla.Col = 1
                                    Pantalla.Text = rstFraseP!Codigo
