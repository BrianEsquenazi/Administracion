...
Begin VB.Form PrgListIbCiudad 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Retenciones de Ingresos Brutos Ciudad de Bs .As."
   ClientHeight    =   4785
   ClientLeft      =   2925
   ClientTop       =   2415
   ClientWidth     =   6705
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "ListIbCiudad.frx":0000
      Left            =   0
      List            =   "ListIbCiudad.frx":0007
      TabIndex        =   3
      Top             =   3240
      Visible         =   0   'False
      Width           =   3255
   ...
   End
End
Attribute VB_Name = "PrgListIbCiudad"
