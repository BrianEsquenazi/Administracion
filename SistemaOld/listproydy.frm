...
Begin VB.Form PrgListProyDy 
   Caption         =   "Listado Proyeccion de Stock"
   ClientHeight    =   7260
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2760
      ItemData        =   "listproydy.frx":0000
      Left            =   120
      List            =   "listproydy.frx":0007
      TabIndex        =   1
      Top             =   4440
      Visible         =   0   'False
      Width           =   7815
   End
End
Attribute VB_Name = "PrgListProyDy"
...
Private Sub Acepta_Click()
    ...
    Mes1 = Val(Mid$(DesdeFecha.Text, 4, 2))
    Mes2 = Val(Mid$(HastaFecha.Text, 4, 2))
    CantiMes = Mes2 - Mes1 + 1
    ...
    If rstEstadistica.RecordCount > 0 Then
        ...
        With rstEstadistica
            ...
            Do
                ...
                If !OrdFecha >= WFechaDesde And !OrdFecha <= WFechaHasta Then
    ...
    Listado.ReportFileName = "WListProyDy.rpt"
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgListProyDy.Caption = "Listado Proyeccion de Stock :  " + !Nombre
        End If
    End With
