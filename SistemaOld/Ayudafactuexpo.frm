...
Begin VB.Form PrgFactuexpo 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   4140
      ItemData        =   "Ayudafactuexpo.frx":0000
      Left            =   360
      List            =   "Ayudafactuexpo.frx":0007
      TabIndex        =   0
      Top             =   2400
      Visible         =   0   'False
      Width           =   6375
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   6495
      Left            =   120
      OleObjectBlob   =   "Ayudafactuexpo.frx":0015
      TabIndex        =   35
      Top             =   1560
      Width           =   7815
   End
        ...
        With rstEstadistica
            ...
            Do
                If .EOF = False Then
                    ...
                    DBGrid1.Col = 1
                    DBGrid1.Text = rstEstadistica!impreterminado
...
Private Sub Impresion_Varios()
    ...
    If rstClientes.RecordCount > 0 Then
        WIdioma = IIf(IsNull(rstCliente!Idioma), "0", rstCliente!Idioma)
        rstClientes.Close
    End If
