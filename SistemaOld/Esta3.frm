...
Begin VB.Form PrgEsta3 
   AutoRedraw      =   -1  'True
   Caption         =   "4.-Listado de Estadisitica de Ventas por Linea y Articulo"
   ClientHeight    =   6825
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
...
Private Sub Acepta_Click()
    ...
    Listado.WindowTitle = "4.-Listado de Estadistica de Ventas por Linea y Articulo"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WEsta3ii.rpt"
