...
Begin VB.Form PrgListProyDwII 
   Caption         =   "Listado de Proyeccion de Ordenes de Compra (DW)"
   ClientHeight    =   8025
   ClientLeft      =   225
   ClientTop       =   405
   ClientWidth     =   11610
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2760
      ItemData        =   "listproydwii.frx":0000
      Left            =   1560
      List            =   "listproydwii.frx":0007
      TabIndex        =   1
      Top             =   4440
      Visible         =   0   'False
      Width           =   7815
   End
End
Attribute VB_Name = "PrgListProyDwII"
...
Private Sub Acepta_Click()
        ...
        If .NoMatch = False Then
            Do
                ...
                For Ciclo = 1 To LugarMes
                    ...
                    If Val(VentaMes(Ciclo, 2)) > VentaMayor Then
    ...
    Listado.WindowTitle = "Listado de Proyeccion de Stock (DW)"
    Listado.WindowTop = 0
    ...
    Desde.Text = UCase(Desde.Text)
    Hasta.Text = UCase(Hasta.Text)
    Listado.ReportFileName = "WListProyDWII.rpt"
    ...
    If Impresora.Value = True Then
        ...
        If Panta.Value = True Then
            Listado.Destination = 0
                Else
            Listado.ReportFileName = "WListProyDWIIEmail.rpt"
            Listado.Destination = 0
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgListProyDwII.Caption = "Listado Proyeccion de Stock (DW) :  " + !Nombre
        End If
    End With
    ...
    Select Case XIndice
        Case 0
            ...
            With rstArticulo
                ...
                Do
                    If .EOF = False Then
                        If Left$(rstArticulo!Codigo, 2) = "DY" Or Left$(rstArticulo!Codigo, 2) = "DW" Or Left$(rstArticulo!Codigo, 2) = "DS" Or Left$(rstArticulo!Codigo, 2) = "DQ" Then
