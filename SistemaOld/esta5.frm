...
Begin VB.Form PrgEsta5 
   AutoRedraw      =   -1  'True
   Caption         =   "6.-Listado de Estadisitica de Ventas por Clientes y Lineas"
   ClientHeight    =   6795
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
...
Private Sub Acepta_Click()
    ...
    Listado.WindowTitle = "6.-Listado de Estadistica de Ventas por Vendedores y Linea"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WEsta5ii.rpt"
