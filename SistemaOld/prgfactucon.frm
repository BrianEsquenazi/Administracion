...
Begin VB.Form PrgFactuCon 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "prgfactucon.frx":0000
      Left            =   6480
      List            =   "prgfactucon.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   4095
      Left            =   120
      OleObjectBlob   =   "prgfactucon.frx":0015
      TabIndex        =   2
      Top             =   1560
      Width           =   11415
   End
            ...
            For iRow = 0 To 9
                ...
                If Cantidad <> 0 Then
                    ...
                    If rstConsig.RecordCount > 0 Then
                        ...
                        Exit Sub
                    End If
                    XLote(DBGrid1.Row, 1) = WLote
                    XLote(DBGrid1.Row, 2) = Cantidad
                End If
        ...
        For A = 0 To 3
            ...
            For iRow = 0 To 9
                ...
                If Cantidad <> 0 Then
                    ...
                    XImpoUs = ""
                    XMarca = ""
                    WLote1 = XLote(Suma - 1, 1)
                    WLote2 = XLote(Suma - 1, 3)
                    Wlote3 = XLote(Suma - 1, 5)
                    WLote4 = XLote(Suma - 1, 7)
                    WLote5 = XLote(Suma - 1, 9)
                    WCanti1 = XLote(Suma - 1, 2)
                    WCanti2 = XLote(Suma - 1, 4)
                    WCanti3 = XLote(Suma - 1, 6)
                    WCanti4 = XLote(Suma - 1, 8)
                    WCanti5 = XLote(Suma - 1, 10)
                    XTipoproDy = "T"
                    XArticuloDy = "  -   -   "
                ...
                Select Case KeyCode
                    Case 13
                        ...
                        If Tipoventa.ListIndex = 0 Then
                            ...
                            If Val(XLote(WRow, 1)) <> 0 Then
                                WLote1.Text = XLote(WRow, 1)
                                WCanti1.Text = XLote(WRow, 2)
                            End If
                            If Val(XLote(WRow, 3)) <> 0 Then
                                WLote2.Text = XLote(WRow, 3)
                                WCanti2.Text = XLote(WRow, 4)
                            End If
                            If Val(XLote(WRow, 5)) <> 0 Then
                                Wlote3.Text = XLote(WRow, 5)
                                WCanti3.Text = XLote(WRow, 6)
                            End If
                            If Val(XLote(WRow, 7)) <> 0 Then
                                WLote4.Text = XLote(WRow, 7)
                                WCanti4.Text = XLote(WRow, 6)
                            End If
                            If Val(XLote(WRow, 9)) <> 0 Then
                                WLote5.Text = XLote(WRow, 9)
                                WCanti5.Text = XLote(WRow, 10)
                            End If
    ...
    If KeyAscii = 13 Then
            ...
            If Val(WLote1.Text) = 0 Then
                ...
                If WEstado = "S" Then
                    ...
                    XLote(WRow, 7) = WLote4.Text
                    XLote(WRow, 8) = WCanti4.Text
                    XLote(WRow, 9) = WLote5.Text
                    XLote(WRow, 10) = WCanti5.Text
                    CargaLote.Visible = False
                    DBGrid1.Col = 5
                    DBGrid1.Text = "S"
...
Sub Impresion()
    ...
    For XX% = 1 To 2
        ...
        If ImporteIb <> 0 Then
            Print #1, " INGRESOS BRUTOS BS.AS.:";
            Print #1, Alinea("#,###.##", Str$(ImporteIb));
        End If
        If ImporteIbTucu <> 0 Then
            Print #1, " INGRESOS BRUTOS TUCUMAN:";
