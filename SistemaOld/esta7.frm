...
Begin VB.Form PrgEsta7 
   AutoRedraw      =   -1  'True
   Caption         =   "8.-Listado de Estadisitica de Ventas por Productos y Clientes"
   ClientHeight    =   6465
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
...
Private Sub Acepta_Click()
    ...
    Sql6 = " and Estadistica.Articulo >= " + "'" + Desde.Text + "'"
    Sql7 = " and Estadistica.Articulo <= " + "'" + Hasta.Text + "'"
    ...
    Listado.WindowTitle = "8.-Listado de Estadistica de Ventas por Articulos y Lineas"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WEsta7ii.rpt"
