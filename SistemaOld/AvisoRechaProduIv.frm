...
Begin VB.Form PrgAvisoRechaProduIV 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaProduIV"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreProdIV = " + "'" + ZMarca + "'"
    ...
    If rstPedidoDevol.RecordCount > 0 Then
        ...
        .MoveFirst
            Do
                If .EOF = False Then
                    If rstPedidoDevol!TipoProII = "CO" Then
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreProdIV  = " + "'" + WMarcaImpresion + "'"
