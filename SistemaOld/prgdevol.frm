...
Begin VB.Form PrgDevol 
   ...
   Begin VB.ComboBox ReteIb 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "prgdevol.frx":0000
      Left            =   8040
      List            =   "prgdevol.frx":0002
      TabIndex        =   53
      Top             =   840
      Width           =   3015
   End
   Begin VB.ComboBox Planta 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "prgdevol.frx":0004
      Left            =   8040
      List            =   "prgdevol.frx":0006
      TabIndex        =   50
      Top             =   120
      Width           =   3015
   End
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "prgdevol.frx":0008
      TabIndex        =   3
      Top             =   1200
      Width           =   10335
   End
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1620
      ItemData        =   "prgdevol.frx":09E6
      Left            =   120
      List            =   "prgdevol.frx":09ED
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6135
            ...
            If Cantidad <> 0 Or Entrada <> 0 Then
                ...
                If WAdicional > 0 Then
                    ...
                    With rstEsta8
                        ...
                        !Importe = Precio * Cantidad * Val(Paridad.Text) * WAdicional * -1
                        !ImporteUs = Precio * Cantidad * WAdicional * -1
                        !Cliente = Cliente.Text
                        !Paridad = Val(Paridad.Text)
                        !vendedor = WVendedor
                        !Rubro = WRubro
