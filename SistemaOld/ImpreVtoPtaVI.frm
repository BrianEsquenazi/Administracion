...
Begin VB.Form PrgImpreVtoPtaVI 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgImpreVtoPtaVI"
...
Private Sub Acepta_Click()
    ...
    For ZZZCiclo = 1 To 2
        ...
        ZSql = ZSql + " Where VerificaVtoArti.ImpreVI = " + "'" + "N" + "'"
