...
Begin VB.Form PrgEntTer 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Entrada de Productos Terminados"
   ClientHeight    =   7095
   ClientLeft      =   630
   ClientTop       =   1140
   ClientWidth     =   11070
   ...
   Begin VB.ListBox Pantalla 
      Height          =   5910
      ItemData        =   "EntTer.frx":09F2
      Left            =   6960
      List            =   "EntTer.frx":09F9
      TabIndex        =   0
      Top             =   120
      Visible         =   0   'False
      Width           =   3975
