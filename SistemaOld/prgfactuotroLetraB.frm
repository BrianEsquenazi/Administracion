...
Begin VB.Form PrgFactuLetraB 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Facturacion ""B"" de Pedidos en U$S"
   ClientHeight    =   8340
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   11550
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "prgfactuotroLetraB.frx":0000
      Left            =   4200
      List            =   "prgfactuotroLetraB.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "prgfactuotroLetraB.frx":0015
      TabIndex        =   2
      Top             =   1680
      Width           =   11415
   End
   ...
   End
End
Attribute VB_Name = "PrgFactuLetraB"
...
Sub ImpresionFe()
    ...
    For a = 0 To 3
        ...
        For iRow = 0 To 9
            ...
            DBGrid1.Col = 3
            XPrecio = Val(Alinea("##,###.##", DBGrid1.Text)) * 1.21
...
Private Sub Calcula_Cae()
    ...
    Rem dada1.Text = Str$(imp_total)
    Rem dada2.Text = Str$(imp_neto)
    Rem dada3.Text = Str$(imp_iva)
    Rem dada4.Text = Str$(imp_trib)
    
    Rem dadadada.Visible = True
