...
Begin VB.Form PrgProveAdicionalParte1 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   3840
      MouseIcon       =   "proveadicionalparte1.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "proveadicionalparte1.frx":030A
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   5400
      MouseIcon       =   "proveadicionalparte1.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "proveadicionalparte1.frx":0E56
      ToolTipText     =   "Salida"
      Top             =   2400
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "PrgProveAdicionalParte1"
...
Sub Imprime_Datos()
    ...
    If rstProveedorAdicional.RecordCount > 0 Then
        ...
        Descri14.Text = Trim(rstProveedorAdicional!Descri14)
