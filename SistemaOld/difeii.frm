...
Begin VB.Form PrgDifeII 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Diferencias de Cambio (Depositos)"
   ClientHeight    =   4785
   ClientLeft      =   2925
   ClientTop       =   2415
   ClientWidth     =   6240
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "difeii.frx":0000
      Left            =   0
      List            =   "difeii.frx":0007
      TabIndex        =   3
      Top             =   3240
      Visible         =   0   'False
      Width           =   3255
...
Private Sub Acepta_Click()
    ...
    Listado.SQLQuery = "SELECT Recibos.Recibo, Recibos.Fechaord, Recibos.Numero1, Recibos.Importe1, Recibos.Tipo2, Recibos.Numero2, Recibos.Fecha2, Recibos.banco2, Recibos.Importe2, Recibos.Impolist, Recibos.Impo1list, Recibos.Marca, Recibos.FechaDepoOrd, " _
                    + "Cliente.Razon, " _
                    + "Cambios.Cambio " _
                    + "From " _
                    + DSQ + ".dbo.Recibos Recibos, " _
                    + DSQ + ".dbo.Cliente Cliente, " _
                    + DSQ + ".dbo.Cambios Cambios " _
                    + "Where " _
                    + "Recibos.Cliente = Cliente.Cliente AND " _
                    + "Recibos.Fecha = Cambios.Fecha AND " _
                    + "Recibos.Marca = 'X' AND " _
                    + "Recibos.FechaDepoOrd >= '00000000' AND " _
                    + "Recibos.FechaDepoOrd <= '99999999'"
