...
Begin VB.Form PrgSalMat 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Salidas de Materias Primas (Stock)"
   ClientHeight    =   8175
   ClientLeft      =   210
   ClientTop       =   555
   ClientWidth     =   11910
   ...
   Begin VB.ListBox Pantalla 
      Height          =   3960
      ItemData        =   "SalMat.frx":09EA
      Left            =   6960
      List            =   "SalMat.frx":09F1
      TabIndex        =   0
      Top             =   1800
      Visible         =   0   'False
      Width           =   4575
