...
Begin VB.Form PrgImpreped25000Otro 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgImpreped25000Otro"
...
Private Sub Acepta_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "Select Pedido, Fecha, Cliente, FecEntrega, TipoPed, Autorizo, Impresion, Cantidad, Facturado, Precio, Impresion3, Terminado, Proceso1, TipoPedido"
    ZSql = ZSql + " FROM Pedido"
    ZSql = ZSql + " Where Pedido.ImpresionIV = " + "'" + "N" + "'"
