...
Begin VB.Form PrgListinf 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2595
      ItemData        =   "listinf.frx":0000
      Left            =   120
      List            =   "listinf.frx":0007
      TabIndex        =   1
      Top             =   4080
      Visible         =   0   'False
      Width           =   7815
...
Private Sub Acepta_Click()
    ...
    For Ciclo = 1 To Lugar
        ...
        If rstOrden.RecordCount > 0 Then
            ...
            Rem WFechaImpo = IIf(IsNull(rstOrden!FechaImpo), "", rstOrden!FechaImpo)
            Rem WOrdFechaImpo = IIf(IsNull(rstOrden!OrdFechaImpo), "", rstOrden!OrdFechaImpo)
            Rem
            Rem If Val(WOrdFechaImpo) <> 0 Then
            Rem     XOrdFecha = WOrdFechaImpo
            Rem     XFecha = WFechaImpo
            Rem End If
    ...
    Listado.WindowTitle = "Listado de Informe de Recepcion"
    Listado.WindowTop = 0
    ...
    If Tipo.ListIndex = 0 Then
        ...
        Uno = "{Informe.fechaord} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
        Dos = " and {Informe.Orden} in 0 to 799999"
        ...
        Listado.SQLQuery = "SELECT Informe.Informe, Informe.Fecha, Informe.Remito, Informe.Proveedor, Informe.Orden, Informe.Articulo, Informe.Cantidad, Informe.Fechaord, Informe.FechaOrden, Informe.Difefecha, " _
                    ...
                    + "Informe.Orden >= 0 AND Informe.Orden <= 799999 AND " _
        ...
        Listado.ReportFileName = "WListinf.rpt"
        
            Else
    
        Uno = "{Informe.fechaord} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
        Dos = " and {Informe.Orden} in 800000 to 999999"
        Listado.GroupSelectionFormula = Uno + Dos
        Listado.SelectionFormula = Uno + Dos
        ...
        Listado.SQLQuery = "SELECT Informe.Informe, Informe.Fecha, Informe.Remito, Informe.Proveedor, Informe.Orden, Informe.Articulo, Informe.Cantidad, Informe.Fechaord, Informe.FechaOrden, Informe.Difefecha, " _
                    ...
                    + "Where " _
                    + "Informe.Articulo = Articulo.Codigo AND Informe.Proveedor = Proveedor.Proveedor AND " _
                    + "Informe.Orden >= 800000 AND Informe.Orden <= 999999 AND " _
                    + "Informe.Proveedor >= '" + DesdeProv.Text + "' AND Informe.Proveedor <= '" + HastaProv.Text + "' AND " _
                    + "Informe.Fechaord >= '" + WDesde + "' AND Informe.Fechaord <= '" + WHasta + "'"
        ...
        Listado.ReportFileName = "WListinfEnvase.rpt"
...
Sub Form_Load()
    ...
    Tipo.AddItem "Materia Prima"
    Tipo.AddItem "Envases"
    ...
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgListinf.Caption = "Listado de Informe de Recepcion :  " + !Nombre
        End If
    End With
    Desde.Text = "  /  /    "
    Hasta.Text = "  /  /    "
