...
Private Sub Proceso()
    ...
    With rstWEnsayos
            ...
            Do
                ...
                If rstEnsayo.RecordCount > 0 Then
                    ...
                    Set rstEnsayo = db.OpenRecordset("ModificaEnsayos " + XParam, dbOpenSnapshot, dbSQLPassThrough)
                    ...
                    Set rstEnsayo = db.OpenRecordset("AltaEnsayos " + XParam, dbOpenSnapshot, dbSQLPassThrough)
    ...
    With rstWEspecif
            ...
            Do
                ...
                WProducto = !Producto
                WEnsayo1 = Str$(!Ensayo1)
                WEnsayo2 = Str$(!Ensayo2)
                WEnsayo3 = Str$(!Ensayo3)
                WEnsayo4 = Str$(!Ensayo4)
                WEnsayo5 = Str$(!Ensayo5)
                WEnsayo6 = Str$(!Ensayo6)
                WEnsayo7 = Str$(!Ensayo7)
                WEnsayo8 = Str$(!Ensayo8)
                WEnsayo9 = Str$(!Ensayo9)
                WEnsayo10 = Str$(!Ensayo10)
                WValor1 = !Valor1
                Wvalor2 = !valor2
                WValor3 = !Valor3
                Wvalor4 = !valor4
                ...
                If rstEspecif.RecordCount > 0 Then
                    ...
                    XParam = "'" + WProducto + "','" _
                        ...
                        + Wvalor10 + "','" _
                        + WDate + "'"
                    Set rstEspecif = db.OpenRecordset("ModificaEspecif" + XParam, dbOpenSnapshot, dbSQLPassThrough)
                    ...
                    XParam = "'" + WProducto + "','" _
                        ...
                        + Wvalor10 + "','" _
                        + WDate + "'"
                    Set rstEspecif = db.OpenRecordset("AltaEspecif " + XParam, dbOpenSnapshot, dbSQLPassThrough)
                End If
    ...
    With rstWEspecificaciones
            ...
            Do
                ...
                spEspecificaciones = "ConsultaEspecificaciones " + "'" + WProducto + "'"
   ...
   Rem Desfripcion de comprobantes
    ...
    With rstWDescComp
            ...
            Do
                ...
                spDesccomp = "ConsultaDescComp " + "'" + WClave + "'"
                ...
                If rstDesccomp.RecordCount > 0 Then
                    ...
                    Rem spDesccomp = "ModificaDesccomp " + XParam
