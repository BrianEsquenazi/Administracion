...
Begin VB.Form PrgFactuproforma 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "PrgfactuProforma.frx":0000
      Left            =   6480
      List            =   "PrgfactuProforma.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   4095
      Left            =   120
      OleObjectBlob   =   "PrgfactuProforma.frx":0015
      TabIndex        =   2
      Top             =   1560
      Width           =   11415
   End
   ...
   End
End
Attribute VB_Name = "PrgFactuproforma"
...
Private Sub Graba_Click()
        ...
        Rem     XParam = "'" + WClave + "','" _
        rem             + WTipo + "','" + WNumero + "','" _
        rem             + WRenglon + "','" + WCliente + "','" _
        rem             + WFecha + "','" + WEstado + "','" _
        rem             + Wvencimiento + "','" + WVencimiento1 + "','" _
        rem             + XTotal + "','" + XTotalUs + "','" _
        rem            + XSaldo + "','" + XSaldoUs + "','" _
        rem             + WOrdFecha + "','" + WOrdVencimiento + "','" _
        rem             + WOrdVencimiento1 + "','" + WImpre + "','" _
        rem             + WEmpresa + "','" _
        rem             + XNet + "','" + XIva1 + "','" _
        rem             + XIva2 + "','" + WPedido + "','" _
        rem             + WRemito + "','" + WOrden + "','" _
        rem             + WParidad + "','" + WProvincia + "','" _
        rem             + XVendedor + "','" + XRubro + "','" _
        rem             + WComprobante + "','" + WAceptada + "','" _
        rem             + WCosto + "','" _
        rem             + WImporte1 + "','" + WImporte2 + "','" _
        rem             + WImporte3 + "','" + WImporte4 + "','" _
        rem             + WImporte5 + "','" + WImporte6 + "','" _
        rem             + WImporte7 + "','" _
        rem             + WDate + "','" _
        rem             + XSeguro + "','" _
        rem             + XFlete + "'"
        Rem
        Rem     spCtacte = "AltaCtacte " + XParam
...
Sub Impresion()
        ...
        If Val(WEmpresa) = 1 Then
            Open "LPT1" For Output As #99
                Else
            If Val(WEmpresa) = 9 Then
                Open "dada.txt" For Output As #99
                    Else
                Rem Open "dada.txt" For Output As #99
                Open "LPT1" For Output As #99
            End If
        End If
...
Sub Impresion_Remito()
        ...
        Print #1, ""
        Print #1, Tab(10); "Lugar de Pago : Paraguay 1539 Piso 6 Capital Federal"
        Print #1, ""
