VERSION 5.00
Begin VB.Form frmLoginInversion 
   ...
   End
End
Attribute VB_Name = "frmLoginInversion"
...
Private Sub cmdOK_Click()
    ...
    If rstoperador.RecordCount > 0 Then
        ...
        WClaveOperador = IIf(IsNull(rstoperador!Clave), " ", rstoperador!Clave)
        WEntra = IIf(IsNull(rstoperador!Inversion), " ", rstoperador!Inversion)
      Rem  WEntra = "S"
        rstoperador.Close
        If WEntra = "S" Then
            Unload frmLoginInversion
            Menu.Show
        End If
    End If
