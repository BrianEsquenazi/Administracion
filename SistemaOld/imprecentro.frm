...
Begin VB.Form PrgImpreCentro 
   ...
   End
End
Attribute VB_Name = "PrgImpreCentro"
...
Private Sub Acepta_Click()
    ...
    Sql2 = " FROM Pedido"
    Sql3 = " Where (Pedido.Proceso1 = 1 OR Pedido.Proceso1 = 2)"
...
Private Sub Imprime_Click()
    ...
    Rem Lugar = 1
    Rem Vector(Lugar, 1) = 292755
    Rem Vector(Lugar, 2) = 1
    Rem Vector(Lugar, 3) = 5
        ...
        With rstPedido
            ...
            Do
                If .EOF = False Then
                    ...
                    Datos(Renglon, 4) = IIf(IsNull(rstPedido!Especificaciones), "", rstPedido!Especificaciones)
...
Private Sub ImpresionIIIAnterior()
