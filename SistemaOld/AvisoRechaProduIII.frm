...
Begin VB.Form PrgAvisoRechaProduIII 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaProduIII"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreProdIII = " + "'" + ZMarca + "'"
    ...
    If rstPedidoDevol.RecordCount > 0 Then
        ...
        .MoveFirst
            Do
                If .EOF = False Then
                    If rstPedidoDevol!TipoProII = "FA" Then
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreProdIII  = " + "'" + WMarcaImpresion + "'"
