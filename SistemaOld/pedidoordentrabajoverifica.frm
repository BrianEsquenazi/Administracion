...
Begin VB.Form PrgpedidoOrdenTrabajoverifica 
   Caption         =   "Ingreso de Destino para los Pedidos de Desarrollos"
   ClientHeight    =   8085
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   11625
   ...
   Begin RichTextLib.RichTextBox Agenda 
      ...
      RightMargin     =   8900
      AutoVerbMenu    =   -1  'True
      TextRTF         =   $"pedidoordentrabajoverifica.frx":0000
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabPicture(0)   =   "pedidoordentrabajoverifica.frx":007C
      ...
      TabPicture(1)   =   "pedidoordentrabajoverifica.frx":0098
      ...
      TabPicture(2)   =   "pedidoordentrabajoverifica.frx":00B4
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "pedidoordentrabajoverifica.frx":00D0
      Left            =   240
      List            =   "pedidoordentrabajoverifica.frx":00D7
      TabIndex        =   41
      Top             =   5160
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   6360
      MouseIcon       =   "pedidoordentrabajoverifica.frx":00E5
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoverifica.frx":03EF
      ToolTipText     =   "Salida"
      Top             =   7440
      Width           =   480
   End
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   5160
      MouseIcon       =   "pedidoordentrabajoverifica.frx":0C31
      MousePointer    =   99  'Custom
      Picture         =   "pedidoordentrabajoverifica.frx":0F3B
   ...
   End
End
Attribute VB_Name = "PrgpedidoOrdenTrabajoverifica"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim rsOrdenTrabajo As Recordset
...
Private Sub cmdAdd_Click()
    ...
    If Val(Pedido.Text) <> 0 Then
        ...
        If Destino.ListIndex = 1 Then
            If CodigoOrden = "  -     " Then
                aa% = MsgBox("Se debe informar el codigo de desarrollo", 0, "Pedidos de Desarrollos")
                Exit Sub
            End If
            ...
            ZSql = ZSql + " Where OrdenTrabajo.Orden = " + "'" + CodigoOrden.Text + "'"
            spOrdenTrabajo = ZSql
            ...
            If rstOrdenTrabajo.RecordCount > 0 Then
                ...
                aa% = MsgBox("Codigo de desarrollo ya existente", 0, "Pedidos de Desarrollos")
                Exit Sub
            End If
        ...
        If Destino.ListIndex = 1 Then
            ...
            ZSql = ZSql + "'" + ZAplicacion + "',"
            ZSql = ZSql + "'" + ZEstabilidad + "',"
...
Private Sub CmdClose_Click()
    PrgpedidoOrdenTrabajoverifica.Hide
    Unload Me
