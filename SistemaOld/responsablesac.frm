...
Begin VB.Form PrgResponsableSac 
   AutoRedraw      =   -1  'True
   Caption         =   "Ingreso de Responsable"
   ClientHeight    =   6495
   ClientLeft      =   300
   ClientTop       =   1005
   ClientWidth     =   11430
   ...
   ScaleHeight     =   6495
   ScaleWidth      =   11430
   Begin VB.TextBox ClaveSeguridad 
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "responsablesac.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "responsablesac.frx":030A
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   4320
         MouseIcon       =   "responsablesac.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "responsablesac.frx":0A56
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   840
         MouseIcon       =   "responsablesac.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "responsablesac.frx":11A2
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1560
         MouseIcon       =   "responsablesac.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "responsablesac.frx":18EE
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   2280
         MouseIcon       =   "responsablesac.frx":1D30
         MousePointer    =   99  'Custom
         Picture         =   "responsablesac.frx":203A
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   240
         MouseIcon       =   "responsablesac.frx":247C
         MousePointer    =   99  'Custom
         Picture         =   "responsablesac.frx":2786
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "ResponsableSac.rpt"
      Destination     =   1
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3720
      MouseIcon       =   "responsablesac.frx":2BC8
      MousePointer    =   99  'Custom
      Picture         =   "responsablesac.frx":2ED2
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   2040
      MouseIcon       =   "responsablesac.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "responsablesac.frx":3A1E
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   360
      MouseIcon       =   "responsablesac.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "responsablesac.frx":456A
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   1200
      MouseIcon       =   "responsablesac.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "responsablesac.frx":50B6
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   4560
      MouseIcon       =   "responsablesac.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "responsablesac.frx":5C02
      ToolTipText     =   "Salida"
      Top             =   2040
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2880
      MouseIcon       =   "responsablesac.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "responsablesac.frx":674E
   ...
   End
End
Attribute VB_Name = "PrgResponsableSac"
...
Sub Imprime_Datos()
    ...
    Sql3 = " Where ResponsableSac.Codigo = " + "'" + Codigo.Text + "'"
    ...
    If rstResponsableSac.RecordCount > 0 Then
        Descripcion.Text = Trim(rstResponsableSac!Descripcion)
        ClaveSeguridad.Text = Trim(rstResponsableSac!ClaveSeguridad)
        Email.Text = Trim(rstResponsableSac!Email)
...
Private Sub Acepta_Click()
    ...
    Listado.SQLQuery = "SELECT ResponsableSac.Codigo, ResponsableSac.Descripcion " _
                + "From " _
                + DSQ + ".dbo.ResponsableSac ResponsableSac " _
                + "Where " _
                + "ResponsableSac.Codigo >= " + Desde.Text + " AND " _
                + "ResponsableSac.Codigo <= " + Hasta.Text
    
    Listado.Connect = Connect()
    
    Listado.GroupSelectionFormula = "{ResponsableSac.Codigo} in " + Desde.Text + " to " + Hasta.Text
    Listado.SelectionFormula = "{ResponsableSac.Codigo} in " + Desde.Text + " to " + Hasta.Text
...
Private Sub cmdAdd_Click()
    If Val(Codigo.Text) <> 0 Then
        ...
        ZSql = ZSql + " Where ResponsableSac.Codigo = " + "'" + Codigo.Text + "'"
        spResponsableSac = ZSql
        Set rstResponsableSac = db.OpenRecordset(spResponsableSac, dbOpenSnapshot, dbSQLPassThrough)
        If rstResponsableSac.RecordCount > 0 Then
            rstResponsableSac.Close
            ZSql = ""
            ZSql = ZSql + "UPDATE ResponsableSac SET "
            ZSql = ZSql + " Descripcion = " + "'" + Descripcion.Text + "',"
            ZSql = ZSql + " ClaveSeguridad = " + "'" + ClaveSeguridad.Text + "',"
            ...
            Set rstResponsableSac = db.OpenRecordset(spResponsableSac, dbOpenSnapshot, dbSQLPassThrough)
                Else
            ZSql = ""
            ZSql = ZSql + "INSERT INTO ResponsableSac ("
            ZSql = ZSql + "Codigo ,"
            ZSql = ZSql + "Descripcion ,"
            ZSql = ZSql + "ClaveSeguridad ,"
            ZSql = ZSql + "Email )"
            ZSql = ZSql + "Values ("
            ZSql = ZSql + "'" + Codigo.Text + "',"
            ZSql = ZSql + "'" + Descripcion.Text + "',"
            ZSql = ZSql + "'" + ClaveSeguridad.Text + "',"
...
Private Sub cmdDelete_Click()
    ...
    If Val(Codigo.Text) <> 0 Then
        ...
        If rstResponsableSac.RecordCount > 0 Then
            ...
            If Respuesta% = 6 Then
                Sql1 = "DELETE ResponsableSac"
                Sql2 = " Where Codigo = " + "'" + Codigo.Text + "'"
                spResponsableSac = Sql1 + Sql2
                Set rstResponsableSac = db.OpenRecordset(spResponsableSac, dbOpenSnapshot, dbSQLPassThrough)
                Call CmdLimpiar_Click
            End If
        End If
...
Private Sub CmdLimpiar_Click()
    ...
    Set rstResponsableSac = db.OpenRecordset(spResponsableSac, dbOpenSnapshot, dbSQLPassThrough)
    If rstResponsableSac.RecordCount > 0 Then
        rstResponsableSac.MoveLast
        ZCodigo = IIf(IsNull(rstResponsableSac!CodigoMayor), "0", rstResponsableSac!CodigoMayor)
...
Private Sub Anterior_Click()
    ...
    If rstResponsableSac.RecordCount > 0 Then
        With rstResponsableSac
            .MoveLast
            Codigo.Text = rstResponsableSac!Codigo
        End With
        rstResponsableSac.Close
        Call Imprime_Datos
        Codigo.SetFocus
        ...
        A% = MsgBox(m$, 0, "Archivo de Responsables")
    End If
End Sub
...
Private Sub ClaveSeguridad_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub Primer_Click()
    ...
    Set rstResponsableSac = db.OpenRecordset(spResponsableSac, dbOpenSnapshot, dbSQLPassThrough)
    If rstResponsableSac.RecordCount > 0 Then
        rstResponsableSac.MoveFirst
        Codigo.Text = rstResponsableSac!CodigoMenor
        rstResponsableSac.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
...
Private Sub Ultimo_Click()
    ...
    If rstResponsableSac.RecordCount > 0 Then
        rstResponsableSac.MoveLast
        Codigo.Text = rstResponsableSac!CodigoMayor
        rstResponsableSac.Close
        Call Imprime_Datos
        Codigo.SetFocus
    End If
