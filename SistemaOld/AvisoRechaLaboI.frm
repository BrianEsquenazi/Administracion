...
Begin VB.Form PrgAvisoRechaLaboI 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaLaboI"
...
Private Sub Acepta_Click()
    ...
    If rstPedidoDevol.RecordCount > 0 Then
        ...
        .MoveFirst
            Do
                If .EOF = False Then
                    If rstPedidoDevol!TipoProII = "CO" Or rstPedidoDevol!TipoProII = "PG" Then
