...
Begin VB.Form PrgDevolSalva 
   ...
   Begin VB.ComboBox ReteIb 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "prgdevolsalva.frx":0000
      Left            =   8040
      List            =   "prgdevolsalva.frx":0002
      TabIndex        =   53
      Top             =   840
      Width           =   3015
   End
   Begin VB.ComboBox Planta 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "prgdevolsalva.frx":0004
      Left            =   8040
      List            =   "prgdevolsalva.frx":0006
      TabIndex        =   50
      Top             =   120
      Width           =   3015
   End
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "prgdevolsalva.frx":0008
      TabIndex        =   3
      Top             =   1200
      Width           =   10335
   End
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1620
      ItemData        =   "prgdevolsalva.frx":09E6
      Left            =   120
      List            =   "prgdevolsalva.frx":09ED
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6135
   ...
   End
End
Attribute VB_Name = "PrgDevolSalva"
...
Private Sub Graba_Click()
    ...
    If WAdicional > 0 Then
        ...
        With rstCtacte8
            ...
            !Vencimiento1 = "  /  /    "
            Call Convierte_datos(Str$(Total), Auxi)
            !Total = (WNeto * WAdicional) * Val(Paridad.Text) * -1
            !Totalus = (WNeto * WAdicional) * -1
            !Saldo = (WNeto * WAdicional) * Val(Paridad.Text) * -1
            !Saldous = (WNeto * WAdicional) * -1
            !OrdFecha = Right$(Fecha.Text, 4) + Mid$(Fecha.Text, 4, 2) + Left$(Fecha.Text, 2)
            !OrdVencimiento = "00000000"
            !OrdVencimiento1 = "00000000"
            !Impre = "DV"
            !Neto = (WNeto * WAdicional) * Val(Paridad.Text) * -1
            !Iva1 = 0
            !Iva2 = 0
            !Pedido = 0
            !Remito = 0
        ...
        With rstEstadistica
            ...
            Do
                If .EOF = False Then
                    ...
                    dada = rstEstadistica!Cantidad
                    DBGrid1.Col = 2
                    DBGrid1.Text = Pusing("###,###.##", Str$(dada))
                
                    dada = rstEstadistica!PrecioUs
                    DBGrid1.Col = 3
                    DBGrid1.Text = Pusing("###,###.##", Str$(dada))
