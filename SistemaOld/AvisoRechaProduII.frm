...
Begin VB.Form PrgAvisoRechaProduII 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaProduII"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreProdII = " + "'" + ZMarca + "'"
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreProdII  = " + "'" + WMarcaImpresion + "'"
