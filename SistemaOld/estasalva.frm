...
Begin VB.Form PrgEstasalva 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Estadisitica de Ventas por Clientes y Lineas"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "estasalva.frx":0000
      Left            =   840
      List            =   "estasalva.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
   ...
   End
End
Attribute VB_Name = "PrgEstasalva"
...
Private Sub Acepta_Click()
    ...
    Sql1 = "Select *, Cliente.Razon as [WDesCliente]"
    ...
    Sql6 = " and Estadistica.Cliente >= " + "'" + Desde.Text + "'"
    Sql7 = " and Estadistica.Cliente <= " + "'" + Hasta.Text + "'"
    ...
    If rstEstadistica.RecordCount > 0 Then
        ...
        With rstEstadistica
            ...
            Do
                ...
                If Left$(rstEstadistica!Articulo, 2) = "DW" Then
    ...
    With rstEsta
        ...
        If .NoMatch = False Then
            Do
                ...
                If Left$(WArticulo, 2) <> "PT" And Left$(WArticulo, 2) <> "PE" Then
                    WTipopro = "M"
                        Else
                    WTipopro = "T"
                End If
                ...
                Select Case WTipopro
                    ...
                    Case Else
                        ...
                        If rstPrecios.RecordCount > 0 Then
                            WDescriRubro = rstPrecios!Descripcion
                            rstPrecios.Close
                        End If
    ...
    Listado.WindowTitle = "Listado de Estadistica de Ventas por Vendedores y Linea"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WEstasalva.rpt"
