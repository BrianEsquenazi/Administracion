...
Begin VB.Form Prgmodhojady 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "modhojady.frx":007C
      Left            =   3360
      List            =   "modhojady.frx":0083
      TabIndex        =   7
      Top             =   6480
      Visible         =   0   'False
      Width           =   8415
   ...
   End
End
Attribute VB_Name = "Prgmodhojady"
...
Private Sub ConfirmaResultado_Click()
    ...
    If Resultado.Text <> "DW" Then
        If Resultado.Text <> "NW" Then
            ca% = MsgBox("El resultado debe ser DY o DW", 0, "Ingreso de Hoja de Produccion")
            Exit Sub
        End If
    End If
...
Private Sub Graba_Click()
    ...
    If Left$(Producto.Text, 2) = "PT" Or Left$(Producto.Text, 2) = "SE" Or Left$(Producto.Text, 2) = "DW" Then
        If Val(WEmpresa) = 1 Or Val(WEmpresa) = 2 Or Val(WEmpresa) = 3 Or Val(WEmpresa) = 4 Or Val(WEmpresa) = 10 Then
