...
Begin VB.Form PrgFactuRemitoActualiza 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "prgfacturemitoactualiza.frx":0000
      Left            =   4200
      List            =   "prgfacturemitoactualiza.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "prgfacturemitoactualiza.frx":0015
      TabIndex        =   2
      Top             =   1680
      Width           =   11415
   End
   ...
   End
End
Attribute VB_Name = "PrgFactuRemitoActualiza"
    ...
    For a = 0 To 3
        ...
        For iRow = 0 To 9
            ...
            If ZZCantidad <> 0 Then
                ...
                ZSql = ZSql + " Fecha = " + "'" + XFecha + "',"
                ZSql = ZSql + " OrdFecha = " + "'" + XOrdFecha + "',"
