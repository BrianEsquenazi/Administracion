...
Begin VB.Form PrgEvaluaEnsayosAnterior 
   AutoRedraw      =   -1  'True
   Caption         =   "Ingreso de Evaluacion de Proveedores de Ensayos"
   ClientHeight    =   8250
   ClientLeft      =   285
   ClientTop       =   300
   ClientWidth     =   11430
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Anterior 
         Height          =   480
         Left            =   840
         MouseIcon       =   "EvaluaEnsayosAnterior.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "EvaluaEnsayosAnterior.frx":030A
      ...
      Begin VB.Image Siguiente 
         Height          =   480
         Left            =   1560
         MouseIcon       =   "EvaluaEnsayosAnterior.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "EvaluaEnsayosAnterior.frx":0A56
      ...
      Begin VB.Image Ultimo 
         Height          =   480
         Left            =   2280
         MouseIcon       =   "EvaluaEnsayosAnterior.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "EvaluaEnsayosAnterior.frx":11A2
      ...
      Begin VB.Image Primer 
         Height          =   480
         Left            =   240
         MouseIcon       =   "EvaluaEnsayosAnterior.frx":15E4
         MousePointer    =   99  'Custom
         Picture         =   "EvaluaEnsayosAnterior.frx":18EE
   ...
   Begin VB.Label Parametro 
      Caption         =   "Entrega Certif. , Presenta evidencias de Trazabilidad e  Idoneida Tecnica"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
   Begin VB.Label Parametro 
      Caption         =   "Ausencia de datos anomalos o incopatibles con la muestra"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
   Begin VB.Label Parametro 
      Caption         =   "El proveedor respeta los lineamientos de Surfactan"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
   Begin VB.Label Parametro 
      Caption         =   "Confiabilidad de los Datos"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Lista 
      Height          =   480
      Left            =   3600
      MouseIcon       =   "EvaluaEnsayosAnterior.frx":1D30
      MousePointer    =   99  'Custom
      Picture         =   "EvaluaEnsayosAnterior.frx":203A
   ...
   Begin VB.Image CmdLimpiar 
      Height          =   480
      Left            =   1920
      MouseIcon       =   "EvaluaEnsayosAnterior.frx":287C
      MousePointer    =   99  'Custom
      Picture         =   "EvaluaEnsayosAnterior.frx":2B86
   ...
   Begin VB.Image CmdAdd 
      Height          =   480
      Left            =   240
      MouseIcon       =   "EvaluaEnsayosAnterior.frx":33C8
      MousePointer    =   99  'Custom
      Picture         =   "EvaluaEnsayosAnterior.frx":36D2
   ...
   Begin VB.Image CmdDelete 
      Height          =   480
      Left            =   1080
      MouseIcon       =   "EvaluaEnsayosAnterior.frx":3F14
      MousePointer    =   99  'Custom
      Picture         =   "EvaluaEnsayosAnterior.frx":421E
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   4440
      MouseIcon       =   "EvaluaEnsayosAnterior.frx":4A60
      MousePointer    =   99  'Custom
      Picture         =   "EvaluaEnsayosAnterior.frx":4D6A
      ToolTipText     =   "Salida"
      Top             =   4680
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   2760
      MouseIcon       =   "EvaluaEnsayosAnterior.frx":55AC
      MousePointer    =   99  'Custom
      Picture         =   "EvaluaEnsayosAnterior.frx":58B6
      ToolTipText     =   "Consulta de Datos"
      Top             =   4680
      Width           =   480
   End
End
Attribute VB_Name = "PrgEvaluaEnsayosAnterior"
...
Private Sub cmdAdd_Click()
    If Val(Proveedor.Text) <> 0 And Val(Mes.Text) <> 0 And Val(Ano.Text) <> 0 Then
        ...
        If Califica1.ListIndex = 0 Or Califica2.ListIndex = 0 Or Califica3.ListIndex = 0 Or Califica4.ListIndex = 0 Then
...
Sub Form_Load()
    ...
    Califica2.AddItem "Parcial"
    Califica2.AddItem "No Cumple"
    Califica2.AddItem "No Aplica"
