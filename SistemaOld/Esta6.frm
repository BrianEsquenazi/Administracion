...
Begin VB.Form PrgEsta6 
   AutoRedraw      =   -1  'True
   Caption         =   "7.-Listado de Estadisitica de Ventas por Vendedor"
   ClientHeight    =   6900
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
...
Dim ZDescriVendedor(1000) As String
...
Private Sub Acepta_Click()
    ...
    Rem Sql1 = "Select *, Vendedor.Nombre as [WDesVendedor], Cliente.Vendedor as [WCodigoVendedor]"
    Rem Sql2 = " FROM Estadistica, Cliente, Vendedor"
    Rem Sql3 = " Where Estadistica.Cliente = Cliente.Cliente"
    Rem Sql4 = " and Cliente.Vendedor = Vendedor.Vendedor"
    Rem Sql5 = " and Estadistica.OrdFecha >= " + "'" + WDesde + "'"
    Rem Sql6 = " and Estadistica.OrdFecha <= " + "'" + Whasta + "'"
    Rem Sql7 = " and Vendedor.Vendedor >= " + "'" + Desde.Text + "'"
    Rem Sql8 = " and Vendedor.Vendedor <= " + "'" + Hasta.Text + "'"
    Rem spEstadistica = Sql1 + Sql2 + Sql3 + Sql4 + Sql5 + Sql6 + Sql7 + Sql8
    ...
    Sql6 = " and Cliente.Vendedor >= " + "'" + Desde.Text + "'"
    Sql7 = " and Cliente.Vendedor <= " + "'" + Hasta.Text + "'"
    ...
    If rstEstadistica.RecordCount > 0 Then
        ...
        With rstEstadistica
            ...
            Do
                ...
                Rem If WNumero = 71393 Then Stop
                ...
                WDescriVendedor = ZDescriVendedor(rstEstadistica!WCodigoVendedor)
    ...
    Listado.WindowTitle = "7.-Listado de Estadistica de Ventas por Vendedores y Lineas"
    Listado.WindowTop = 0
    ...
    Listado.ReportFileName = "WEsta6ii.rpt"
