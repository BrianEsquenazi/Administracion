...
Begin VB.Form PrgImpreSoldev 
   ...
   End
End
Attribute VB_Name = "PrgImpreSoldev"
    ...
    With rstPedidoDevol
        ...
        If .NoMatch = False Then
            Do
                ...
                aa = rstPedidoDevol!Impresion
                        
                If WTipoPedido <> "CO" And WTipoPedido <> "PG" And WTipoPedido <> "FA" Then
