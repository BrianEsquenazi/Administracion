...
Begin VB.Form PrgGrupo 
   ...
   Begin VB.Image Graba 
      Height          =   480
      Left            =   8280
      MouseIcon       =   "Grupo.frx":0015
      MousePointer    =   99  'Custom
      Picture         =   "Grupo.frx":031F
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   8280
      MouseIcon       =   "Grupo.frx":0B61
      MousePointer    =   99  'Custom
      Picture         =   "Grupo.frx":0E6B
      ToolTipText     =   "Salida"
      Top             =   4200
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   8280
      MouseIcon       =   "Grupo.frx":16AD
      MousePointer    =   99  'Custom
      Picture         =   "Grupo.frx":19B7
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   8280
      MouseIcon       =   "Grupo.frx":21F9
      MousePointer    =   99  'Custom
      Picture         =   "Grupo.frx":2503
      ToolTipText     =   "Limpia la pantalla"
      Top             =   3240
      Width           =   480
   End
End
Attribute VB_Name = "PrgGrupo"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim rstGrupo As Recordset
Dim spGrupo As String
...
Private Sub Grupo_Keypress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        If rstGrupo.RecordCount > 0 Then
            Descripcion.Text = Trim(rstGrupo!Descripcion)
            rstGrupo.Close
            Call Proceso_Click
            WVector1.TopRow = 1
            WVector1.Col = 1
...
Private Sub Graba_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "DELETE Grupo"
    ZSql = ZSql + " Where Grupo = " + "'" + Grupo.Text + "'"
    rsGrupo = ZSql
    Set rstGrupo = db.OpenRecordset(rsGrupo, dbOpenSnapshot, dbSQLPassThrough)
...
Private Sub Pantalla_Click()
    ...
    Select Case XIndice
        Case 0
            ...
            ZClave = WIndice.List(Indice)
            WTexto1.Visible = False
            WTexto2.Visible = False
            ZSql = ""
            ZSql = ZSql + "Select *"
            ZSql = ZSql + " FROM ResponsableSac"
            ZSql = ZSql + " Where ResponsableSac.Codigo = " + "'" + ZClave + "'"
            spResponsableSac = ZSql
            Set rstResponsableSac = db.OpenRecordset(spResponsableSac, dbOpenSnapshot, dbSQLPassThrough)
            If rstResponsableSac.RecordCount > 0 Then
                WVector1.TextMatrix(WVector1.Row, 1) = rstResponsableSac!Codigo
                WVector1.TextMatrix(WVector1.Row, 2) = rstResponsableSac!Descripcion
                rstResponsableSac.Close
            End If
