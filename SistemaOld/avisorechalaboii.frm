...
Begin VB.Form PrgAvisoRechaLaboII 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Aviso 
      ...
      Begin VB.Label Label1 
         Alignment       =   2  'Center
         Caption         =   "Aviso de Entrada de Productos a Verificar el Estado por Devolucion"
         BeginProperty Font 
            Name            =   "MS Serif"
            Size            =   24
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaLaboII"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreLaboII = " + "'" + ZMarca + "'"
    ...
    If rstPedidoDevol.RecordCount > 0 Then
        ...
        .MoveFirst
            Do
                If .EOF = False Then
                    If rstPedidoDevol!TipoProII <> "CO" And rstPedidoDevol!TipoProII <> "PG" Then
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        Listado.ReportFileName = "AvisoRechaLabo.rpt"
    
        DbConnect = db.Connect
        DSQ = getDatabase(DbConnect)
    
        Listado.GroupSelectionFormula = "{PedidoDevol.Pedido} in " + WCodigo + " to " + WCodigo
        Listado.SQLQuery = "SELECT PedidoDevol.Pedido, PedidoDevol.Cliente, PedidoDevol.Fecha, PedidoDevol.Observaciones, PedidoDevol.Terminado, PedidoDevol.Cantidad, PedidoDevol.ImpreTerminado, PedidoDevol.Partida, PedidoDevol.NroDev, " _
                        + "Cliente.Razon " _
                        + "From " _
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreLaboII  = " + "'" + WMarcaImpresion + "'"
