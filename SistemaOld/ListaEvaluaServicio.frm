...
Begin VB.Form PrgListaEvaluaServicio 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Evaluacion de Proveedores de Servicio"
   ClientHeight    =   6510
   ClientLeft      =   1980
   ClientTop       =   570
   ClientWidth     =   8145
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Consulta 
         Height          =   480
         Left            =   5400
         MouseIcon       =   "ListaEvaluaServicio.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "ListaEvaluaServicio.frx":030A
   ...
   End
End
Attribute VB_Name = "PrgListaEvaluaServicio"
...
Private Sub Acepta_Click()
    ...
    Listado.WindowTitle = "Listado de Evaluacion de Proveedores de Servicio"
    Listado.WindowTop = 0
    ...
    Tres = " and {EvaluaI.Tipo} in " + WDesdeI + " to " + WHastaI
    ...
    Listado.ReportFileName = "ListaEvaluaServicio.rpt"
    
    Listado.SQLQuery = "SELECT EvaluaI.Proveedor, EvaluaI.Mes, EvaluaI.Ano, EvaluaI.Promedio, EvaluaI.Observaciones, EvaluaI.Periodo, EvaluaI.Tipo, EvaluaI.Parametro1, EvaluaI.Parametro2, EvaluaI.Parametro3, EvaluaI.Parametro4, EvaluaI.Parametro5, EvaluaI.Criterio1, EvaluaI.Criterio2, EvaluaI.Criterio3, EvaluaI.Criterio4, EvaluaI.Criterio5, EvaluaI.Califica11, EvaluaI.Califica12, EvaluaI.Califica13, EvaluaI.Califica14, EvaluaI.Califica15, EvaluaI.Califica21, EvaluaI.Califica22, EvaluaI.Califica23, EvaluaI.Califica24, EvaluaI.Califica25, EvaluaI.Califica31, EvaluaI.Califica32, EvaluaI.Califica33, EvaluaI.Califica34, EvaluaI.Califica35, EvaluaI.DesSector1, EvaluaI.DesSector2, EvaluaI.DesSector3, EvaluaI.Sector1, EvaluaI.Sector2, EvaluaI.Sector3, " _
            ...
            + "EvaluaI.Periodo <= '" + WHasta + "' AND " _
            + "EvaluaI.Tipo >= " + WDesdeI + " AND " _
            + "EvaluaI.Tipo <= " + WHastaI
...
Sub Form_Load()
    ...
    Tipo.AddItem "Calibraciones"
    Tipo.AddItem "Ensayos"
    Tipo.AddItem "Mantenimiento"
