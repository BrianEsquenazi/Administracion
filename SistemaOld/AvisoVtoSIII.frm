...
Begin VB.Form PrgAvisoVtoSIII 
   ...
   End
End
Attribute VB_Name = "PrgAvisoVtoSIII"
...
Private Sub Acepta_Click()
    ...
    ZTitulo = "Planta SIII   Fecha : " + Mid$(Date$, 4, 2) + "/" + Left$(Date$, 2) + "/" + Right$(Date$, 4)
