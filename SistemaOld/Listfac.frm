...
Begin VB.Form PrgListfac 
   AutoRedraw      =   -1  'True
   Caption         =   "12.-Listado de Facturas Emitidas"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "Listfac.frx":0000
      Left            =   840
      List            =   "Listfac.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
...
Dim rstAuxiliar As Recordset
Dim spAuxiliar As String
...
Private Sub Acepta_Click()
    ...
    spAuxiliar = "ActualizaAuxiliar " + XParam
    Set rstAuxiliar = db.OpenRecordset(spAuxiliar, dbOpenSnapshot, dbSQLPassThrough)
    
    spEstadistica = "ActualizaEstadistica"
    Set rstEstadistica = db.OpenRecordset(spEstadistica, dbOpenSnapshot, dbSQLPassThrough)
    
    Listado.WindowTitle = "12.-Listado de Facturas Emitidas"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Estadistica.Numero, Estadistica.Articulo, Estadistica.Precio, Estadistica.Importe, Estadistica.Cliente, Estadistica.Fecha, Estadistica.OrdFecha, " _
                        + "Cliente.Razon " _
                        + "From " _
                        ...
                        + "Estadistica.Cliente >= '" + Desde.Text + "' AND Estadistica.Cliente <= '" + Hasta.Text + "' AND " _
                        + "Estadistica.OrdFecha >= '" + WDesde + "' AND Estadistica.OrdFecha <= '" + Whasta + "' "
