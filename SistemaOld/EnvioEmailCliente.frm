VERSION 5.00
Begin VB.Form PrgEnvioEmailCliente 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame IngresaArchivo 
      ...
      Begin VB.Image AceptaFoto 
         Height          =   480
         Left            =   1920
         MouseIcon       =   "EnvioEmailCliente.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "EnvioEmailCliente.frx":030A
   ...
   End
End
Attribute VB_Name = "PrgEnvioEmailCliente"
...
Private Sub EnvioMensaje_Click()
            ...
            If .EOF = False Then
                ...
                If Val(!Provincia) < 24 Then
                    ...
                    If ZZEmail <> "" Then
                        ...
                        ZZProve(ZLugar, 1) = !Proveedor
                        ZZProve(ZLugar, 2) = ZZRazon
                        ZZProve(ZLugar, 3) = ZZEmail
    ...
    For Ciclo = 1 To ZLugar
        ...
        ZZProveedor = ZZProve(Ciclo, 1)
        ZZRazon = ZZProve(Ciclo, 2)
        ZZEmail = ZZProve(Ciclo, 3)
        ZZEmail = Trim(ZZEmail)
        
        ZSql = "Select *"
        ZSql = ZSql + " FROM Ivacomp"
        ZSql = ZSql + " Where Ivacomp.Proveedor = " + "'" + ZZProveedor + "'"
        ZSql = ZSql + " and Ivacomp.OrdFecha >= " + "'" + ZZOrdFecha + "'"
        spIvaComp = ZSql
