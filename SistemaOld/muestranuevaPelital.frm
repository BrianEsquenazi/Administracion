...
Begin VB.Form PrgMuestraNueva 
   ...
   Begin VB.ListBox pantalla 
      ...
      EndProperty
      Height          =   2700
      ItemData        =   "muestranuevaPelital.frx":0000
      Left            =   120
      List            =   "muestranuevaPelital.frx":0007
      TabIndex        =   5
      Top             =   5640
      Visible         =   0   'False
      Width           =   8175
...
Private Sub cmdGraba_Click()
    ...
    If WArticulo <> "" Then
        If Left$(WArticulo, 2) = "DY" Or Left$(WArticulo, 2) = "CO" Then
            XTipoPro = "CO"
                Else
            XTipoPro = "PT"
        End If
    ...
    For irow = 1 To 100
        ...
        If WTerminado <> "" Or WArticulo <> "" Or WEnsayo <> "" Or Val(WCantidad) <> 0 Then
            ...
            If WTerminado <> "" And Val(WEmpresa) = 8 Then
                WLinea = 0
