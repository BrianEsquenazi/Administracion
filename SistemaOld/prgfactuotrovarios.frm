...
Begin VB.Form PrgFactu 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "prgfactuotrovarios.frx":0000
      Left            =   4200
      List            =   "prgfactuotrovarios.frx":0007
      TabIndex        =   0
      Top             =   5880
      Visible         =   0   'False
      Width           =   1815
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Height          =   3855
      Left            =   120
      OleObjectBlob   =   "prgfactuotrovarios.frx":0015
      TabIndex        =   2
      Top             =   1680
      Width           =   11415
   End
...
Rem dada
  ...
  For i = 1 To 2
    ...
    If Val(WEmpresa) = 1 Then
        If Cliente.Text = "T00094" Then
            If Moneda.ListIndex = 0 Then
                Listado.ReportFileName = "ImpreFacturaLocalDolarNuevoT00094.rpt"
                    Else
                Listado.ReportFileName = "ImpreFacturaLocalPesosNuevoT00094.rpt"
            End If
                Else
            If Moneda.ListIndex = 0 Then
