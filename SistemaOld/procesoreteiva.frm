...
Begin VB.Form PrgProcesoReteIva 
   AutoRedraw      =   -1  'True
   Caption         =   "Proceso de Traspaso de Retenciones de Iva "
   ClientHeight    =   5580
   ClientLeft      =   3060
   ClientTop       =   1455
   ClientWidth     =   6240
   ...
   End
End
Attribute VB_Name = "PrgProcesoReteIva"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " and Recibos.RetIva <> 0"
    ...
    If rstRecibos.RecordCount > 0 Then
        ...
        With rstRecibos
            ...
            Do
                ...
                WComproIva = IIf(IsNull(!ComproIva), "", !ComproIva)
                Vector(LugarVector, 3) = WComproIva
                Vector(LugarVector, 4) = Str$(!RetIva)
