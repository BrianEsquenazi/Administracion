...
Begin VB.Form PrgRankLin 
   Caption         =   "11.-Listado de Ranking por Linea"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "RankLin.frx":0000
      Left            =   840
      List            =   "RankLin.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
...
Private Sub Acepta_Click()
    ...
    With rstRanking
        ...
        If .NoMatch = False Then
            Do
                ...
                Rem     WDescripcion = rstTerminado!Descripcion
                Rem End If
    ...
    Listado.WindowTitle = "11.-Listado de Ranking de ventas por cliente"
    Listado.WindowTop = 0
    Listado.WindowLeft = 0
    Listado.WindowWidth = Screen.Width
    Listado.WindowHeight = Screen.Height
    
    Uno = "{Ranking.Cliente} in " + Chr$(34) + "" + Chr$(34) + " to " + Chr$(34) + "ZZZZZZ" + Chr$(34)
