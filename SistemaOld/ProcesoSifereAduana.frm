...
Begin VB.Form PrgProcesoSifereAduana 
   AutoRedraw      =   -1  'True
   Caption         =   "Proceso de Traspaso de Percepcioes SIFERE (Aduana)"
   ClientHeight    =   5775
   ClientLeft      =   3060
   ClientTop       =   1425
   ClientWidth     =   6930
   ...
   End
End
Attribute VB_Name = "PrgProcesoSifereAduana"
