...
Begin VB.Form PrgAvisoRechaProduVI 
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "PrgAvisoRechaProduVI"
...
Private Sub Acepta_Click()
    ...
    ZSql = ZSql + " Where PedidoDevol.ImpreProdVI = " + "'" + ZMarca + "'"
...
Private Sub Imprime_Click()
    ...
    For ZCiclo = 1 To LugarVector
        ...
        WMarcaImpresion = "S"
        Sql1 = "UPDATE PedidoDevol SET "
        Sql2 = "ImpreProdVI  = " + "'" + WMarcaImpresion + "'"
