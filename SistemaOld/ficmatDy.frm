...
Begin VB.Form PrgFicmatDy 
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   3060
      ItemData        =   "ficmatDy.frx":0000
      Left            =   120
      List            =   "ficmatDy.frx":0007
      TabIndex        =   1
      Top             =   3240
      Visible         =   0   'False
      Width           =   7815
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgFicmatDy.Caption = "Listado de Ficha de Stock de Materias Primas  :  " + !Nombre
