...
Begin VB.Form PrgModHojaAnterior 
   ...
   Begin RichTextLib.RichTextBox Agenda 
      ...
      RightMargin     =   8900
      AutoVerbMenu    =   -1  'True
      TextRTF         =   $"modhojaanterior.frx":0000
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "modhojaanterior.frx":007C
      Left            =   3360
      List            =   "modhojaanterior.frx":0083
      TabIndex        =   7
      Top             =   6480
      Visible         =   0   'False
      Width           =   8415
   ...
   End
End
Attribute VB_Name = "PrgModHojaAnterior"
