...
Begin VB.Form PrgActuaCargaSolicitud 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2460
      ItemData        =   "Actuacargasolicitud.frx":0000
      Left            =   120
      List            =   "Actuacargasolicitud.frx":0007
      TabIndex        =   1
      Top             =   4800
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   8760
      MouseIcon       =   "Actuacargasolicitud.frx":0015
      MousePointer    =   99  'Custom
      Picture         =   "Actuacargasolicitud.frx":031F
      ToolTipText     =   "Salida"
      Top             =   3360
      Width           =   480
   End
   Begin VB.Image Graba 
      Height          =   480
      Left            =   8760
      MouseIcon       =   "Actuacargasolicitud.frx":0B61
      MousePointer    =   99  'Custom
      Picture         =   "Actuacargasolicitud.frx":0E6B
   ...
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   8760
      MouseIcon       =   "Actuacargasolicitud.frx":16AD
      MousePointer    =   99  'Custom
      Picture         =   "Actuacargasolicitud.frx":19B7
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   8760
      MouseIcon       =   "Actuacargasolicitud.frx":21F9
      MousePointer    =   99  'Custom
      Picture         =   "Actuacargasolicitud.frx":2503
   ...
   End
End
Attribute VB_Name = "PrgActuaCargaSolicitud"
...
Private Sub Graba_Click()
    ...
    rsCargaSolicitud = Sql1 + Sql2
    Set rstCargaSolicitud = db.OpenRecordset(rsCargaSolicitud, dbOpenSnapshot, dbSQLPassThrough)
    ...
    For iRow = 1 To HastaRenglon
        ...
        Sql11 = "Values ("
        Sql12 = "'" + WClave + "',"
        Sql13 = "'" + Solicitud.Text + "',"
        Sql14 = "'" + Str$(WRenglon) + "',"
        Sql15 = "'" + Fecha.Text + "',"
        Sql16 = "'" + ZOrdFecha + "',"
        Sql17 = "'" + Observaciones.Text + "',"
        Sql18 = "'" + ZArticulo + "',"
        Sql19 = "'" + ZCantidad + "',"
        Sql20 = "'" + ZEntregado + "')"
            
        rsCargaSolicitud = Sql1 + Sql2 + Sql3 + Sql4 + Sql5 + Sql6 + Sql7 + Sql8 + Sql9 + Sql10 _
...
Private Sub Proceso_Click()
    ...
    Sql1 = "Select CargaSolicitud.Clave, CargaSolicitud.Solicitud, CargaSolicitud.Articulo, CargaSolicitud.Cantidad, Terminado.Descripcion"
    ...
    rsCargaSolicitud = Sql1 + Sql2 + Sql3 + Sql4 + Sql5
    Set rstCargaSolicitud = db.OpenRecordset(rsCargaSolicitud, dbOpenSnapshot, dbSQLPassThrough)
    If rstCargaSolicitud.RecordCount > 0 Then
...
Private Sub Solicitud_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        Sql2 = " FROM CargaSolicitud"
        Sql3 = " Where CargaSolicitud.Solicitud = " + "'" + Solicitud.Text + "'"
        rsCargaSolicitud = Sql1 + Sql2 + Sql3
        Set rstCargaSolicitud = db.OpenRecordset(rsCargaSolicitud, dbOpenSnapshot, dbSQLPassThrough)
        If rstCargaSolicitud.RecordCount > 0 Then
