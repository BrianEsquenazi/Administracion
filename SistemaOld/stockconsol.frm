...
Begin VB.Form PrgStockConsol 
   Caption         =   "Listado de Stock Consolidado"
   ClientHeight    =   2490
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "WStockConsol.rpt"
      Destination     =   1
   ...
   End
End
Attribute VB_Name = "PrgStockConsol"
...
Private Sub Acepta_Click()
    ...
    For a = 1 To XHasta
                    ...
                    If .EOF = False Then
                        ...
                        If Desde.Text <= rstArticulo!Codigo And Hasta.Text >= rstArticulo!Codigo Then
                            ...
                            If XSaldo <> 0 Or rstArticulo!Minimo <> 0 Then
                                ...
                                Vector(Suma, 5) = Str$(rstArticulo!Laboratorio)
                                Vector(Suma, 6) = Str$(rstArticulo!Pedido)
        ...
        For Ciclo = 1 To Suma
            ...
            Laboratorio = Val(Vector(Ciclo, 5))
            Pedido = Val(Vector(Ciclo, 6))
            Descripcion = ""
            ...
            If rstMinimo.RecordCount > 0 Then
                    ...
                    SumaLaboratorio = rstMinimo!Venta1
                    SumaPedido = rstMinimo!Venta2
                    
                    SumaLaboratorio = SumaLaboratorio + Laboratorio
                    SumaPedido = SumaPedido + Pedido
            ...
            ZSql = ZSql + " Venta1 = " + "'" + Str$(SumaLaboratorio) + "',"
            ZSql = ZSql + " Venta2 = " + "'" + Str$(SumaPedido) + "'"
    ...
    Listado.SQLQuery = "SELECT Minimo.Articulo, Minimo.Descripcion, Minimo.Stock1, Minimo.Stock2, Minimo.Stock3, Minimo.Stock4, Minimo.Stock5, Minimo.Minimo, Minimo.Venta1, Minimo.Venta2 " _
                + "From " _
                + DSQ + ".dbo.Minimo Minimo " _
                + "Where " _
                + "Minimo.Articulo >= ' ' AND " _
                + "Minimo.Articulo <= 'ZZZZZZZZZZ'"
