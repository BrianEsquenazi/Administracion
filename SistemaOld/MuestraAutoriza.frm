...
Begin VB.Form PrgMuestraAutoriza 
   ...
   Begin VB.ListBox pantalla 
      ...
      EndProperty
      Height          =   2700
      ItemData        =   "MuestraAutoriza.frx":0000
      Left            =   120
      List            =   "MuestraAutoriza.frx":0007
      TabIndex        =   5
      Top             =   5640
      Visible         =   0   'False
      Width           =   8175
   ...
   End
End
Attribute VB_Name = "PrgMuestraAutoriza"
    ...
    For iRow = 1 To 100
        ...
        If WTerminado <> "" Or WArticulo <> "" Or WEnsayo <> "" Or Val(WCantidad) <> 0 Then
            ...
            WFechaord = Right$(Fecha.Text, 4) + Mid$(Fecha.Text, 4, 2) + Left$(Fecha.Text, 2)
                ...
                Sql28 = "'" + Cliente.Text + "',"
                Sql29 = "'" + Razon.Text + "',"
                Sql30 = "'" + WDescriCliente + "',"
                Sql31 = "'" + vendedor.Text + "',"
                Sql32 = "'" + DesVendedor.Caption + "',"
                Sql33 = "'" + Observaciones.Text + "',"
                Sql34 = "'" + WAutoriza + "',"
                Sql35 = "'" + WImpresion + "',"
                Sql36 = "'" + WPedido + "')"
                ...
                spMuestra = Sql1 + Sql2 + Sql3 + Sql4 + Sql5 + Sql6 + Sql7 + Sql8 + Sql9 + Sql10 + _
                            ...
                            Sql31 + Sql32 + Sql33 + Sql34 + Sql35 + Sql36
        ...
        With rstMuestra
            ...
            Do
                If .EOF = False Then
                    ...
                    WVector1.Col = 5
                    WVector1.Text = rstMuestra!Ensayo
                        
                    WVector1.Col = 6
                    WVector1.Text = rstMuestra!DescriCliente
                        
                    WVector1.Col = 7
                    WVector1.Text = Str$(Val(rstMuestra!Cantidad))
