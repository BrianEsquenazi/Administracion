...
Begin VB.Form PrgMinTerConsol 
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "WMinterConsol.rpt"
      Destination     =   1
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "minterconsol.frx":0000
      Left            =   840
      List            =   "minterconsol.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
   ...
   End
End
Attribute VB_Name = "PrgMinTerConsol"
...
Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgMinTerConsol.Caption = "Listado de Stock Minimo Consolidado :  " + !Nombre
        End If
    End With
    Desde.Text = "  -     -   "
    Hasta.Text = "  -     -   "
