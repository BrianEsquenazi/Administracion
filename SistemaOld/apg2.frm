...
Private Sub cmdAdd_Click()
    ...
    If Existe <> "S" Then
        ...
        With rstPagos
            ...
            For iRow = 0 To 9
                ...
                If Val(DbGrid1.Text) <> 0 Then
                    ...
                    !Tiporeg = "1"
                    DbGrid1.Col = 0
                    !Tipo1 = Left$(DbGrid1.Text, 2)
                    DbGrid1.Col = 1
                    !Letra1 = Left$(DbGrid1.Text, 1)
                    DbGrid1.Col = 2
                    !Punto1 = Left$(DbGrid1.Text, 4)
                    DbGrid1.Col = 3
                    !Numero1 = Left$(DbGrid1.Text, 8)
                    DbGrid1.Col = 4
                    !Importe1 = Val(DbGrid1.Text)
                    DbGrid1.Col = 5
                    !Observaciones2 = Left$(DbGrid1.Text, 30)
                    !Tipo2 = ""
                    !Numero2 = ""
                    !Fecha2 = ""
                    !FechaOrd2 = ""
        ...
        Rem             .AddNew
        Rem             !Tipomovi = "3"
        Rem             !Proveedor = Proveedor.Text
        Rem             !TipoComp = "01"
        Rem             !LetraComp = "A"
        Rem             !PuntoComp = "0000"
        Rem             !NroComp = Orden.Text
        Rem             Renglon = Renglon + 1
        Rem             Auxi1 = Str$(Renglon)
        Rem             Call Ceros(Auxi1, 2)
        Rem             !Renglon = Auxi1$
        Rem             !Fecha = Fecha.Text
        Rem             !Observaciones = DesProveedor.Caption
        Rem             If Tipo1.Value = True Or Tipo2.Value = True Then
        Rem                 !Cuenta = WCtaProveedor
        Rem             End If
        Rem             If Tipo3.Value = True Then
        Rem                 !Cuenta = WCuenta(iRow)
        Rem             End If
        Rem              !Credito = 0
        ...
        With rstRetencion
            .Index = "clave"
            Claveven$ = WFecha + Proveedor.Text
            .Seek "=", Claveven$
            If .NoMatch = False Then
                .Edit
                !Neto = !Neto + XNeto
                !Retenido = !Retenido + Val(Retencion.Text)
                .Update
            End If
        End With
...
Private Sub IMPREORDEN()
    ...
    Open "lpt1" For Output As #1
        ...
        For Ciclo% = 1 To 2
            ...
            Print #1, Tab(1); Chr$(15)
            Rem Print #1, Tab(1); Chr$(14); Impretit
            Print #1, Tab(1); Impretit
            Print #1, Tab(1); "ORDEN DE PAGO";
            
            Print #1, Tab(1); String$(130, "-")
            
            Print #1, Tab(1); "|";
            Print #1, Tab(10); "Proveedor";
            Print #1, Tab(60); "     Fecha    ";
            Print #1, Tab(80); "  Numero";
            Print #1, Tab(130); "|"
            
            Print #1, Tab(1); "|";
            Print #1, Tab(2); "Sres.:"; DesProveedor.Caption;
            Print #1, Tab(63); Fecha.Text;
            Print #1, Tab(82); Orden.Text;
            Print #1, Tab(130); "|"
            ...
            Print #1, Tab(76); "|";
            Print #1, Tab(90); "|";
            Print #1, Tab(91); "Valores o Docucmentos Entregados";
            Print #1, Tab(130); "|"
            Print #1, Tab(1); "|";
            Print #1, Tab(2); " Fecha";
            Print #1, Tab(14); "|";
            Print #1, Tab(15); "Nro.Interno";
            Print #1, Tab(29); "|";
            Print #1, Tab(30); "Comp.";
            Print #1, Tab(39); "|";
            Print #1, Tab(40); "Descripcion ";
            Print #1, Tab(76); "|";
            Print #1, Tab(80); " Importe";
            Print #1, Tab(90); "|";
            Print #1, Tab(91); "Nro.";
            Print #1, Tab(99); "|";
            Print #1, Tab(100); "Banco/Cliente";
            Print #1, Tab(119); "|";
            Print #1, Tab(120); " Importe";
            Print #1, Tab(130); "|"
            ...
            For WCiclo = 1 To 12
                ...
                If Val(WImpresion(WCiclo, 5)) <> 0 Then
                    ...
                    If Val(WImpre2(WCiclo, 3)) <> 0 Then
                        DbGrid1.Col = 7
                        Print #1, Tab(91); WImpre2(WCiclo, 1);
                        DbGrid1.Col = 10
                        Print #1, Tab(99); "|";
                        Print #1, Tab(100); Left$(WImpre2(WCiclo, 2), 19);
                        DbGrid1.Col = 11
                        Print #1, Tab(119); "|";
                        Print #1, Tab(120); Alinea("###,###.##", WImpre2(WCiclo, 3));
                            Else
                        Print #1, Tab(95); "";
                        Print #1, Tab(99); "|";
                        Print #1, Tab(119); "|";
            ...
            Print #1, Tab(20); ""; Alinea("###,###.##", Str$(Total));
            Print #1, Tab(40); " Retencion";
            Print #1, Tab(50); ""; Alinea("###,###.##", Retencion.Text);
            Print #1, Tab(80); " Importe neto a Pagar";
            Print #1, Tab(110); ""; Alinea("###,###.##", Str$(Total - Val(Retencion.Text)));
            Print #1, Tab(130); "|"
            ...
            Rem
            Rem
            Rem Print #1, Tab(1); String$(130, "_")
            ...
            Print #1, Tab(110); "  Recibi Conforme";
            Print #1, Tab(130); "|"
...
Private Sub Impreret()
    ...
    Select Case Val(WEmpresa)
        Case 1
            ...
            WEmpDireccion = "Malvinas Aregntinas 4589"
            WEmpLocalidad = "1644 Victoria Bs.As. Argentina"
            WEmpCuit = "30-59916508-3"
        Case Else
