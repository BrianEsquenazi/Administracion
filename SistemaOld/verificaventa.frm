...
Begin VB.Form PrgVerificaVenta 
   Caption         =   "Listado de Verirficacion de Productos Terminados sin venta"
   ClientHeight    =   6075
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "verificaventa.frx":0000
      Left            =   1920
      List            =   "verificaventa.frx":0007
      TabIndex        =   3
      Top             =   4440
      Visible         =   0   'False
      Width           =   3735
   ...
   End
End
Attribute VB_Name = "PrgVerificaVenta"
            ...
            With rstTerminado
                ...
                Do
                    If .EOF = False Then
                        ...
                        ZZStock = rstTerminado!Entradas - rstTerminado!Salidas
