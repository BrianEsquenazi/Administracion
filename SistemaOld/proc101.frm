...
Private Sub Aceptar_Click()
    ...
    Open "veriMP.TXT" For Output As #1
    ...
    With rstArticulo
            ...
            Do
                ...
                Rem If rstArticulo!Codigo = "DY-302-901" Then
                
                    Renglon = Renglon + 1
                    
                    Vector(Renglon, 1) = rstArticulo!Codigo
                    Vector(Renglon, 2) = rstArticulo!Entradas
                    Vector(Renglon, 3) = rstArticulo!Salidas
    ...
    For Da = 1 To Renglon
        ...
        Rem If WArticulo = "DY-302-901" Then Stop
        
        
        If Int(WEntradas) <> Int(WEntradas1) Or Int(WSalidas) <> Int(WSalidas1) Or Int(WSaldo) <> Int(WSaldo1) Then
            Print #1, WArticulo, WEntradas, WEntradas1, WSalidas, WSalidas1, WSaldo, WSaldo1
        End If
                ...
                If rstMovguia!Marca = "X" And rstMovguia!Saldo = 0 Then
                    ...
                    If rstMovguia!Tipo = "M" And rstMovguia!Articulo = WArticulo Then
                        If rstMovguia!Movi = "E" Then
                            ...
                            WSaldo = WSaldo + rstMovguia!Saldo
                                Else
...
Private Sub Form_Load()
    With rstEmpresa
        ...
        .Seek "=", Val(WEmpresa)
        If .NoMatch = False Then
            PrgProc101.Caption = "Reproceso de Stock de Materia Prima :  " + !Nombre
        End If
    End With
