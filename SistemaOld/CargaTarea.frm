...
Begin VB.Form PrgHojaRuta 
   ...
   Begin VB.Frame EntraPedido 
      ...
      Begin VB.Image FinPedido 
         Height          =   480
         Left            =   5520
         MouseIcon       =   "CargaTarea.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "CargaTarea.frx":030A
         ToolTipText     =   "Salida"
         Top             =   5760
         Width           =   480
      End
   ...
   Begin VB.CommandButton CargaPedido 
      Height          =   735
      Left            =   7320
      MouseIcon       =   "CargaTarea.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "CargaTarea.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "CargaTarea.frx":1720
      Left            =   120
      List            =   "CargaTarea.frx":1727
      TabIndex        =   1
      Top             =   6120
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image cmdclose1 
      Height          =   480
      Left            =   9720
      MouseIcon       =   "CargaTarea.frx":1735
      MousePointer    =   99  'Custom
      Picture         =   "CargaTarea.frx":1A3F
      ToolTipText     =   "Salida"
      Top             =   5880
      Width           =   480
   End
   Begin VB.Image Graba 
      Height          =   480
      Left            =   7320
      MouseIcon       =   "CargaTarea.frx":2281
      MousePointer    =   99  'Custom
      Picture         =   "CargaTarea.frx":258B
   ...
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   8160
      MouseIcon       =   "CargaTarea.frx":2DCD
      MousePointer    =   99  'Custom
      Picture         =   "CargaTarea.frx":30D7
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   9000
      MouseIcon       =   "CargaTarea.frx":3919
      MousePointer    =   99  'Custom
      Picture         =   "CargaTarea.frx":3C23
                            ...
                            If rstPedido!autorizo = "X" Then
                                ...
                                If Pasa = "S" And !Cliente <> "P00005" Then
                                    ...
                                    If ZZCorte <> rstPedido!Pedido Then
                                        ...
                                        End If
                                        Muestra.TextMatrix(ZZRenglon, 4) = Pusing("######", Str$(ZKilos))
                            ...
                            Do
                                If .EOF = False Then
                                    ...
                                    If ZSumaCantidad <> 0 Then
                                        ZKilos = ZKilos + ZSumaCantidad
                                            Else
                                        ZKilos = ZKilos + (rstPedido!Cantidad - rstPedido!Facturado)
                                    End If
