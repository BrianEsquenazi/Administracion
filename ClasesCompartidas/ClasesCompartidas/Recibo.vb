Public Class Recibo
    ...
    Public codigo, fecha, observaciones As String
    ...
    Public Sub New(ByVal id As String, ByVal fecha2 As String, ByVal cli As Cliente, ByVal ganancias As Double, ByVal IB As Double, ByVal IVA As Double,
                   ByVal suss As Double, ByVal valorParidad As Double, ByVal valorTotal As Double, ByVal cuentaContable As CuentaContable,
